...
//			conn = ResourceManager.getConnection();
			...
			String sql = "SELECT id,baqylx,jsjdm,baqssj,sfftsk,sndsfxwqy,fzjglxdm FROM sfdb.SF_JL_ZFJGBA_QYXX " +
					     " WHERE jsjdm=? AND ZXBZ='0' AND BAQSSJ<to_date(?,'yyyymmdd') ORDER BY baqssj DESC";
