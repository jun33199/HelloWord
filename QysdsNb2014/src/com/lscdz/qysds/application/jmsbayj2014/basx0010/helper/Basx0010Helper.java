package com.lscdz.qysds.application.jmsbayj2014.basx0010.helper;
...
import com.lscdz.qysds.application.jmsbayj2014.basx0010.vo.inner.Basx0010Vo;
...
//					" FROM sfdb.sf_jl_qysdsjmsba_01 T,SFDB.SF_JL_QYSDSJMSBAJL_2014 S,DMDB.SF_DM_ZYZHLYZL B " +
...
//				//更新主表
//				sql = "update SFDB.SF_JL_QYSDSJMSBAJL_2014 set bajmse='"+bajmse+"',bajmbl='"+bajmbl+"',fhwjmc=?,qsrq="+qsrq+
...
//			}else{
//				//插入主表
//				sql = " insert into SFDB.SF_JL_QYSDSJMSBAJL_2014(BASQWSH,BASQBH,JSJDM,BAND,JMBASXDM,SZDM,SWJGZZJGDM,SQZT,TJR,TJSJ,SHR,SHSJ," +
...
//				//删除该备案申请文书号的资料清单表
//				String delzlqd = "DELETE SFDB.SF_JL_QYSDSJMSBAJLZLQD_2014 WHERE BASQWSH = '"+basqwsh+"'";
//
//				ps2=conn.prepareStatement(delzlqd);
//				ps2.execute();
//				//插入该备案申请文书号的资料清单
//				String zlqd = "INSERT INTO SFDB.SF_JL_QYSDSJMSBAJLZLQD_2014(XH,BASQWSH,ZLQD,SWJGZZJGDM,CJR,CJRQ,LRR,LRRQ,SFSHTG,SFKYSC)" +
