...
public class QysdsNsrjbxxVo2014 {
	...
	public String getNlmyJmsbaFlag() {
		return nlmyJmsbaFlag;
	}
	public void setNlmyJmsbaFlag(String nlmyJmsbaFlag) {
		this.nlmyJmsbaFlag = nlmyJmsbaFlag;
	}
