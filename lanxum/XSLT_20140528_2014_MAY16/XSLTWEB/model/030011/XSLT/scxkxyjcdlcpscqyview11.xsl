	...
	<xsl:template match="/">
		...
		<table class="table-99" cellspacing="0">
				...
				<xsl:value-of select="taxdoc/jmsbajl/basqbh" />
										...
										<tr>                                            	
                            <td width="20%" class="2-td2-left"><div align="left">获利年度声明：获利年度<font color="#FF0000">*</font></div></td>
                            <td colspan="4" class="2-td2-center"><div id="mx_zsfsdm_epx_visible_1" align="left">
                                            <input type="text" name="hlnd" size="5" tabindex="-1" class="noborder-txtcenter" readonly="true">
                                             <xsl:attribute name="value">
                    ...
                    <tr>
                            ...
                            <td colspan="4" class="2-td2-center"><div id="mx_zsfsdm_epx_visible_1" align="left">
                                           <input type="text" name="mzqsnd" size="5" tabindex="-1"   class="noborder-txtcenter" readonly="true">
                                            <xsl:attribute name="value">
                        <xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/mzqsnd"/>
                        </xsl:attribute>
                          </input>年至<input type="text" name="mzzznd" size="5" tabindex="-1"  class="noborder-txtcenter" readonly="true">
                           <xsl:attribute name="value">
                    ...
                    <tr>
                            ...
                            <td colspan="4" class="2-td2-center"><div id="mx_zsfsdm_epx_visible_1" align="left">
                                           <input type="text" name="jzqsnd" size="5" tabindex="-1"  class="noborder-txtcenter" readonly="true">
                                            <xsl:attribute name="value">
                        <xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/jzqsnd"/>
                        </xsl:attribute>
                          </input>年至<input type="text" name="jzzznd" size="5" tabindex="-1"  class="noborder-txtcenter" readonly="true">
                           <xsl:attribute name="value">
                    ...
                    <tr>
                            ...
                            <td colspan="3" class="2-td2-center"><div id="mx_zsfsdm_epx_visible_1" align="left">
										<input type="text" name="yjjmse" size="20" tabindex="-1"  class="noborder-txtcenter" readonly="true">
										 <xsl:attribute name="value">
