        	...
        	<td class="2-td1-left">收入额</td>
				...
				<xsl:if test="taxdoc/sbxx/done[.=1]">
					<xsl:for-each select="taxdoc/sbsj">
						...
						<tr>
						<td class="2-td2-left"><xsl:value-of select="position()"/></td>						
						...
						<td class="2-td2-left">
							...
							<td class="2-td2-left">
								<input maxlength="15" size="15" name="sre" value="{sre}">
									<xsl:attribute name="onChange">return(sreOnChange(this,0,0,<xsl:value-of select="position()"/>));</xsl:attribute>
								</input>
							</td>
							<td class="2-td2-left">
				...
				<tr>
					...
					<TD class="2-td2-left" colSpan="6" noWrap="true">
