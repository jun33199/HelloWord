						...
						<td>
							<div id="Layer2" style="position:static;">
								<table id="wrklistTable" border="1" cellspacing="0" class="table-99" align="center">
									...
									<tr>
										<td class="2-td2-left" nowrap="nowrap">执行的财务会计制度（必选）</td>
										<td colspan="3" class="2-td2-center" nowrap="nowrap">
											单项选择：
											<br />
												<input type="Radio" name="cwkjzddm_show" id="cwkjzddm12" value="12"/>企业（小企业）会计制度；
												<input type="Radio" name="cwkjzddm_show" id="cwkjzddm14" value="14"/>金融企业会计制度；
												<input type="Radio" name="cwkjzddm_show" id="cwkjzddm15" value="15"/>事业单位、社会团体、民办非企业单位会计制度（对报表有控制）
										</td>
									</tr>
									<tr>
										<td class="2-td2-left" nowrap="nowrap">工资管理形式</td>
										<td colspan="3" class="2-td2-center" nowrap="nowrap">
											单项选择：
											<br />
											<input type="Radio" name="gzglxsdm_show" id="gzglxsdm01" value="01">非工效挂钩</input>
											<input type="Radio" name="gzglxsdm_show" id="gzglxsdm03" value="03">工效挂钩（对报表有控制）</input>
										</td>
									</tr>
									<tr>
										<td colspan="4" class="2-td2-center" nowrap="nowrap">纳税人享受减免企业所得税的类型</td>
									</tr>
									<tr>
										<td colspan="4" class="2-td2-center" nowrap="nowrap">
											单项选择：
											<br />
											<input type="Radio" name="jmlxdm_show" id="jmlxdmNo" value="">1、 没有优惠；</input>
											<input type="Radio" name="jmlxdm_show" id="jmlxdm9010" value="9010">2、 高新技术企业；</input>
											<input type="Radio" name="jmlxdm_show" id="jmlxdm9020" value="9020">3、 软件产业；</input>
											<input type="Radio" name="jmlxdm_show" id="jmlxdm9030" value="9030">4、 集成电路产业；</input>
											<input type="Radio" name="jmlxdm_show" id="jmlxdm9090" value="9090">5、福利生产企业；</input>
											<input type="Radio" name="jmlxdm_show" id="jmlxdm9070" value="9070">6、劳动就业服务企业；</input>
											<input type="Radio" name="jmlxdm_show" id="jmlxdm9990" value="9990">7、其他优惠；</input>
										</td>
									</tr>
								</table>
							</div>
