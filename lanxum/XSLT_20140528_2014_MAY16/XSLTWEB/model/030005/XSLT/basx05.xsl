	...
	<xsl:template match="/">
		...
		<table class="table-99" cellspacing="0" id="TABLE_LIST1"
			...
			<tr>
				...
				<td class="2-td2-left">
						<div id="nlmyjmxmdmdiv0" align="left">
					</div>
				</td>
				...
				<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<input type="text" name="jmsde0" id="jmsde0"
							maxlength="16" size="17" tabindex="1" value=""
		...
		<table class="table-99" cellspacing="0" id="TABLE_LIST2"
			...
			<tr>
				...
				<td class="2-td2-left">
					<div id="nlmyjmxmdmdiv1" align="left">
					</div>
				</td>
				...
				<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<input type="text" name="jmsde1" id="jmsde1"
							maxlength="15" size="17" tabindex="1" value=""
							onchange="return formatKsslJsje(this);">
							<xsl:attribute name="value">
								<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/jmsde" />
