     ...
     <table class="table-99" cellspacing="0">
				...
				<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/wh" />&#160;
                    ...
                    <tr>
                      ...
                      <td class="2-td2-center">                        
												<div  align="left">
<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/zyzhlyzlmc"/>
   			...
   			<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/zsbh" />&#160;
				...
				<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/zsyxjzrq" />&#160;
                     ...
                     <tr>
                      ...
                      <td class="2-td2-center">
                      	<div align="left">
				<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/qdsr" />元&#160;
	                      </div>               
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">   
	                      <div align="left">
				<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/jjsr" />元&#160;
	                      </div>  
                      </td>
                    </tr>                
                  </table>
