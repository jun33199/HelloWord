...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		...
		<table class="table-99" cellspacing="0">
			...
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						&#160;<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/zrsrje" />&#160;元
					</div>
				</td>
			</tr>
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
								&#160;<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/sjje1" />&#160;元							
					</div>
				</td>
			</tr>
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
								&#160;<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/sjje2" />&#160;元
					</div>
				</td>
			</tr>
			...
			<tr>
				<td  class="2-td2-left">
					<div align="left">取得第一笔减排量转让收入所属纳税年度<font color="#FF0000">*</font></div>
				</td>
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
								&#160;<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/hlnd" />&#160;年
					</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td  class="2-td2-left">
					<div align="left">减征年度<font color="#FF0000">*</font></div>
				</td>
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						&#160;从（
