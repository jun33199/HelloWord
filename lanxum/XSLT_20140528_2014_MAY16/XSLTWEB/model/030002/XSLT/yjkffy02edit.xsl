  ...
  <table class="table-99" cellspacing="0">                  
  	<tr>
				...
				<xsl:value-of select="taxdoc/jmsbajl/basqbh" />
                    ...
                    <tr>
                      <td width="70%" class="2-td2-left" colspan="2">
                        <div align="left">
                          研发费用领域
                          <font color="#FF0000">
                            *
           ...
           <xsl:variable name="jdm" select="taxdoc/jmsbajl/qysdsjmba/yffylydm"/>
					<select name="yffylydm" id="yffylydm">
						<option value="{$jdm}" selected="selected"><xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/yffylymc"/>					
						</option>
					</select>
					<input type="hidden" name="yffylymc" id="yffylymc">
						<xsl:attribute name="value"><xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/yffylymc"/></xsl:attribute>
					</input>
                    ...
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          <input type="text" id="xmmc" name="xmmc" maxlength="200" size="30" tabindex="-1"
                          >
                          		<xsl:attribute name="value">
				<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/xmmc" />
			</xsl:attribute>
	</input>
                    ...
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          <input type="text" name="dqkcje" maxlength="18" size="30" tabindex="-1" >
                           		<xsl:attribute name="value">
				<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/dqkcje" />
			</xsl:attribute>
	</input>
	元</div>
                       </td>
                    ...
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          <input type="text" name="wxzcje" maxlength="18" size="30" tabindex="-1"
                         >
                            		<xsl:attribute name="value">
				<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/wxzcje" />
			</xsl:attribute>
	</input>
                   元</div>   </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          <input type="text" name="jjkcje" maxlength="18" size="30" tabindex="-1"
                          >
                            		<xsl:attribute name="value">
				<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/jjkcje" />
			</xsl:attribute>
	</input>
               元</div>       </td>
                    </tr>
