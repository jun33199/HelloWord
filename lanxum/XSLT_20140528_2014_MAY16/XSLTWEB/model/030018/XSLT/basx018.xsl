	...
	<xsl:template match="/">
		...
		<table class="table-99" cellspacing="0" id="TABLE_LIST1"
			...
			<tr>
				...
				<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<input type="text" name="zsbh" size="20" maxlength="50"
							tabindex="1">
							<xsl:attribute name="value">
								<xsl:value-of
			...
			<tr>
				...
				<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<input type="text" name="zsqsrq" size="20" maxlength="10"
							tabindex="2" onclick="WdatePicker()">
							<xsl:attribute name="value">
								<xsl:value-of
			...
			<tr>
				...
				<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<input type="text" name="zszzrq" size="20" maxlength="10"
							tabindex="3" onclick="WdatePicker()">
							<xsl:attribute name="value">
								<xsl:value-of
			...
			<tr>
				...
				<td colspan="1" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<input type="text" name="jmse" size="20" maxlength="18"
							tabindex="4" onchange="return formatKsslJsje(this);">
							<xsl:attribute name="value">
								<xsl:value-of
