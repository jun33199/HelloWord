		...
		<table class="table-99" cellspacing="0">
		   <tr>
				...
				<xsl:value-of select="taxdoc/jmsbajl/basqbh" />
                    ...
                    <tr>
                            <td width="20%" class="2-td2-left"><div align="left">本年减按10%税率征收的预计减税额<font color="#FF0000">*</font></div></td>
                            <td colspan="3" class="2-td2-center"><div id="mx_zsfsdm_epx_visible_1" align="left">
							<input type="text" name="yjjse" size="20" tabindex="-1" class="noborder-txtcenter" readonly="true" >
							 <xsl:attribute name="value">
                        <xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/yjjse"/>
                        </xsl:attribute>
                          </input>
                                            </div></td>
                    </tr>
		...
		<table class="table-99" cellspacing="0" id="FhtjjzzrsdTable">
			       ...
			       <xsl:variable name="rr" select="taxdoc/nsrxx/nsrmc"/>
                      ...
                      <td width="30%" class="2-td2-center">
                        <div align="left">
                         <input type="text" name="lrr" size="20" class="noborder-txtcenter" readonly="true" value='{$rr}'>
