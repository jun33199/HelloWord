		...
		<table class="table-99" align="center">
            ...
            <td> 
              <div id="Layer2" style="position:static;">
                ...
                <table id="wrklistTable" border="1" cellspacing="0"
				  ...
				  <tr> 
                    <td colspan="5" nowrap="nowrap" class="2-td2-center"><div align="left"><B>一、以下由按应税所得率计算应纳所得税额的企业填报</B></div></td>
                  </tr>
                  <tr> 
		  ...
		  <!--屏蔽，guoxh，2012-2-24
				  ...
				  <tr> 
                    ...
                    <td class="2-td2-center" nowrap="nowrap"><input tabindex='15' type='text' name='swjghdynsdse'
								id='15_1' style='text-align:right' value='0.00' size='13' 
								onblur='checkNumInput(this)' onchange='compute_Row_15()'>
								<xsl:attribute name="value">
									<xsl:value-of select="swjghdynsdse" />
								</xsl:attribute>
								</input>
					</td>
                  </tr>
