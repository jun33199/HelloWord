...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<input name="XH" type="hidden" id="XH">
		...
		<xsl:attribute name="value">
				<xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/WHSYDWLXDM"/>
			</xsl:attribute>
		</input>		
           ...
           <tr>
				...
				<xsl:value-of select="taxdoc/jmsbajl/basqbh" />
                    ...
                    <tr>
                            <td width="50%" class="2-td2-left"><div align="left">文化事业单位类型代码<font color="#FF0000">*</font></div></td>
                            <td colspan="3" class="2-td2-center">
                                 <div id="mx_zsfsdm_epx_visible_1" align="left">
							         <select  name="fudm" id="fudm" style="width:150px">
                    ...
                    <tr>
                            <td width="20%" class="2-td2-left"><div align="left">减免税额<font color="#FF0000">*</font></div></td>
                            <td colspan="3" class="2-td2-center">
                              <div id="mx_zsfsdm_epx_visible_1" align="left">
                                    <input name="JMSE" id="JMSE" tabindex="1" type="text" style="text-align:right" value="" size="15">
