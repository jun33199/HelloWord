				...
				<td width="50%" class="2-td2-center" height="21"
					...
					<div align="left">
						...
						<input type="button" name="cx" value="查询 "
							onclick="javascript:return doAjaxQueryWnsj();">
						</input>
			...
			<tr>
				...
				<td class="2-td2-center" colspan="2">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<input type="text" name="dmnd" maxlength="4"
							size="17" tabindex="2" value="" onchange="javascript:return doAjaxQueryDmnd();">
							<xsl:attribute name="value">
								<xsl:value-of
				...
				<tr>
					...
					<td class="2-td2-left">
						<div id="mx_zsfsdm_epx_visible_1"
							...
							<input name="tzezs{$crdmnd}" id="tzezs{$crdmnd}"
								tabindex="{$tabIndex+1}" type="text" style="text-align:right" size="17"
								onchange="change('1','{$crdmnd}');checkTzxx();" >
								<xsl:attribute name="value">
									<xsl:value-of select="tzezs" />
								</xsl:attribute>
							</input>元
					...
					<td class="2-td2-left">
						...
						<xsl:choose>
							...
							<input name="dmynse{$crdmnd}" id="dmynse{$crdmnd}"
								tabindex="{$tabIndex+1}" type="text" style="text-align:right" size="17"
								onchange="change('2','{$crdmnd}');checkTzxx();" readonly="readonly">
								<xsl:attribute name="value">
							...
							<input name="dmynse{$crdmnd}" id="dmynse{$crdmnd}"
								tabindex="{$tabIndex+1}" type="text" style="text-align:right" size="17"
								onchange="change('2','{$crdmnd}');checkTzxx();" >
								<xsl:attribute name="value">
									<xsl:value-of select="dmynse" />
								</xsl:attribute>
							</input>元
					...
					<td class="2-td2-left">
						<div align="center">
							<input name="jze{$crdmnd}" id="jze{$crdmnd}"
								 type="text" style="text-align:right" size="17"
								onchange="return formatKsslJsje(this);" readonly="readonly" class="txtInput">
								<xsl:attribute name="value">
