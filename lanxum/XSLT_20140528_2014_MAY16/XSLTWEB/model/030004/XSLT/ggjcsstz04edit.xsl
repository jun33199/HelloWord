  	...
  	<tr>
                     ...
                     <tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                                   <xsl:variable name="jdm" select="//ggjcssxmlxdm"/>
					<select name="ggjcssxmlxdm" id="ggjcssxmlxdm">
				<xsl:if test="$disacheck='true'">
					<xsl:attribute name="disabled">true</xsl:attribute>
					</xsl:if>
						<option value="{$jdm}" selected="selected"><xsl:value-of select="//ggjcssxmlxmc"/>					
						</option>
					</select>
					<input type="hidden" name="ggjcssxmlxmc" id="ggjcssxmlxmc">
						<xsl:attribute name="value"><xsl:value-of select="//ggjcssxmlxmc"/></xsl:attribute>
					</input>
                    ...
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">
                  <input type="text" id="wjmc" name="wjmc" size="30" tabindex="1"
                       maxlength="200"    >
 				<xsl:if test="$disacheck='true'">
					<xsl:attribute name="disabled">true</xsl:attribute>
					</xsl:if>
				...
				<xsl:value-of select="//wjmc" />
                    ...
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">
                  <input type="text" id="wh" name="wh" size="30" tabindex="2"
                       maxlength="50"    >
				<xsl:if test="$disacheck='true'">
					<xsl:attribute name="disabled">true</xsl:attribute>
					</xsl:if>
				...
				<xsl:value-of select="//dybzlmc" />
                    ...
                    <tr>
                      ...
                      <td class="2-td2-center">
                       <div align="left">
                            <input type="text" id="dybrq" name="dybrq" maxlength="4" size="8" tabindex="4" >
				<xsl:if test="$disacheck='true'">
					<xsl:attribute name="disabled">true</xsl:attribute>
					</xsl:if>
                          		<xsl:attribute name="value">
				...
				<xsl:value-of select="//mzzznd" />
                    ...
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          从（
   <input type="text" id="jzqsnd" name="jzqsnd" maxlength="4" size="5" tabindex="7" >
                          		<xsl:attribute name="value">
				<xsl:value-of select="//jzqsnd" />
			</xsl:attribute>
	</input>                          ）年至（
     <input type="text" id="jzzznd" name="jzzznd" maxlength="4" size="5" tabindex="8" >
                       	<xsl:attribute name="value">
