		...
		<table class="table-99" align="center">
		  ...
		  <tr> 
			...
			<input type='text' name='yycb'
				...
				<xsl:attribute name="value">
                  ...
                  <tr> 
                    ...
                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="left">实际利润额</div></td>
                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
                    <td colspan="2" nowrap="nowrap" class="2-td2-center">
			...
			<input type='text' name='ybtsdse'
				...
				<xsl:attribute name="value">
                  ...
                  <tr> 
                    ...
                    <td colspan="1" rowspan="4" width="20%" class="2-td2-left"><div align="center">总机构<br/>（注：当总分机构税率不一致时，18-20行公式不成立。）</div></td>
                    <td colspan="1" nowrap="nowrap" width="40%" class="2-td2-left"><div align="left">总机构应分摊的所得税额（9行或14行或16行×25%）</div></td>
                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
                    <td colspan="2" nowrap="nowrap" class="2-td2-center">
			...
			<tr> 
                ...
                <td colspan="1" nowrap="nowrap" class="2-td2-left"><div align="left">&#160;&#160;&#160;&#160;其中：总机构缴纳其独立生产经营部门分摊的所得税额</div></td>
                <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
                <td colspan="2" nowrap="nowrap" class="2-td2-center">
