              ...
              <div id="Layer2" style="position:static;">	
				  <table id="wrklistTable" border="1" cellspacing="0" class="table-99" align="center" width="100%">
					  <tr> 
	                    ...
	                    <td width="60%" colspan="2" nowrap="nowrap" class="2-td1-left"><div align="center">项目</div></td>
	                    <td width="15%" colspan="2"  nowrap="nowrap" class="2-td1-left"><div align="center">本期金额</div></td>
	                    <td width="15%" colspan="2"  nowrap="nowrap" class="2-td1-center">累计金额</td>
			          </tr>
	                  <tr> 
	                    <td colspan="1" nowrap="nowrap" class="2-td2-left"><div align="center">1</div></td>
	                    <td colspan="6" nowrap="nowrap" class="2-td2-center"><div align="left"><B>一、按照实际利润额预缴</B></div></td>
	                  </tr>
	                  <tr> 
	                 ...
	                 <table id="mssrxmAutoTable" border="1" cellspacing="0" class="table-99" align="center" width="100%">	                  
	                  <tr> 
	                    <td width="5%"  colspan="1" nowrap="nowrap" class="2-td2-left"><div align="center">7</div></td>
	                    <td width="48%" colspan="2" nowrap="nowrap" class="2-td2-left"><div align="left">&#160;&#160;&#160;&#160;免税收入</div></td>
	                    <td width="24%" colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td width="15%" colspan="2" nowrap="nowrap" class="2-td2-center" >
							<input type='text' name='mssr'
								id='8_1' style='text-align:right' value='0.00' size='13'
								onblur="checkNumInput(this)" onchange="compute_Row_8()" readonly="true">
								<xsl:attribute name="value">
									<xsl:value-of select="mssr" />
								</xsl:attribute>
							</input>
							<img onclick="doMssrxmAddRow()" src="" alt="增加" name="add_image" id="add_image"  style="cursor:hand"/>
					    </td>
	                  </tr>                  
	                  <xsl:apply-templates select="//cbsbsj/cbMssrxmList" />
	                  </table>
	                  
	                 <table id="jzmzxmAutoTable" border="1" cellspacing="0" class="table-99" align="center" width="100%">	  
					<tr> 
	                    <td width="5%"  colspan="1" nowrap="nowrap" class="2-td2-left"><div align="center">8</div></td>
	                    <td width="48%" colspan="2" nowrap="nowrap" class="2-td2-left"><div align="left">&#160;&#160;&#160;&#160;减征、免征应纳税所得额</div></td>
	                    <td width="24%" colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td width="15%" colspan="2" nowrap="nowrap" class="2-td2-center">
							<input type='text' name='jmzynssde'
								id='9_1' style='text-align:right' value='0.00' size='13'
								onblur="checkNumInput(this)" onchange="compute_Row_8_1()" readonly="true">
								<xsl:attribute name="value">
									<xsl:value-of select="jmzynssde" />
								</xsl:attribute>
							</input>
							<img onclick="doJzmzxmAddRow()" src="" alt="增加" name="add_image" id="add_image"  style="cursor:hand"/>
					    </td>
	                  </tr>                  
	                  <xsl:apply-templates select="//cbsbsj/cbJzmzxmList" />
	                  </table>
	                   <table id="wrklistTable2" border="1" cellspacing="0" class="table-99" align="center" width="100%">
	                  <tr> 
	                    <td width="5%"  colspan="1" nowrap="nowrap" class="2-td2-left"><div align="center">9</div></td>
	                    <td width="60%" colspan="2" nowrap="nowrap" class="2-td2-left"><div align="left">&#160;&#160;&#160;&#160;弥补以前年度亏损</div></td>
	                    <td width="15%" colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td width="15%" colspan="2" nowrap="nowrap" class="2-td2-center">
	                 ...
	                 <table id="jmxmAutoTable" border="1" cellspacing="0" class="table-99" align="center" width="100%">
	                  <tr style="border:1px solid yellow;"> 
	                    <td width="5%" colspan="1"  nowrap="nowrap" class="2-td2-left"><div align="center">13</div></td>
	                    <td width="48%" colspan="2"  nowrap="nowrap" class="2-td2-left"><div align="left">减：减免所得税额</div></td>
	                    <td width="24%" colspan="2"  nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td width="15%" colspan="2"  nowrap="nowrap" class="2-td2-center">
							<input type='text' name='jmsdse'
								id='14_1' style='text-align:right' value='0.00' size='13'
								onblur="checkNumInput(this)" onchange="compute_Row_13()" readonly="true">
								<xsl:attribute name="value">
									<xsl:value-of select="jmsdse" />
								</xsl:attribute>
							</input>
							<img onclick="doJmxmAddRow()" src="" alt="增加" name="add_image" id="add_image"  style="cursor:hand"/>
					    </td>
	                  </tr>                  
	                  <xsl:apply-templates select="//cbsbsj/cbJmxmList" />
	                  </table>
	                   <table id="wrklistTable3" border="1" cellspacing="0" class="table-99" align="center" width="100%">
					   <tr style="border:1px solid blue"> 
	                    <td colspan="1" width="5%" nowrap="nowrap" class="2-td2-left"><div align="center">14</div></td>
	                    <td colspan="2" width="60%" nowrap="nowrap" class="2-td2-left"><div align="left">&#160;&#160;其中：符合条件的小型微利企业减免所得税额</div></td>
	                    <td colspan="2" width="15%" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td colspan="2" width="16%" nowrap="nowrap" class="2-td2-center">
...
<xsl:template match="//cbsbsj/cbMssrxmList">
	   <tr id='tr_Mssrxm'> 
	       <td colspan="1" width="5%" nowrap="nowrap" class="2-td2-left"><div align="center">&#160;
	       	<input type="hidden" name="cbMssrxmYzhc" value="" id="" >								
	       							<xsl:attribute name="value">
									<xsl:value-of select="cbMssrxmYzhc" />
								</xsl:attribute>
			</input></div></td>
	       <td colspan="2"  nowrap="nowrap" class="2-td2-left"><div align="left">&#160;&#160;&#160;&#160;</div></td>
	       <td colspan="2"  nowrap="nowrap" class="2-td2-left"><div align="center" name='mssrxm_div' id='mssrxm_div'>
	            <input type="hidden" name="cbMssrxmDmhc" value="" id="">
	            	    <xsl:attribute name="value"><xsl:value-of select="cbMssrxmDmhc" /></xsl:attribute>
				</input>
                <input type="hidden" name="cbMssrxmDm" value="" id="">
            	       	<xsl:attribute name="value"><xsl:value-of select="cbMssrxmDm" /></xsl:attribute>
				</input>                
	       </div></td>
	       <td colspan="2" width="15%" nowrap="nowrap" class="2-td2-center">
			   <input type='text' name='cbMssrxmYz'
								id='' style='text-align:right' value='0.00' size='13'
								onblur="" onchange="checkNum(this);cbsjHj('Mssrxm')">
								<xsl:attribute name="value">
									<xsl:value-of select="cbMssrxmYz" />
								</xsl:attribute>
						  </input>
			   <img onclick="doDeleteCbRow(this,'Mssrxm')" src="" alt="删除" name="delete_image" id="delete_image"  style="cursor:hand"/>
			</td>
	   </tr>
	</xsl:template>
<xsl:template match="//cbsbsj/cbJzmzxmList">
	   <tr id='tr_Jzmzxm'> 
	       <td colspan="1" width="5%" nowrap="nowrap" class="2-td2-left"><div align="center">&#160;
	       	<input type="hidden" name="cbJzmzxmYzhc" value="" id="" >								
	       							<xsl:attribute name="value">
									<xsl:value-of select="cbJzmzxmYzhc" />
								</xsl:attribute>
			</input></div></td>
	       <td colspan="2" width="60%" nowrap="nowrap" class="2-td2-left"><div align="left">&#160;&#160;&#160;&#160;</div></td>
	       <td colspan="2" width="15%" nowrap="nowrap" class="2-td2-left"><div align="center" name='jzmzxm_div' id='jzmzxm_div'>
	            <input type="hidden" name="cbJzmzxmDmhc" value="" id="">
	            	    <xsl:attribute name="value"><xsl:value-of select="cbJzmzxmDmhc" /></xsl:attribute>
				</input>
                <input type="hidden" name="cbJzmzxmDm" value="" id="">
            	       	<xsl:attribute name="value"><xsl:value-of select="cbJzmzxmDm" /></xsl:attribute>
				</input>                
	       </div></td>
	       <td colspan="2" width="15%" nowrap="nowrap" class="2-td2-center">
			   <input type='text' name='cbJzmzxmYz'
								id='' style='text-align:right' value='0.00' size='13'
								onblur="" onchange="checkNum(this);cbsjHj('Jzmzxm')">
								<xsl:attribute name="value">
									<xsl:value-of select="cbJzmzxmYz" />
								</xsl:attribute>
						  </input>
			   <img onclick="doDeleteCbRow(this,'Jzmzxm')" src="" alt="删除" name="delete_image" id="delete_image"  style="cursor:hand"/>
			</td>
	   </tr>
	</xsl:template>			
<xsl:template match="//cbsbsj/cbJmxmList">
	   <tr id='tr_Jmxm'> 
	       <td colspan="1" width="5%" nowrap="nowrap" class="2-td2-left"><div align="center">&#160;
	       	<input type="hidden" name="cbJmxmYzhc" value="" id="" >								
	       							<xsl:attribute name="value">
									<xsl:value-of select="cbJmxmYzhc" />
								</xsl:attribute>
			</input></div></td>
	       <td colspan="2" width="60%" nowrap="nowrap" class="2-td2-left"><div align="left">&#160;</div></td>
	       <td colspan="2" width="15%" nowrap="nowrap" class="2-td2-left"><div align="center" name='jmxm_div' id='jmxm_div'>
	            <input type="hidden" name="cbJmxmDmhc" value="" id="">
	            	    <xsl:attribute name="value"><xsl:value-of select="cbJmxmDmhc" /></xsl:attribute>
				</input>
                <input type="hidden" name="cbJmxmDm" value="" id="">
            	       	<xsl:attribute name="value"><xsl:value-of select="cbJmxmDm" /></xsl:attribute>
				</input>                
	       </div></td>
	       <td colspan="2" width="15%" nowrap="nowrap" class="2-td2-center">
			   <input type='text' name='cbJmxmYz'
								id='' style='text-align:right' value='0.00' size='13'
								onblur="" onchange="checkNum(this);cbsjHj('Jmxm')">
								<xsl:attribute name="value">
									<xsl:value-of select="cbJmxmYz" />
								</xsl:attribute>
						  </input>
			   <img onclick="doDeleteCbRow(this,'Jmxm')" src="" alt="删除" name="delete_image" id="delete_image"  style="cursor:hand"/>
			</td>
	   </tr>
	</xsl:template>
