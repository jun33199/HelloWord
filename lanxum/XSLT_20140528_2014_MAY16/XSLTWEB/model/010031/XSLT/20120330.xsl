              ...
              <div id="Layer2" style="position:static;">	
				  <table id="wrklistTable" border="1" cellspacing="0" class="table-99" align="center" width="100%">
	                  ...
	                  <tr> 
	                    ...
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="left">实际利润额（4行+5行-6行-7行-8行）</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-center">
	                  ...
	                  <tr> 
	                    ...
	                    <td colspan="2" nowrap="nowrap" class="2-td2-center">
							&#160;<input type='text' name='sl'
								id='11_1' style='text-align:right' value='25' size='13'
	                  ...
	                  <tr> 
	                    ...
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="left">应补（退）所得税额（11行-12行-13行-14行）</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-center">
							<input type='text' name='ybtsdse'
								id='16_1' style='text-align:right' value='0.00' size='13'
								onblur="checkNumInput(this)" onchange="compute_Row_16()" readonly="true">
								<xsl:attribute name="value">
	                  ...
	                  <tr> 
	                    ...
	                    <td colspan="2" nowrap="nowrap" class="2-td2-center">
							<input type='text' name='yqnddjsdse'
								...
								onblur="checkNumInput(this)" onchange="compute_Row_17()" >
								<xsl:attribute name="value">
	                  ...
	                  <tr> 
	                    ...
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="left">本期实际应补（退）所得税额</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-center">
							<input type='text' name='bqsjybtsdse'
								id='18_1' style='text-align:right' value='0.00' size='13'
								onblur="checkNumInput(this)" onchange="compute_Row_18()" readonly="true">
								<xsl:attribute name="value">
	                  ...
	                  <tr> 
	                    ...
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="left">本月（季）应纳税所得额（19行×1/4或1/12）</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-center"><div align="center">---</div></td>
	                  </tr>
	                  <tr> 
	                  ...
	                  <tr> 
	                    ...
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="left">本月（季）应纳所得税额（20行×21行）</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-center"><div align="center">---</div></td>
	                  </tr>
	                  <tr> 
	                  ...
	                  <tr> 
	                    ...
	                    <td colspan="1" rowspan="5" width="20%" class="2-td2-left"><div align="center">总机构</div></td>
	                    <td colspan="1" nowrap="nowrap" width="40%" class="2-td2-left"><div align="left">总机构应分摊所得税额（15行或22行或24行×总机构应分摊预缴比例）</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-center">
							<input type='text' name='zjgyftsdse'
								id='24_1' style='text-align:right' value='0.00' size='13'
								onblur="checkNumInput(this)" onchange="compute_Row_24()" readOnly="true">
								<xsl:attribute name="value">
	                  ...
	                  <tr> 
	                    ...
	                    <td colspan="2" nowrap="nowrap" class="2-td2-center">
							<input type='text' name='czjzfpsdse'
								id='25_1' style='text-align:right' value='0.00' size='13'
								onblur="checkNumInput(this)" onchange="compute_Row_25()" readOnly="true">
								<xsl:attribute name="value">
	                  ...
	                  <tr> 
	                    ...
	                    <td colspan="1" nowrap="nowrap" class="2-td2-left"><div align="left">分支机构应分摊所得税额(15行或22行或24行×分支机构应分摊比例）</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
	                    <td colspan="2" nowrap="nowrap" class="2-td2-center">
							<input type='text' name='fzjgyftsdse'
								id='26_1' style='text-align:right' value='0.00' size='13'
								onblur="checkNumInput(this)" onchange="compute_Row_26()" readOnly="true">
								<xsl:attribute name="value">
					  ...
					  <tr> 
		                ...
		                <td colspan="2" nowrap="nowrap" class="2-td2-center">
							<input type='text' name='zjgdlscjybmyftsdse' 
								id='27_1' style='text-align:right' value='0.00' size='13' 
								onblur="checkNumInput(this)" onchange="compute_Row_27()" >
								<xsl:attribute name="value">
			          ...
			          <tr> 
		                ...
		                <td colspan="1" nowrap="nowrap" class="2-td2-left"><div align="left">&#160;&#160;&#160;&#160;&#160;&#160;总机构已撤销分支机构应分摊所得税额</div></td>
		                <td colspan="2" nowrap="nowrap" class="2-td2-left"><div align="center">---</div></td>
		                <td colspan="2" nowrap="nowrap" class="2-td2-center">
							<input type='text' name='zjgycxfzjgyftsdse' 
								id='28_1' style='text-align:right' value='0.00' size='13' 
								onblur="checkNumInput(this)" onchange="compute_Row_28()" >
								<xsl:attribute name="value">
									<xsl:value-of select="zjgycxfzjgyftsdse" />
								</xsl:attribute>
							</input>
						</td>
			          </tr>
	                  ...
	                  <td colspan="2" nowrap="nowrap" class="2-td2-center">
						  &#160;<input type='text' name='fpbl'
							id='29_1' style='text-align:right' value='0.00' size='13'
							onblur="checkNumInput(this)" onchange="compute_Row_29()">
							<xsl:attribute name="value">
	                  ...
	                  <td colspan="2" nowrap="nowrap" class="2-td2-center">
						  <input type='text' name='fpsdse'
								...
								onblur="checkNumInput(this)" onchange="compute_Row_30()">
								<xsl:attribute name="value">
