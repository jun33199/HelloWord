	...
	<xsl:template match="/">
		...
		<tr>
			...
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						 <input type="text" name="ctqyzsjbh"  tabindex="-1"  class="noborder-txtcenter" readonly="true">
			...
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<input type="text" name="btzqymcjzsbh"  tabindex="-1"  class="noborder-txtcenter" readonly="true">
