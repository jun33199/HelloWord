			...
			<table id="table_30" class="table-99" border="0" cellpadding="0" cellspacing="0">
				...
				<tr> 
					<td class="2-td2-left" align="left">
						<input type='text' name='nsrsbh' id='3_1' size='19' tabindex='15' style='text-align:left' readonly='readonly' class="text-gray">
							<xsl:attribute name="value">
					...
					<td class="2-td2-left" align="left">
						<input type='text' name='nsrmc' id='4_1' size='19' tabindex='15' style='text-align:left' readonly='readonly' class="text-gray">
							<xsl:attribute name="value">
