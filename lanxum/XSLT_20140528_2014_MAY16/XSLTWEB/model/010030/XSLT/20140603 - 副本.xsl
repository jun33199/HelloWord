...
<table width="96%" align="center" cellspacing="0" class="table-99">
	<tr>			
		<td class="1-td1" colspan="7">中华人民共和国企业所得税汇总纳税分支机构所得税分配表</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td class="1-td2" colspan="7"><br/>
			...
			<table id="table_30" class="table-99" border="0" cellpadding="0" cellspacing="0">
				<tr> 
					<td width="15%" colspan="2" class="2-td2-t-left">总机构纳税人识别号</td>
					<td width="15%" class="2-td2-t-left">本月（季）实际应补（退）所得税额</td>
				...
				<tr> 
					...
					<td class="2-td2-left" align="left">
						<input type='text' name='bqsjybtsdse' id='3_1' size='19' tabindex='15' style='text-align:right' onblur="return formatData(this)">
							<xsl:attribute name="value">
				...
				<tr> 
					...
					<td rowspan="2" align="left" class="2-td2-left">分支机构纳税人识别号</td>
					<td rowspan="2" class="2-td2-left">分支机构名称</td>
					<td colspan="3" align="left" class="2-td2-left">三项因素</td>
					<td width="10%" rowspan="2" align="left" class="2-td2-left">分配比例</td>
					<td width="12%" rowspan="2" align="left" class="2-td2-center">分配税额</td>
				</tr>
				<tr> 
					<td class="2-td2-left">营业收入</td>
					<td class="2-td2-left">职工薪酬</td>
				...
				<td align="left" class="2-td2-left"> 
						<input type='text' name='fpblhj' id='10_1' style='text-align:right' value='0' size='13' onblur="checkPercent(this)" readonly='readonly' class="text-gray"> 
							<xsl:attribute name="value">
...
<xsl:template match="taxdoc/fzjgxx/mxxx">
	<tr> 
        ...
        <td align="left" class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' style='text-align:right' value='0' size='13' onblur="checkPercent(this)"> 
