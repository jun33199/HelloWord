			...
			<table cellspacing="0" class="table-99" id="mainTable">
				<tbody>
					<tr>
						...
						<td colspan="3" class="2-td1-left">纳税申报额</td>
					...
					<tr>
						<td class="2-td1-left">
							<font size="2">合同成交额<br/>(1)</font>
						</td>
						<td class="2-td1-left">
							<font size="2">佣金率<br/>(2)</font>
						</td>
						<td class="2-td1-left" nowrap="true">
							<font size="2">核定收入额<br/>(3)=(1)×(2)</font>
						</td>
					</tr>
					<xsl:if test="taxdoc/sbxx/done[.=1]">
						<xsl:for-each select="taxdoc/sbsj">
							...
							<tr>
								...
								<td class="2-td2-left">
									<input maxlength="15" size="15" name="htcje" value="{htcje}">
										<xsl:attribute name="onChange">
									return(htcjeOnChange(this,0,0,<xsl:value-of select="position()"/>));
								</xsl:attribute>
									</input>
								</td>
								<td class="2-td2-left">
									<input maxlength="5" size="5" name="yjl" value="{yjl}">
										<xsl:attribute name="onChange">
										return(yjlOnChange(this,3,<xsl:value-of select="position()"/>));
									</xsl:attribute>
									</input>
								</td>
								<td class="2-td2-left">
									<div id="hdsreDiv" align="right">
										<xsl:value-of select="hdsre"/>
									</div>
									<input type="hidden" name="hdsre" value="{hdsre}"/>
								</td>
								<td class="2-td2-left">
					...
					<tr>
						...
						<TD class="2-td2-left" colSpan="8" noWrap="true">
