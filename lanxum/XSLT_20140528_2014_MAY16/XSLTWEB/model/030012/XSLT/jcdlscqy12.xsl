...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		<table class="table-99" cellspacing="0">
			...
			<tr>
				<td  class="2-td2-left">
					<div align="left">获利年度<font color="#FF0000">*</font></div>
				</td>
				<td  class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<input name="HLND" id="HLND" tabindex="1" type="text" style="text-align:right" size="13" maxlength="4" >
							<xsl:attribute name="value">
			...
			<tr>
				<td width="20%" class="2-td2-left">
					<div align="left">免征年度<font color="#FF0000">*</font></div>
				</td>
				<td  class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
                        从（
						<input size="5" name="MZQSND" type="text" maxlength="4" tabindex="2" id="MZQSND" style="text-align:right" >
							<xsl:attribute name="value">
                                <xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/MZQSND"/>
                            </xsl:attribute>
						</input>
                        ）年至（
                        <input size="5" name="MZZZND" type="text" maxlength="4" tabindex="3" id="MZZZND" style="text-align:right" >
							<xsl:attribute name="value">
			...
			<tr>
				<td width="20%" class="2-td2-left">
					<div align="left">减半征收年度<font color="#FF0000">*</font></div>
				</td>
				<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
                        从（
                        <input size="5" name="JZQSND" type="text" maxlength="4" tabindex="4" id="JZQSND" style="text-align:right" >
							<xsl:attribute name="value">
                                <xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/JZQSND"/>
                            </xsl:attribute>
                        </input>
                        ）年至（
                        <input size="5" name="JZZZND" type="text" maxlength="4" tabindex="5" id="JZZZND" style="text-align:right" >
							<xsl:attribute name="value">
			...
			<tr>
				<td width="20%" class="2-td2-left">
					<div align="left">本年预计的减免税额<font color="#FF0000">*</font></div>
				</td>
				<td  class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<input name="YJJMSE" id="YJJMSE" tabindex="6" maxlength="18" type="text" style="text-align:right" size="13" onchange="return formatKsslJsje(this);">
							<xsl:attribute name="value"><xsl:value-of select="taxdoc/jmsbajl/qysdsjmba/YJJMSE"/></xsl:attribute>
						</input>元
					</div>
				</td>
			</tr>
