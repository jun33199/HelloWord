...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		...
		<input name="bajmsehbl" type="hidden" id="bajmsehbl">
			<xsl:attribute name="value">
				<xsl:value-of select="taxdoc/jmsbajl/bajmsehbl" />
			</xsl:attribute>
		</input>
		...
		<table class="table-99" width="75%" cellspacing="0">
			<tr>
			...
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div align="left">
						<input type="text" name="gjrjpzmc" id="gjrjpzmc"
							maxlength="200" size="30" tabindex="1" value="">
							<xsl:attribute name="value">
								<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/gjrjpzmc">
								</xsl:value-of>
							</xsl:attribute>
						</input>
					</div>
			...
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div align="left">
						<input type="text" name="sdtxnx" maxlength="10"
							size="15" tabindex="2" value="">
							<xsl:attribute name="value">
								<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/sdtxnx">
								</xsl:value-of>
							</xsl:attribute>
						</input>
						年
			...
			<tr>
				...
				<td class="2-td2-center">
					<div align="left">
						<input id="jtzjqsnd" type="text" size="15" tabindex="3" maxlength="4">
							<xsl:attribute name="value">
								<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/jtzjqsnd">
								</xsl:value-of>
							</xsl:attribute>
						</input>
						年
			...
			<tr>
				...
				<td class="2-td2-center">
					<div align="left">
						<input id="jtzjzznd" type="text" size="15" tabindex="4" maxlength="4">
							<xsl:attribute name="value">
								<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/jtzjzznd">
								</xsl:value-of>
							</xsl:attribute>
						</input>
						年
			...
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						...
						<input type="text" name="kkczje" maxlength="18"
							size="15" tabindex="5" value=""
							onchange="return formatKsslJsje(this);">
							<xsl:attribute name="value">
								<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/kkczje">
								</xsl:value-of>
							</xsl:attribute>
						</input>
						元
			...
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						...
						<input type="text" name="zcyz" maxlength="18"
							size="15" tabindex="6" value=""
							onchange="return formatKsslJsje(this);">
							<xsl:attribute name="value">
								<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/zcyz">
								</xsl:value-of>
							</xsl:attribute>
						</input>
						元
			...
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						...
						<input type="text" name="yjtzjnx" maxlength="10"
							size="15" tabindex="7" value="">
							<xsl:attribute name="value">
								<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/yjtzjnx">
								</xsl:value-of>
							</xsl:attribute>
						</input>
						年
			...
			<tr>
				...
				<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						...
						<input type="text" name="yjtzje" maxlength="18"
							size="15" tabindex="8" value=""
							onchange="return formatKsslJsje(this);">
							<xsl:attribute name="value">
								<xsl:value-of
									select="taxdoc/jmsbajl/qysdsjmba/yjtzje">
								</xsl:value-of>
							</xsl:attribute>
						</input>
						元
