...
<xsl:output method="html"/>
	...
	<xsl:template match="taxdoc/nsrxx">
		...
		<tr>
		 <td class="1-td2"  colspan="7"><div align="center">税款所属日期：<xsl:value-of select="//skssksrq"/>&#160;至&#160;<xsl:value-of select="//skssjsrq"/></div></td>
		</tr>
		<tr>
		 <td class="1-td2"  colspan="7"><div align="left">&#160;&#160;&#160;&#160;纳税人地税计算机代码:<xsl:value-of select="jsjdm"/>&#160;&#160;&#160;&#160;
		 注册资本(万元，必填项)：					
		 <input type='text'  name='zczbje' id='zczbje'   size='13' tabindex='1' onblur ='return formatData10(this,1);' >
...
&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;</div></td>
		...
		<tr>
		 <td class="1-td2"  colspan="7"><div align="left">&#160;&#160;&#160;&#160;申报日期:<xsl:value-of select="//sbrqshow"/>&#160;&#160;&#160;&#160;&#160;
		 资产总额(万元，必填项)：<input type='text'  name='zcze_ljs' id='zcze_ljs'   size='13' tabindex='1' onblur ='return formatData10(this,0);' > 
		    <xsl:attribute name="value"><xsl:value-of select="//zcze_ljs"/></xsl:attribute></input>&#160;&#160;</div></td>
		</tr>
		<tr>
		 <td class="1-td2"  colspan="7"><div align="left">&#160;&#160;&#160;&#160;纳税人名称：<xsl:value-of select="nsrmc"/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;金额单位：元（列至角分）</div></td>
		</tr>	
	</xsl:template>
