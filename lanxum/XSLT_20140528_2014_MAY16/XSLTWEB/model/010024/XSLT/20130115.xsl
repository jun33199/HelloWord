		...
		<tr>
			<td class="1-td2"  colspan="7">
				<div align="left">&#160;&#160;&#160; 注册资本(万元)：					
					<input type='text' name='zczb' id='zczb' size='13' tabindex='1' onblur ='return formatData10(this,1);' >
						<xsl:attribute name="value">
							<xsl:value-of select="//zczb" />
						</xsl:attribute>
					</input>
					&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;资产总额(万元)：
					<input type='text' name='zcze' id='zcze' size='13' tabindex='1' onblur ='return formatData10(this,0);' > 
			    		<xsl:attribute name="value">
