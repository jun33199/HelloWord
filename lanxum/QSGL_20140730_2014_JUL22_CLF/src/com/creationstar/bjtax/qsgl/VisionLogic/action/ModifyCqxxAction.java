...
public class ModifyCqxxAction extends BaseAction {
    /**
     *
    ...
    public ActionForward doShow(ActionMapping mapping,
        ...
        //获取选中的拆迁信息
        Jsblcq jsblcq = (Jsblcq) (sbxxForm.getCqList().get(sbxxForm.getFwindex()));
        jsblcq.setSbbh(sbxxForm.getSbbh());
    ...
    public ActionForward doSave(ActionMapping mapping,
        ...
        try {
            ...
            // 从Form中获取对象。
            Object obj = ((CqxxForm) form).getDataForUpdate();
            Debug.out("ModifyCqAction doSave form.getData() obj.class is " +
            ...
            request.setAttribute(Constants.MESSAGE_KEY, "拆迁修改成功！");
