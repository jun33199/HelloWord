 ...
 */
public class QueryPlslForm2 extends QueryBaseForm {
    /**
     *查询条件
     */
    ...
    public void createViewForm() {
        ...
        if (from.equals("cx")) {
            PlsbBo2 plsbBo = (PlsbBo2) queryCache.getDataDetail(viewIndex);
            this.plBo = plsbBo;
            zb = plsbBo.getDrzb();
        }
        ...
        try {
            ...
            bo = (PldrBo2) QsglPcclXmlUtil.getRecord2(zb.getDrsjnr());
        } catch (Exception ex) {
            Debug.out("queryPlslForm2中获取viewform时解析xml出错");
            ex.printStackTrace();
        }
    ...
    public void setPlBo(PlsbBo2 plBo) {
        this.plBo = plBo;
    }
