...
import com.creationstar.bjtax.qsgl.VisionLogic.form.QueryPlcxMxForm2;
 ...
 */
public class ViewPlcxAction2 extends QueryBaseAction {
    ...
    public ActionForward doQuery(ActionMapping mapping,
        ...
        try {
            ...
            QueryPlcxMxForm2 queryForm = (QueryPlcxMxForm2) form;
    ...
    public ActionForward doReturn(ActionMapping mapping,
        ...
        request.getSession().removeAttribute("queryPlcxForm2");
        //保存Token;
        saveToken(request);
...

    {
        ...
        QueryPlcxMxForm2 queryForm = null;
        VOPackage vo = new VOPackage();
        //执行Processor
        try {
            //初始化
            // 将参数中的Form构型为QueryBaseForm。
            queryForm = (QueryPlcxMxForm2) form;
            Object obj = queryForm.getData();
            // 调用BaseProxy的query方法，查询数据。
            HttpSession session = request.getSession();
