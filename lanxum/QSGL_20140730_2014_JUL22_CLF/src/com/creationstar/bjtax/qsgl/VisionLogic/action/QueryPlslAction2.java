 ...
 */
public class QueryPlslAction2 extends QueryBaseAction {
        ...
        try {
            ...
            if (list != null && list.size() > 0) {
                for (int i = 0; i < list.size(); i++) {
                    PlsbBo2 bo = (PlsbBo2) list.get(i);
                    Drzb dz = bo.getDrzb();
                    PldrBo2 pdbo = new PldrBo2();
                    pdbo = (PldrBo2) QsglPcclXmlUtil.getRecord2(dz.getDrsjnr());
