...
import com.creationstar.bjtax.qsgl.VisionLogic.form.ReceivePlslForm;
 ...
 */
public class ReceviePlslAction extends BaseAction {
    /**
     * 受理记录
    ...
    public ActionForward doReceive(ActionMapping mapping,
        ...
        try {
            ...
            ReceivePlslForm pForm = (ReceivePlslForm) form;
            // 从Request中获取对象。
