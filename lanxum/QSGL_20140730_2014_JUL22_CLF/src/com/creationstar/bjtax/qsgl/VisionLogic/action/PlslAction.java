 ...
 * @version 1.0
 */
public class PlslAction extends QueryBaseAction {
    /**
     * 即时办理--查询申报相关信息
                    ...
                    try {
                        ...
                        if (zb.getNsrjsjdm() == null) {
                            ...
                            flag = DAOFactory.getInstance().getDrzbDAO().
                                   querydrGrxx(zb.getFdcxmmc(), zb.getFdcdz(),
                            ...
                            flag = DAOFactory.getInstance().getDrzbDAO().
                                   querydrFgrxx(zb.getFdcxmmc(), zb.getFdcdz(),
    ...
    public ActionForward doCheck(ActionMapping mapping,
        ...
        try {
            ...
            //System.out.println("length:"+selstr.length());
            //重新构造链表
            ...
            if (list != null && list.size() > 0) {
                for (int i = 0; i < list.size(); i++) {
                    ...
                    bo = (PldrBo) QsglPcclXmlUtil.getRecord(dz.getDrsjnr());
