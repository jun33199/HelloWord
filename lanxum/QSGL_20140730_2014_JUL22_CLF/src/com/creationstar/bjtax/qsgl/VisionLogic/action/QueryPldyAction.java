...
import com.creationstar.bjtax.qsgl.VisionLogic.form.PldyForm;
...
public class QueryPldyAction extends QueryBaseAction {
    ...
    public ActionForward doQuery(ActionMapping mapping,
        ...
        try {
            ...
            PldyForm queryForm = (PldyForm) form;
    ...
    public ActionForward doBack(ActionMapping mapping,
        ...
        Debug.out("come in============================");
        // 回填查询条件和结果集
        PldyForm dyForm = (PldyForm) form;
        PldyBo pldyBo = (PldyBo) dyForm.getQueryObj();
    ...
    public ActionForward doPrint(ActionMapping mapping,
                                 ...
                                 HttpServletRequest request,
                                 HttpServletResponse response) {
        PldyForm pldyForm = (PldyForm) form;
        // 需要导出的xml文件内容
        String xmlContent = "";
        try {
            xmlContent = QsglPcclXmlUtil.createXML(pldyForm.getResultList());
