...
import com.creationstar.bjtax.qsgl.VisionLogic.form.PlslForm;
 ...
 * @version 1.0
 */
public class ViewPlslAction extends BaseAction {
    public ActionForward doSave(ActionMapping mapping,
                                ActionForm actionform,
                                HttpServletRequest request,
                                HttpServletResponse response) {
        HttpSession session = request.getSession(false);
        QueryPlslForm aForm = (QueryPlslForm) session.getAttribute(
                "queryPlslForm");
        ...
        session.setAttribute("queryPlslForm", aForm);
    ...
    public ActionForward doDelete(ActionMapping mapping,
        ...
        try {
            ...
            HttpSession session = request.getSession(false);
            QueryPlslForm queryForm = (QueryPlslForm) session.getAttribute(
                    "queryPlslForm");
