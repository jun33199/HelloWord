...
public class PldyProcessor extends CommonProcessor {
    public Object process(VOPackage vo) throws BaseException {
        Object result = null;
        PldyBo bo = (PldyBo) vo.getData();
        // 批次号
        ...
        String where =
                " where rownum<202 and  a.sjly='02' and c.sjly='05' and a.drpch=c.drpch";
        if (vo == null) {
        ...
        try {
            ...
            ErrorLog.makeLog(vo.getUserData(), "契税申报征收－PldyProcessor，操作出错",
...
//          ArrayList fwjhxxList;
            ...
            tmpPldrBo.setHdbo(CommonUtil.getJZSE(tmpPldrBo, conn));
