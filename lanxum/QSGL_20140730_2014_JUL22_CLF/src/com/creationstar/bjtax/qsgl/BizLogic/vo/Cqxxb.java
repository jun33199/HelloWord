...
public class Cqxxb implements Serializable {
    ...
    private BigDecimal bcje; //'补偿金额'
    private String bclxdm; //'补偿类型代码'
    private String bclxmc; //'补偿类型名称'
    private BigDecimal bcmj; //'补偿面积'
    ...
    private BigDecimal cqmj; //'拆迁面积'
    private String swjgzzjgmc; //'税务机关组织机构名称'

    private String bcjeBegin; //补偿金额
    private String bcjeEnd; //补偿金额
    ...
    private Timestamp cqxkzspsj; //'拆迁许可证审批时间'
