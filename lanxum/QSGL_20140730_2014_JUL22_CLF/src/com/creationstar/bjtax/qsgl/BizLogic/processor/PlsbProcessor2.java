...
import com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2;
 ...
 */
public class PlsbProcessor2 implements Processor {
    ...
    public Object process(VOPackage vo) throws BaseException {
        ...
        Debug.out("--Debug-- Info : Here is PlsbProcessor2.process(vo)");
    ...
    private Object doQuery(VOPackage vo) throws BaseException {
        ...
        try {
            ...
            resultList = DAOFactory.getInstance().getDrzbDAO().queryDrxx2(
                    conditions, conn);

        } catch (Exception ex) {
            // 处理失败信息:控制台 ＋ 日志
            Debug.printException(ex);
            ErrorLog.makeLog(vo.getUserData(), "契税申报征收－PlsbProcessor2，操作出错",
...
//            conditions += " and " + datafilter;
            ...
            // 处理失败信息:控制台 ＋ 日志
            Debug.printException(ex);
            ErrorLog.makeLog(vo.getUserData(), "契税批量处理－PlsbProcessor2，操作出错",
                             new StackMsg2StringUtil(ex,
                    Constants.STACK_MSG_CAP).getStackMsg(), "失败");
     ...
     * @return ArrayList of JsblBo
     * @throws BaseException
     * TODO A 需要修改check方法，得到批量导入的PldrBo2后，校验是否有问题，然后把有问题的PldrBo2放到list中返回。
     */
        ...
        try {
            ...
            if (checkList != null && checkList.size() > 0) {
                for (int i = 0; i < checkList.size(); i++) {
                    ...
                    zt = "0";
                    //获取传递过来的对象
                    PldrBo2 bo = (PldrBo2) checkList.get(i);
                    //个人信息
                    ArrayList grxxList = bo.getGrxxList();
                    //非个人信息
                    ArrayList fgrxxList = bo.getFgrxxList();

                    System.out.println("个人信息:" + grxxList.size());
                    ...
                    //错误数据内容值对象
                    PlsbErrBo2 plsbErrBo = new PlsbErrBo2();
                    ...
                    for (int m = 0; m < grxxList.size(); m++) {
                        ...
                        if (grxx != null && zt.equals("0")) {
                            ...
                            try {
                                //grxx.getf
                                //System.out.println("/////////////////////////////");
                                //System.out.println("zjlxdm:" + grxx.getSfzjlx());
                                //System.out.println("/////////////////////////////");
                    ...
                    if (fwjhxxList != null && fwjhxxList.size() > 0 &&
                        ...
                        for (int m = 0; m < fwjhxxList.size(); m++) {
                            //获取传递过来的对象
                            PldrBo2 bo1 = (PldrBo2) fwjhxxList.get(i);
        ...
        try {
            ...
            if (receiveList != null && receiveList.size() > 0) {
                ...
                for (int i = 0; i < receiveList.size(); i++) {
                    ...
                    /**
                     * 加入"数据来源"-- 04-批量导入（税务人员）,05-批量导入（开发商）
                     */
                    //  sbzb.sjly = "04";
                    ...
                    if (gyzfxxList != null && gyzfxxList.size() > 0) {
                        for (int k = 0; k < gyzfxxList.size(); k++) {
                            ...
                            //更新主表办理减免税标识
                            bo.setSbzb(sbzb);
                            JghdsjBo hdbo = CommonUtil.getJZSE2(bo, conn);
                            //获取已购公有住房项
    ...
    private Object doDeletePc(VOPackage vo) throws BaseException {
        ...
        try {
            ...
            // 处理失败信息:控制台 ＋ 日志
            Debug.printException(ex);
            ErrorLog.makeLog(vo.getUserData(), "契税申报征收－PlsbProcessor2，删除数据操作出错",
                             new StackMsg2StringUtil(ex,
                    Constants.STACK_MSG_CAP).getStackMsg(), "失败");
            throw ExceptionUtil.getBaseException(ex);
        } finally {
