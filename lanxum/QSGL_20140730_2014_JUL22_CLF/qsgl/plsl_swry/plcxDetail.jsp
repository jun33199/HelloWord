...
<html:form action="/plsl_swry/pltjDetail.do">
    <input type="hidden" name="operationType" value="">
    <html:hidden name="queryPlcxMxForm2" property="pch"/>
     <html:hidden name="queryPlcxMxForm2" property="zt"/>

          <logic:equal name="queryPlcxMxForm2" scope="session" property="status" value="Result">
              <input type="hidden" name="changePage" value='<bean:write name="queryPlcxMxForm2" property="queryCache.currentPageNum"/>'>
              <input type="hidden" name="pageCount" value='<bean:write name="queryPlcxMxForm2" property="queryCache.pageCount"/>'>
          <table cellspacing="0" class="table-99">
            <tr>
            <td class="2-td2-t-left">查询结果</td>
           <!--如果结果集为空，提示没有记录-->
           <logic:equal name="queryPlcxMxForm2" property="queryCache.pageCount" scope="session" value="0">
            <td class="2-td2-t-center"> <div align="center">没有你要的记录，请重新查询</div></td>
           </logic:equal>
           <logic:notEqual name="queryPlcxMxForm2" property="queryCache.pageCount" scope="session" value="0">
              <td class="2-td2-t-center"> <div align="right">
               共<bean:write name="queryPlcxMxForm2" property="queryCache.countNumber"/>条记录
               第<bean:write name="queryPlcxMxForm2" property="queryCache.currentPageNum"/>/
               <bean:write name="queryPlcxMxForm2" property="queryCache.pageCount"/>页
                ...
                <!--如果只有一页，下面按钮不显示-->
                <logic:equal name="queryPlcxMxForm2" property="queryCache.isOnePage" scope="session" value="false">
                  <!--如果是第一页，前页不显示-->
                  <logic:equal name="queryPlcxMxForm2" property="queryCache.hasPrev" scope="session" value="true">
                  ...
                  <!--如果是最后一页，后页不显示-->
                  <logic:equal name="queryPlcxMxForm2" property="queryCache.hasNext" scope="session" value="true">
      ...
      <logic:iterate id="data" indexId="index" length="length" name="queryPlcxMxForm2" property="queryCache.currentPage"
            type="com.creationstar.bjtax.qsgl.model.bo.PlcxMxBo2">
            <tr>
