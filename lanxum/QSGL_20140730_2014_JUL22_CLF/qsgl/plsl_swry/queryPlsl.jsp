    ...
    <td vAlign=top>
      <table align=center cellSpacing=0 class=table-99>
        ...
        <TR>
          <td class=1-td2 vAlign=top>
            <html:form action="/plsl_swry/plslQuery.do">
              ...
              <TBODY>
               ...
               <TR>
                ...
                <td class="2-td2-right">
                  <DIV align=left>
				       <html:select name="queryPlslForm2" property="sl" >
               ...
               <TR>
                ...
                <td class="2-td2-right">
				<DIV align=left>
                                          <bean:define id="jsfs" name="queryPlslForm2" property="jkfsList"  />
     ...
     <logic:equal name="queryPlslForm2" property="status" scope="session" value="Result">
      ...
      <logic:iterate id="data" indexId="index" length="length" name="queryPlslForm2" property="queryCache.currentPage"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbBo2">
            <tr>
              <td class="2-td2-left">
<logic:equal name="queryPlslForm2" property="sl"  value="received">
              <input type="checkbox" name="selectedIndex" disabled="true"
                     onclick="FN_setChkState()" value="<%=index.intValue()%>">
</logic:equal>

<logic:equal name="queryPlslForm2" property="sl"  value="unreceived">
              <input type="checkbox" name="selectedIndex"
                     onclick="FN_setChkState()" value="<%=index.intValue()%>">
</logic:equal>

<logic:equal name="queryPlslForm2" property="sl"  value="all">
              <input type="checkbox" name="selectedIndex" disabled="true"
                     onclick="FN_setChkState()" value="<%=index.intValue()%>">
</logic:equal>
              </td>
