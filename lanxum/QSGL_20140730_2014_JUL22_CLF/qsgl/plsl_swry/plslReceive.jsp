...
<%@ page import="com.creationstar.bjtax.qsgl.VisionLogic.form.ReceivePlslForm2"%>
...
<html:form action="/plsl_swry/plslReceive.do">
<html:hidden property="operationType"/>

<%

ReceivePlslForm2 aform = (ReceivePlslForm2)session.getAttribute("receivePlslForm2");
...
<logic:iterate id="fgrsp" indexId="index" length="length" name="receivePlslForm2" property="fgrspList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="spti" indexId="index" length="length" name="receivePlslForm2" property="sptsList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="nsrgr" indexId="index" length="length" name="receivePlslForm2" property="nsrgrList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="nsrfgrdm" indexId="index" length="length" name="receivePlslForm2" property="nsrfgrdmList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="nsrfgrmc" indexId="index" length="length" name="receivePlslForm2" property="nsrfgrmcList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="spje" indexId="index" length="length" name="receivePlslForm2" property="spjeList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="spyy" indexId="index" length="length" name="receivePlslForm2" property="spyyList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="tu" indexId="index" length="length" name="receivePlslForm2" property="tufwxxList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="cqbce" indexId="index" length="length" name="receivePlslForm2" property="cqbceList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="cqsye" indexId="index" length="length" name="receivePlslForm2" property="cqsyeList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="gfcjjg" indexId="index" length="length" name="receivePlslForm2" property="gfcjjgList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
...
<logic:iterate id="gfsye" indexId="index" length="length" name="receivePlslForm2" property="gfsyeList"
            type="com.creationstar.bjtax.qsgl.model.bo.PlsbErrBo2">
            <tr>
              <td class="2-td2-left">
