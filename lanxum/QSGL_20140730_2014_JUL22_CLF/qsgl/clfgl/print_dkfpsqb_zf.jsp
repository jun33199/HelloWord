...
<BODY bgColor=#ffffff leftMargin=0 style="MARGIN: 0px" topMargin=0
	...
	<table width="80%" border="0" align="center" cellspacing="0" class="table-99">
		<tr>
			<td colspan="15">
					<h3>个&nbsp;人&nbsp;销&nbsp;售&nbsp;已&nbsp;购&nbsp;房&nbsp;屋&nbsp;涉&nbsp;税&nbsp;申&nbsp;报&nbsp;核&nbsp;定&nbsp;表&nbsp;<br>(代&nbsp;开&nbsp;发&nbsp;票&nbsp;申&nbsp;请&nbsp;表)</h3>
				          编号（流水号）：<bean:write name="ClfswjghdxxlrForm" property="sbbh"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;受理日期：<bean:write name="ClfswjghdxxlrForm" property="slrq"/> <br>
	...
	<html:form action="/clfgl/clfxxcj.do" type="POST">
		<TABLE align=center border=0 cellPadding=0 cellSpacing=0 width=90%>
										...
										<td>
											...
											<tr>
												<td colspan="6"  class="td1-center">
													<table cellSpacing=0>
														<tr>
															<td class=2-td1-left align="left" width="1%" rowspan="19">纳<br>税<br>人<br>填<br>写</td>
															<%
																...
																<td colspan="6" class="2-td1-center" width="99%">
																	...
																	<tr>
																		<td class=2-td2-left colspan="4" style="border-left: 0px solid #9BB4CA;"><font style="font-weight:bold;">申请人信息</font></td>
																	</tr>
																	<tr>
																		<td class=2-td2-noleft align="left" width="30%"><div align="left">申请人（卖方）姓名</div></td>
																		<td class=2-td2-left width="20%" >&nbsp;联系电话</td>
																		<td class=2-td2-left width="20%" ><div align="left">申请人（卖方）合法身份证件</div></td>
																		<td class=2-td2-center style="border-right: 0px solid;" width="30%"  >证件号码</td>
																    </tr>
																    <%
																	...
																	<% }%>
																	<tr>
																		<td class=2-td2-left colspan="4" style="border-left: 0px solid #9BB4CA;"><font style="font-weight:bold;">付款方信息</font></td>
																	</tr>
														...
														<tr>
															...
															<tr>
																...
																<td class=2-td2-left width="30%" id="gfzmrqShow" style="font-weight:bold;" >&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;日</td>
																<td class=2-td2-left width="15%" nowrap="nowrap"><div
															...
															<tr>
																<td class=2-td2-left width="15%" colspan="3"><div align="left">取得房地产时所缴纳的契税金额</div></td>
												...
												<tr>
													<td colspan="6" class="td1-center">
														<table cellSpacing=0 width="100%">
															<tr >
																<td class=2-td1-left rowspan="21" width="1%">税<br>务<br>机<br>关<br>确<br>认</td>
															...
															<tr>
																<td class=2-td2-left  width="18%"  nowrap="nowrap"><div align="left">每平米交易单价</div></td>
																<td class=2-td2-left  width="30%" id="mpmjydjShow" style="font-weight:bold;" >&nbsp;</td>
																<td class=2-td2-left  width="18%"  nowrap="nowrap"><div align="left">每平米核定单价</div></td>
																<td class=2-td2-center   id="mpmhdjgShow" style="font-weight:bold;" >&nbsp;</td>																
															</tr>
															<tr>
																<td class=2-td2-left width="15%" nowrap="nowrap"><div align="left">普通住房最高套总价（万元）</div></td>
															...
															<tr>
																...
																<!-- 5年（含）以上□&nbsp;&nbsp;&nbsp;&nbsp;5年以下3年以上□&nbsp;&nbsp;&nbsp;&nbsp;3年（含）以下 □ -->
																	...
																	<input type="checkbox" value="1" id="zfsjsjfl_1" onclick="return false;">5年以下</input>
																</div></td>
															</tr>
			...
			<!-- 													免征营业税□
																	...
																	<input type="checkbox" value="1" id="grsdszsfs_1" onclick="return false;">征收个人所得税</input>	<br>
																	...
																	<input type="checkbox" value="6" id="tdzsszsfs_6" onclick="return false;">提供评估报告征收土地增值税</input>
																	<input type="checkbox" value="5" id="tdzsszsfs_5" onclick="return false;">核定征收土地增值税</input> 	<br>															
																	<input type="checkbox" value="4" id="tdzsszsfs_4" onclick="return false;">提供购房发票征收土地增值税</input>
																	
																	<input type="checkbox" value="0" id="tdzsszsfs_1" onclick="return false;">免征土地增值税</input>	
																	<input type="checkbox" value="0" id="tdzsszsfs_0" onclick="return false;">不征土地增值税</input> 
																...
																<td colspan="6" class=2-td2-center>
																	<table border=0 cellSpacing=0 width=100%>
																		...
																		<tr>
																			...
																			<td class=2-td2-left width="15%" colspan="3" style="font-weight:bold;"><div align="left" id="yys_show">计税收入&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×5%&nbsp;=</div>
																			</td>
																		...
																		<tr>
																			...
																			<td class=2-td2-left width="15%" colspan="3" style="font-weight:bold;"><div align="left" id="cjs_show">营业税税额&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×7%&nbsp;=</div>
																			</td>
																			<td class=2-td2-left width="15%" nowrap="nowrap"><div align="left">完税凭证号</div></td>
																			<td class=2-td2-center width="30%" colspan="3" style="border-right: 0px solid;">&nbsp;</td>	
																		</tr>
																		<tr>
																			...
																			<td class=2-td2-left width="15%" colspan="3"><div align="left" id="jyffj_show" style="font-weight:bold;">营业税税额&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×3%&nbsp;=</div>
																			</td>
																			<td class=2-td2-left width="15%" nowrap="nowrap"><div align="left">完税凭证号</div></td>
																			<td class=2-td2-center width="30%" colspan="3" style="border-right: 0px solid;">&nbsp;</td>														
																		</tr>
						 												<tr>
																			<td class=2-td2-left style="border-left: 0px solid;" width="15%" nowrap="nowrap"><div align="left">地方教育附加金额</div></td>
																			<td class=2-td2-left width="15%" colspan="3"><div align="left" id="dfjyfj_show" style="font-weight:bold;">营业税税额&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×2%&nbsp;=</div>
																			<td class=2-td2-left width="15%" nowrap="nowrap"><div align="left">完税凭证号</div></td>
																			<td class=2-td2-center width="30%" colspan="3" style="border-right: 0px solid;">&nbsp;</td>																				
																			</td>
																		</tr>
																		...
																		<tr>
																			<td class=2-td2-left style="border-left: 0px solid;" width="15%" nowrap="nowrap"><div align="left">印花税金额</div></td>
																			<td class=2-td2-left width="15%" colspan="3"><div align="left" id="yhsse_show" style="font-weight:bold;">合同价格&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×0.05%&nbsp;=</div>
																			<td class=2-td2-left width="15%" nowrap="nowrap"><div align="left">完税凭证号</div></td>
																			<td class=2-td2-center width="30%" colspan="3" style="border-right: 0px solid;">&nbsp;</td>																				
																			</td>
																		</tr>
																		...
																		<tr>
																			...
																			<td class=2-td2-left width="15%" colspan="3" style="font-weight:bold;"><div
																					align="left" id="tdzzs_HD_show">计税收入&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×5%&nbsp;&nbsp;&nbsp;=</div>
																			</td>
																			<td class=2-td2-left width="15%" nowrap="nowrap"><div
																					align="left">完税凭证号</div></td>
																			<td class=2-td2-center width="30%" colspan="3"
																		...
																		<tr>
																			...
																			<td class=2-td2-left width="15%" colspan="3" style="font-weight:bold;"><div align="left" id="grsds_HD_show" >计税收入&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×1%&nbsp;&nbsp;&nbsp;=</div>
																			</td>
																			<td class=2-td2-left width="15%" nowrap="nowrap"><div align="left">完税凭证号</div></td>
																			<td class=2-td2-center width="30%" colspan="3" style="border-right: 0px solid;">&nbsp;</td>
																		</tr>
																		<tr>
																			...
																			<td class=2-td2-left width="15%" colspan="3" style="font-weight:bold;"><div align="left" id="grsds_AS_show">（房屋转让收入-房屋原值-税金-合理费用）&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×20%&nbsp;=</div>
																			</td>
																			<td class=2-td2-left width="15%" nowrap="nowrap"><div align="left">完税凭证号</div></td>
																			<td class=2-td2-center width="30%" colspan="3" style="border-right: 0px solid;">&nbsp;</td>
																		</tr>
													...
													<td colspan="6" class="td1-center">
														<table cellSpacing=0 width="100%">
															<tr>
																...
																<td class=2-td2-center width="15%" colspan="6" style="border-top: 1px solid #9BB4CA;"><div align="left"><h3>以上提供的信息真实、准确，愿承担相应的法律责任。</h3>
																<h3>纳税人签章： &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	经办人签章：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>经办人身份证号码：&nbsp;&nbsp;&nbsp; 
																</h3></div></td>
															</tr>
...
/* 		var res_fwsyqztfrq = '<bean:write name="ClfswjghdxxlrForm" property="fwsyqztfrq"/>';
    	...
    	//普通住房最高套总价，added by zhangj start，2014.10.15
  ...
  putObjectValue("", "sjhjjeShow", sjhjje);
	...
	*/
	function setSbxx(tdzzssbfs,jssrqrfs){
		...
		var yhsse_show_OBJ = document.all.yhsse_show;//印花税金额
					...
					switch(szsmdm) {
					    ...
					    case '51'://教育费附加
					    	jyffj_show_OBJ.innerHTML = yysse_ZH+ sbxxMsg; 
						 	break;
					    case '16'://印花税
					    	yhsse_show_OBJ.innerHTML = "合同价格"+sbxxMsg;
					    	break;
						case '54'://地方教育费附加
