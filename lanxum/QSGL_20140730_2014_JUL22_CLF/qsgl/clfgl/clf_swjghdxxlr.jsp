...
<%@page import="com.ttsoft.bjtax.sfgl.common.taglib.TableTag"%>
...
<html:hidden property="pageName" value="zf"/>
...
<TABLE align=center border=0 cellPadding=0 cellSpacing=0 height="80%" width="80%">
  ...
  <TR>
    <TD vAlign=top>
	  ...
	  <TBODY>
        <tr>
          <td class="1-td1"><a>个人销售已购房屋涉税申报核定表（住房类代开发票申请表）</a></td>
        </tr>
        <tr>
          <td class="1-td2"> <br>
            <table width="75%" border="0" cellspacing="0" class="table-99">
              <tr>
                ...
                <td  colspan="3" class="2-td2-t-center">
                	<div align="center">经核定为住房&nbsp;<html:radio name="ClfswjghdxxlrForm" property="fwhdlxdm" value="<%=Constants.FWHDLX_HOUSING%>"  onclick="document.all.isQuery.value=false;fzfchange()"/>
                	&nbsp;经核定为非住房&nbsp;<html:radio name="ClfswjghdxxlrForm" property="fwhdlxdm" value="<%=Constants.FWHDLX_NONHOUSING%>" onclick="document.all.isQuery.value=false;if(window.confirm('您确定要将房屋核定类型切换为非住房吗？')){fzfchange();}else{document.all.fwhdlxdm[1].checked=true;}"/></div></td>
              </tr>
            </table>
            <br>
...
<!--               <tr>
            ...
            <table width="75%" border="0" cellspacing="0" class="table-99">
              <tr>
                <td width="10%" class="2-td2-t-left"><div align="center">申请人现住址</div></td>
                <td colspan="6" class="2-td2-t-center"><div align="left"><html:text property="sqrxzdz" size="99%" />&nbsp;</div></td>
              </tr>
              <tr>
                <td width="10%" class="2-td2-left"><div align="center">房屋详细地址</div></td>
              ...
              <tr>
                ...
                <td width="300px" class="2-td2-left"><div align="left"><html:text property="jcnd" size="10" maxlength="4"/>&nbsp;<FONT color=red>(yyyy)</FONT>   &nbsp;&nbsp;<input type="checkbox"  id="wjcnd" onclick="setJcnd(this)">无建成年代</div></td>
		...
		<table width="75%" border="0" cellspacing="0" class="table-99">
              ...
              <tr>
                ...
                <td width="18%" class="2-td2-left" colspan="2">
                	<div align="center"><bean:define id="dto" name="ClfswjghdxxlrForm" property="tdjcList"/>
                  		<html:select property="tdjcdm" style='width:165px'>
                  		<html:option value="">请选择</html:option>
                  ...
                  <td class="2-td2-center" colspan="2">
                	<div align="left"><bean:define id="fwszqy_dto" name="ClfswjghdxxlrForm" property="fwszqyList"/>
              ...
              <tr>
              	<td class="2-td2-left" colspan="2"><div align="center"><FONT color=red>普通住房最高套总价（万元）</FONT></div></td>
                <td class="2-td2-left"><div align="left"> <html:text property="fwszqyje" size="20" disabled="true"/>&nbsp;</div></td>
              	<td class="2-td2-left"><div align="center"><FONT color=red>普通住房最高限价</FONT></div></td>
                <td colspan="2" class="2-td2-center"><div align="left"> <html:text property="ptzfzgxj" style='width:165px' disabled="true"/>&nbsp;</div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td  class="2-td2-left" style="border-right-style:none">
                	<div align="right">普通住房&nbsp;<html:radio name="ClfswjghdxxlrForm" property="hfbz" value="<%=Constants.HFBZ_PT%>" disabled="true"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
                <td colspan="2" class="2-td2-left" style="border-left-style:none;">
                	<div align="right">非普通住房&nbsp;<html:radio name="ClfswjghdxxlrForm" property="hfbz" value="<%=Constants.HFBZ_NOTPT%>" disabled="true"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
                <td colspan="4" class="2-td2-center" style="border-left-style:none;">&nbsp;</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="2-td2-left" style="border-right-style:none">
                	<div align="right">征收印花税&nbsp;<html:radio name="ClfswjghdxxlrForm" property="yhszsfs" value="<%=Constants.YHSZSFS_ZS%>"  disabled="true"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
                <td colspan="2" class="2-td2-center" style="border-left-style:none;border-right-style:none;">
                	<div align="right">免征印花税&nbsp;<html:radio name="ClfswjghdxxlrForm" property="yhszsfs" value="<%=Constants.YHSZSFS_FREE%>" disabled="true"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
                <td colspan="3" class="2-td2-center" style="border-left-style:none;">&nbsp;</td>                            
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="2-td2-left"><div align="left"><html:text property="gzf" size="15" onchange="getView()"/>&nbsp;</div></td>                            
              ...
              <tr>
                ...
                <td class="2-td2-left"><div align="left"><html:text property="zfdklx" size="15" onchange="getView()"/>&nbsp;</div></td>
                <td class="2-td2-left"><div align="center">手续费</div></td>    
                <td class="2-td2-left"><div align="left"> <html:text property="sxf" size="15" onchange="getView()"/>&nbsp;</div></td>                                  
              ...
              <tr>
                ...
                <td class="2-td2-left"><div align="left"><html:text property="zfzxfy" size="15" onchange="getView()"/>&nbsp;
                ...
                &nbsp;&nbsp;<input type="checkbox"  id="zfzxfy_check" onclick="setFwzxfy(this)">无装修费用凭证
                </div></td>              
                <td class="2-td2-left"><div align="center">土地出让金</div></td>
                <td class="2-td2-left"><div align="left"><html:text property="tdcrj" size="15" onchange="getView()"/>&nbsp;</div></td>            
              ...
              <tr>
                ...
                <td colspan="3" class="2-td2-left"><div align="left">&nbsp;<label id="showHlfy"><input type="hidden" name="hidd_hlfy" value="<bean:write name="ClfswjghdxxlrForm" property="hlfy" />" > </label></div></td>
...
var tdzzssbfs_checked = document.all.tdzzssbfs;
...
function init(){
	...
	document.all.yhszsfs[1].checked = true;
	if(document.all.isSaved.value!="true" && document.all.isQuery.value!="false"){
		ghytchange();
	}
	...
	//土地增值征收方式默认为免征
	if(document.all.tdzsszsfs[0].checked==false&&
		document.all.tdzsszsfs[1].checked==false&&
		document.all.tdzsszsfs[2].checked==false&&
		document.all.tdzsszsfs[3].checked==false&&
		document.all.tdzsszsfs[4].checked==false){

		document.all.tdzsszsfs[4].checked=true;
	}
	if(document.all.isSaved.value=="false" || (document.all.isSaved.value=="true" && document.all.isQuery.value=="false")){
		document.all.fwcqzbzzflxdm.value="04";
	}
...
function doSubmitForm(operationType)
{
	...
	if(operationType=="Save")
	{
		...
		if(document.forms[0].fwqszylx.value =="04" && (document.forms[0].qszyxsmxdm.value =="" || document.forms[0].qszyxsmxdm.value ==null)){
			...
			alert("当房屋权属转移类型为[房屋赠与]时，房屋权属转移明细为必选项！");
			return false;
		}
...
//    	if(checkradio(tdzzssbfs_checked,<%=Constants.TDZSS_SB_GFFP%>) == false && 
 ...
 //   		document.all.tdzzssbfs[<%=Constants.TDZSS_SB_HDZS%>].checked=true;
//    	}
    	
    	
    	//给   tdzsszsfsSubmit,yhszsfsSubmit赋值	
    	...
    	document.all.yhszsfsSubmit.value=<%=Constants.YHSZSFS_FREE%>;
	    	//给yyszsfsSubmit赋值
...
{	//added by zhangj
	...
	*/
    ...
    //控制计税收入金额，added by zhangj, 2014.10.14
	setJsje_jsfs();	
	/**
	 * 6.控制划分标准
	 * 规则：
	      【普通住房】:满足（1） 或 （2）均可
		   （1） A．房屋容积率在【1.0（含）以上】、
	        ...
	        //C．取【每平米交易单价】和【核定单价】中的最大值，要求最大值小于等于【普通住房最高限价】。
	      	C.取【每平米交易单价】和【核定单价】中的最大值，要求最大值小于等于【普通住房最高限价】;或计税【金额】小于等于【普通住房最高套总价（万元）】
	...
	var fwszqyje=document.forms[0].fwszqyje.value;
	   ...
	   checkradio(cqzbzjzmjfl_checkes,<%=Constants.CQZBZ_JLMX_LOW%>) == true))
	{
		...
		var jsje_fwszqyjg=parseFloat(jsje) - parseFloat(fwszqyje)*10000;
		
		//alert(fwrjl_high_checked+" : "+cqzbzjzmjfl_low_checked+" : "+ptzfzgxjValue+"　：　"+mpmjydj_ptzfzgxj);
		if((fwrjl_high_checked==true && cqzbzjzmjfl_low_checked==true && (!(mpmjydj_ptzfzgxj > 0)||jsje_fwszqyjg<=0)) || is6Type)
    	{
...
if(document.all.isQuery.value!="true"){	
	if(document.all.fwqszylx.value=="04"){		
		/**
		added by zhangj
	 * 8.控制营业税征收方式
	 * 规则：
	...
	/**
	 * 8.控制营业税征收方式
	 * 规则：A.【免征营业税】:划分标准选择为【普通住房】，并且住房使用时间选择【5年（含）以上】;
	 *      B.【差额征收营业税】:划分标准选择为【非普通住房】，并且住房使用时间选择【5年（含）以上】;
	 *      C.【全额征收营业税】:除上面条件外其他全部为【全额征收营业税】;
	 *      D.【免征营业税】金额计算规则与全额征收营业税计算规则一致。
	 */
	 var hfbz_pt_checked = document.all.hfbz[<%=Constants.HFBZ_PT%>].checked;
	 var hfbz_notpt_checked = document.all.hfbz[<%=Constants.HFBZ_NOTPT%>].checked;
	 var zfsjsjfl_five_checked = document.all.zfsjsjfl[<%=Constants.ZFSYSJ_FIVE%>].checked;
	 if((checkradio(hfbz_checked,<%=Constants.HFBZ_PT%>) == true ||  
	 	 checkradio(hfbz_checked,<%=Constants.HFBZ_NOTPT%>) == true) && (
	 	 checkradio(zfsjsjfl_checked,<%=Constants.ZFSYSJ_FIVE%>) == true || 
	 	 checkradio(zfsjsjfl_checked,<%=Constants.ZFSYSJ_THREETOFOIVE%>) == true || 
	 	 checkradio(zfsjsjfl_checked,<%=Constants.ZFSYSJ_THREE%>) == true))
	 {
		if(hfbz_pt_checked==true && zfsjsjfl_five_checked==true)
    	{
			initradio(yyszsfs_checked,<%=Constants.YSSZSFS_NOT%>);
			putObjectValue(document.forms[0].yyszsfsSubmit,"",<%=Constants.YSSZSFS_NOT%>);
    	}
    	else if(hfbz_notpt_checked==true && zfsjsjfl_five_checked==true)
    	{
    		initradio(yyszsfs_checked,<%=Constants.YSSZSFS_MINUS%>);
    		putObjectValue(document.forms[0].yyszsfsSubmit,"",<%=Constants.YSSZSFS_MINUS%>);
    	}
	...
	/**
	 * 9.控制个人所得税征收方式
	 * 规则：A.【免征个人所得税】:家庭唯一生活用房选择为【是】，并且住房使用时间选择【5年（含）以上】;
	 *      C.【征收个人所得税】:除上面条件外其他全部为【征收个人所得税】;
	 */
	var jtwyshyhbz_yes_checked = document.all.jtwyshyhbz[<%=Constants.ONLY_ROOM_YES%>].checked;
	if((checkradio(jtwyshyhbz_checked,<%=Constants.ONLY_ROOM_YES%>) == true ||  
	 	 checkradio(jtwyshyhbz_checked,<%=Constants.ONLY_ROOM_NOT%>) == true) && (
	 	 checkradio(zfsjsjfl_checked,<%=Constants.ZFSYSJ_FIVE%>) == true || 
	 	 checkradio(zfsjsjfl_checked,<%=Constants.ZFSYSJ_THREETOFOIVE%>) == true || 
	 	 checkradio(zfsjsjfl_checked,<%=Constants.ZFSYSJ_THREE%>) == true))
	 {
		if(jtwyshyhbz_yes_checked==true && zfsjsjfl_five_checked==true)
    	{
			initradio(grsdszsfs_checked,<%=Constants.GRSDSZSFS_FREE%>);
			putObjectValue(document.forms[0].grsdszsfsSubmit,"",<%=Constants.GRSDSZSFS_FREE%>);
    	}
...
function setFwzxfy(){
		var isChecked = document.all.zfzxfy_check.checked;
		...
		if(isChecked==true){
			...
			putObjectValue(document.forms[0].zfzxfy,"","");
		}
...
function ghytchange(){
	//alert(document.all.pageName.value+"");
	var ghyt=document.forms[0].ghyt.value;	
	if(ghyt==null||ghyt==""){
		document.all.fwhdlxdm[0].checked=true;
	}else{
		if(ghyt=="21"||ghyt=="1"||ghyt=="3"){
			if(window.confirm('房屋划分用途是经济适用住房、普通住宅、别墅，请确定为住房？')){
				document.all.fwhdlxdm[0].checked=true;
			...
			if(window.confirm('房屋划分用途是商业、写字楼、工业厂房、车库，请确定为非住房吗？')){
				document.all.fwhdlxdm[1].checked=true;
				if(document.all.pageName.value=="zf"){			
					fzfchange();
				}
