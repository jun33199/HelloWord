...
<TBODY>
	   <TR>
        ...
        <TR>
        <TD class=1-td2><BR>
        <html:form action="/jks/viewJks.do" >
        <html:hidden property = "operationType" />
<bean:define id="data" name="jksForm" property="jksBo" type="com.creationstar.bjtax.qsgl.model.bo.JksBo"/>
<bean:define id="data1" name="data" property="sbjkzb" type="com.creationstar.bjtax.qsgl.BizLogic.vo.Sbjkzb"/>
		    ...
		    <TR>
			 ...
			 <TR>
		    	<TD  colspan="5" align=left class=2-td2-left width="5%"><div align="left">税款所属时期:</div>&nbsp;</TD>
		    	<TD  colspan="3" class=2-td2-center width="10%"><div align="left"><div align="left">缴款限缴日期:</div><%=DataConvert.TimeStamp2String(data1.getXjrq())%>&nbsp;</TD>
 ...
 <logic:iterate id="data2" indexId="index" length="length" name="data" property="resultList" type="com.creationstar.bjtax.qsgl.BizLogic.vo.Sbjkmx"  >
           <TR>
           	<TD colspan="2" class=2-td2-left width="20%"><bean:write name="data2" property="szsmdm" />&nbsp;</TD>
