...
<HTML><HEAD><TITLE>查询拆迁使用信息</TITLE>
...
function doSubmitForm(operationType)
{
  ...
  {
    if(document.forms[0].cqxyh.value=="" )
    {
        alert("查询条件不能为空！");
     	document.forms[0].cqxyh.focus();
    	return false;
    }
  }
...
<jsp:include page="/include/Header.jsp" flush="true">
                       <jsp:param name="subtitle" value="信息维护>查询拆迁使用信息"/>
...
<TABLE align=center border=0 cellPadding=0 cellSpacing=0 height="80%" width=770>
  ...
  <TR>
    <TD Align=top>
      <TABLE align=center cellSpacing=0 class=table-99>
        <TBODY>
        <TR>
          <TD class=1-td1>查询拆迁使用信息</TD></TR>
        <TR>
          <TD class=1-td2 vAlign=top>
            <html:form action="/xxwh/queryCqxx.do" method="post">
           <input type="hidden" name="operationType" value="">
            ...
            <br>
             <TABLE border="0" cellSpacing=0 class=table-89>
              <TBODY>
               <tr>
                <td class="2-td2-t-left">拆迁协议号</td>
                <td class="2-td2-t-center">
                    <div align=left>
                    <html:text property="cqxyh"  size="25" /><FONT color=red>*</FONT>
					</div>
                </td>
              </tr>
             </TABLE><BR>
  ...
  <logic:equal name="queryCqxxForm" property="afterQuery" scope="session" value="true">

       <table cellspacing="0" class="table-99">
 	  <tr>
		<td><hr class="hr1"></td>
		<td width="140" class="b-black10">
			<div align="center">拆迁使用信息查询结果</div></td>
		<td><hr class="hr1"></td>
	  </tr>
	</table>

          <!--如果结果集为空，提示没有记录-->
           <logic:equal name="queryCqxxForm" property="exist" scope="session" value="false">
           ...
           <logic:equal name="queryCqxxForm" property="exist" scope="session" value="true">
             <TABLE border="0" cellSpacing=0 class=table-99>
               <TBODY>
                 <TR>
                   <TD  align="left" >拆迁详细信息 </TD>
                 </TR>
                 <TR>
                   <TD class="2-td1-left" width = "20%" >被拆迁房屋坐落地址 </TD>
                   <TD class="2-td1-left" width = "20%" >拆迁补偿额</TD>
                   <TD class="2-td1-left" width = "20%" >拆迁补偿剩余额</TD>
                   <TD class="2-td1-left" width = "20%" >申报人</TD>
                   <TD class="2-td1-center" width = "20%" >申报日期</TD>
                 </TR>

                 <TR>
                   <td class="2-td2-left" style="word-break:break-all"><bean:write name="queryCqxxForm" property="zldz"/></td>
                   <td class="2-td2-left"><bean:write name="queryCqxxForm" property="cqbce"/></td>
                   <td class="2-td2-left"><bean:write name="queryCqxxForm" property="cqbcsye"/></td>
                    <td class="2-td2-left"><bean:write name="queryCqxxForm" property="cjr"/></td>
                   <td class="2-td2-center"><bean:write name="queryCqxxForm" property="cjrq"/></td>
                 </TR>
        ...
        <IMG alt=保存 height=22 id=baocun name=Submit63
          ...
          src="<%=static_file%>images/baocun1.jpg" style="CURSOR: hand" width=79>
                 ...
                 <TABLE border="0" cellSpacing=0 class=table-99>
                   <TBODY>
                     <TR>
                       <TD  align="left"  >使用此拆迁的申报信息 </TD>
                     </TR>
                     <TR>

                       <TD class="2-td1-left" width = "30%" >申报表号 </TD>
                       <TD class="2-td1-left" width = "30%" >本次使用补偿额</TD>
                       <TD class="2-td1-left" width = "25%" >申报人</TD>
                       <TD class="2-td1-center" width = "40%" >申报日期</TD>
                     </TR>
      <logic:iterate id="data" name="queryCqxxForm" property="listSbxx"
            type="com.creationstar.bjtax.qsgl.BizLogic.vo.Sbcqgl">
                     <TR>
                         <td class="2-td2-left">
                       ...
                       <td class="2-td2-left"><%=DataConvert.BigDecimal2String(data.getBcsybce())%></td>
