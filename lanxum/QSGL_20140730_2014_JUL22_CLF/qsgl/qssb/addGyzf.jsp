...
<HTML><HEAD><TITLE>录入已购公有住房/经济适用住房信息表</TITLE>
...
function doSubmitForm(operationType){
  ...
  if(operationType=="save")
  {
   ...
   if(document.forms[0].cshtqdsj.value == "" || !checkDate(document.forms[0].cshtqdsj.value))
  	...
  	{
  	   alert("对不起，出售合同（契约）签订时间不能大于当前时间，请重新输入！");
  	   document.forms[0].cshtqdsj.focus();
  	   return false;
  	}

//修改建筑面积为小数点三位，并且当个人建筑面积超过1000平米时给出提示
//modify  by fujx 20081129
//begin
	    if (!FN_QSCheckNumberDigit_Qssb(document.forms[0].jzmj.value,3,"房屋建筑面积"))
	    {
...
function fnChangeCjjg()
{
   ...
   {
      fBckdke = floatplus(floatminus(fCjjg,fOldCjjg) , parseFloat(fBckdke));
   }
   //剩余补偿额=可使用补偿额-本次使用额
...
function fnOnLoad()
{
   ...
   if (document.forms[0].bcdke.value == "")
   {
       document.forms[0].bcdke.value = "0.00";
   }
...
topMargin=0 marginheight="0" marginwidth="0">
 <jsp:include page="/include/Header.jsp" flush="true">
                <jsp:param name="subtitle" value="契税申报&gt;录入已购公有住房/经济适用住房信息表"/>
    ...
    <TD vAlign=top>
        ...
        <TR>
          <TD class=1-td2 vAlign=top>
           <html:form action="/qssb/addGyzf.do">
			  ...
			  <BR>
               ...
               <TR>
                ...
                <TD colspan="4" class=2-td2-center width="15%">
                  <DIV align=left>京<html:text property="fjmc" size="6" maxlength="6"/>地税<html:text property="zsdmc" size="6" maxlength="6"/>契
                  	<html:select property="zflx">
											<html:option value="公">公</html:option>
											<html:option value="经">经</html:option>
										</html:select>
										字<html:text property="nd" size="4" maxlength="4"/>第<html:text property="lsh" size="4" maxlength="5" onchange="doSubmitForm('Get')"/>号<FONT color=red>*</FONT>
                ...
                <TR>
                 ...
                 <TD colspan="4" class=2-td2-center width="25%">
                  <DIV align=left> <html:text property="zldz"  maxlength="190" size="25"/><FONT color=red>*</FONT>&nbsp;</DIV></TD>
                  </TR>
                  <TR>
                 <TD  class=2-td2-left width="15%";>
                   出售合同（契约）签订时间&nbsp;</DIV>
                ...
                <TD colspan="4" class=2-td2-center width="25%">
                  <DIV align=left><html:text property="cshtqdsj" size="25"/> (yyyymmdd)<FONT color=red>*</FONT></DIV></TD>
                  </TR>
                  <TR>
                 <TD class=2-td2-left width="15%";>
                ...
                <TD class=2-td2-left width="25%">
                   <DIV align=left><html:text property="jzmj" maxlength="14" size="18"/> m2<FONT color=red>*</FONT> </DIV></TD>
                ...
                <TD colspan="2"  class=2-td2-center width="32%">
                  <DIV align=left><html:text property="bcdke"  maxlength="15" onchange="javascript:fnChangeBcdke()"/> 元(人民币)<FONT color=red>*</FONT></DIV></TD>
                  </TR>
                   <TR>
                   <TD class=2-td2-left width="17%">
