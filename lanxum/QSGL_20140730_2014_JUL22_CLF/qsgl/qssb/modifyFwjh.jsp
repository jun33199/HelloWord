    ...
    <TD vAlign=top>
        ...
        <TR>
          <TD class=1-td2 vAlign=top width="100%">
            <html:form action="/qssb/modifyFwjh.do">
   ...
   <TBODY>
      <BR>
        <TR>
          ...
          <TD class=2-td2-t-left width="43%" colspan=3><DIV align=left>&nbsp<bean:write name="fwjhxxForm" property="sbbh" /> </DIV></TD>
          ...
          <TR>
            ...
            <TD class=2-td2-left width="34%"> <DIV align=left>
              ...
              <TD class=2-td2-left width="22%">房屋土地房产局受理号</TD>
              <TD class=2-td2-center width="23%"><DIV align=left><html:text name="fwjhxxForm" property="fcjslh" maxlength="30"/></DIV></TD>
            </TR>


          <TR>
            <TD class=2-td2-t-left width="12%">交换对象</TD>
            <TD class=2-td2-t-left width="43%" colspan=3><DIV align=left>
