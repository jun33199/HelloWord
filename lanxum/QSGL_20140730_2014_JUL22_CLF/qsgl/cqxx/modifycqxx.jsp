...
<BODY bgColor=#ffffff leftMargin=0 style="MARGIN: 0px" topMargin=0 marginheight="0" marginwidth="0" onload="filterZjlx()">
 <jsp:include page="/include/Header.jsp" flush="true">
   <jsp:param name="subtitle" value="拆迁信息&gt;修改"/>
  ...
  <TR>
    <td vAlign=top>
      <table align=center cellSpacing=0 class=table-99>
        <TBODY>
        <TR>
          <td class=1-td1>拆迁信息修改</td></TR>
        <TR>
          <td class=1-td2 vAlign=top>
            <html:form action="/cqxx/addCqxx.do">
			  <html:hidden property="cqxxbh"/>
            ...
            <br>
             <table border="0" cellSpacing=0 class=table-60>
              <TBODY>
               <TR>
                ...
                <td class="2-td2-t-right" width="50%">
                  <DIV align=left><html:text property="cqrmc" maxlength=""/></DIV>
                </td>
              </TR>
               <TR>
              ...
              <tr>
                ...
                <td class="2-td2-right">
                  <DIV align=left>
                    <html:text property="cqxxdz" maxlength="" />
                  </DIV>
                </td>
              </tr>
               <TR>
                ...
                <td class="2-td2-right" width="50%">
                  ...
                  <DIV align=left>
                    <html:select property="bclxdm" onchange="changeBclx()">
                      <option value="<%=Constants.BCLX_HB%>">货币</option>
              ...
              <tr>
                ...
                <td class="2-td2-right">
                  <DIV align=left>
                    <html:text property="cqxmmc" maxlength="" />
                  </DIV>
                </td>
              </tr>
              <tr>
