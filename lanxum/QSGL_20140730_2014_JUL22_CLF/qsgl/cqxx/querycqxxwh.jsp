...
function fnMod(operationType,cqxxbh,viewIndex)
{
  document.forms[0].operationType.value=operationType;
  document.forms[0].viewIndex.value=viewIndex;
  if (cqxxbh == "" ){
  	   alert("请选定要修改的拆迁信息！");
  	   return false;
  }
   document.forms[0].cqxxbh.value=cqxxbh;
...
<jsp:include page="/include/Header.jsp" flush="true">
	<jsp:param name="subtitle" value="拆迁信息&gt;维护查询" />
	...
	<TBODY>
		<TR>
			...
			<table align=center cellSpacing=0 class=table-99>
				<TBODY>
					<TR>
						<td class=1-td1>拆迁信息-维护查询</td>
					</TR>
					<TR>
						<td class=1-td2 vAlign=top><html:form action="/cqxx/cqxxWh.do">
							<input type="hidden" name="operationType" value="">
							<input type="hidden" name="sfwh" value="1">
								...
								<logic:notEqual name="cqxxbForm" property="queryCache.pageCount"
									...
									<table cellspacing="0" class="table-99">
										...
										<logic:iterate id="data" indexId="index" length="length"
											...
											<tr>
												<td class="2-td2-left"><input type="checkbox"
													name="selectedIndex" onclick="FN_setChkState()"
													value="<%=index.intValue()%>"></td>
											...
											.getLrrq())%></td>
												...
												<td class="2-td2-center">&nbsp; <IMG alt=修改 height=22
													id=baocun name="btnSave"
													onclick="fnMod('Modify','<bean:write name="data" property="cqxxbh"/>','<%=index.intValue()%>');"
													onmouseout=MM_swapImgRestore()
													onmouseover="MM_swapImage('baocun','','<%=static_file%>images/xiugai2.jpg',1)"
													src="<%=static_file%>images/xiugai1.jpg"
									...
									<table cellspacing="0" class="table-99">
										<tr>
											...
											<div align="left">&nbsp; <input type="checkbox" name="chkall"
												value="checkbox" onclick="javascript:All_quanxuan();">
											是否全选&nbsp; <input type="image" name="delete" value="删除"
												alt="删除" onclick="javascript:return fnDel();"
												onMouseOver="MM_swapImage('shanchu','','<%=static_file%>images/shanchu2.jpg',1)"
												onMouseOut="MM_swapImgRestore()"
												src="<%=static_file%>images/shanchu1.jpg" width="79"
												height="22" id="shanchu"></div>
											</td>

											<td class="2-td2-t-center" align="right"><br>
