...
<HTML><HEAD><TITLE>查询申报数据信息</TITLE>
      ...
      <TABLE align=center cellSpacing=0 class=table-99>
        ...
        <TR>
          <TD class=1-td2 vAlign=top>
            <html:form action="/sh/querySbxx.do">
            <html:hidden property="fromPage" value="2"/>
            <input type = "hidden" name = "operationType" value = "" >
            <html:hidden property="ztbs" value="<%=Constants.ZB_ZTBS_DY%>"/>
            <!--html:hidden property="jmsbs" value="<%=Constants.ZB_BLJMSBS_FHBL_WLR%>"/-->
...
<tr>
               ...
               <tr>
                ...
                <td class="2-td2-left">
                    <div align=left>
						<html:text property="sbbh" size="20"/>
					</div>
                </td>
	...
	<table cellspacing="0" class="table-99">
     ...
     <TABLE border="0" cellSpacing=0 class=table-99>
      ...
      <logic:iterate id="data" indexId="index" length="length" name="querySbxxForm" property="queryCache.currentPage"
            ...
            <tr>
              <td class="2-td2-left">
                  <a href="<%=response.encodeURL("/qsgl/sh/querySbxx.do?operationType=ShowDetail&viewIndex=") + index.intValue()%>">
