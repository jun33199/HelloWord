  ...
  <TR>
    <TD vAlign=top>
      <TABLE align=center cellSpacing=0 class=table-99>
        <TBODY>
        <TR>
          <TD class=1-td1>补录撤销缴款书</TD></TR>
        <TR>
          <TD class=1-td2 vAlign=top>
<html:form action="/qsbl/blCx.do">
<html:hidden property="operationType"/>
            ...
            <table cellspacing="0" class="table-60">
			   ...
			   <tr>
                <td class="2-td2-left">请选择缴款书类型</td>
                <td  class="2-td2-center">
                    <html:select property = "type" >
                        <html:option value = "<%=Constants.PT_JKS%>" >普通缴款书</html:option>
                        <html:option value = "<%=Constants.DZ_JKS%>" >调帐缴款书</html:option>
                    </html:select>
                </td>
              </tr>
 ...
 <logic:equal name="blJksForm" property="status" scope="session" value="Result">
     <TABLE border="0" cellSpacing=0 class=table-99>
      ...
      <logic:iterate id="data1" indexId="index" length="length" name="blJksForm" property="queryCache.currentPage"
