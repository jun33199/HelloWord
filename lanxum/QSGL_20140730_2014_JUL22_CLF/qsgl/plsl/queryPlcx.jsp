      ...
      <table align=center cellSpacing=0 class=table-99>
        ...
        <TR>
          <td class=1-td2 vAlign=top>
            <html:form action="/plsl/pltjQuery.do">
		      <input type="hidden" name="operationType" value="">
              <logic:equal name="queryPlcxForm" property="status" scope="session" value="Result">
                <input type="hidden" name="changePage" value='<bean:write name="queryPlcxForm" property="queryCache.currentPageNum"/>'>
                <input type="hidden" name="pageCount" value='<bean:write name="queryPlcxForm" property="queryCache.pageCount"/>'>
              </logic:equal>
            <br>
...
-->
        <IMG name="back"
          ...
          <table cellspacing="0" class="table-99">
           ...
           <!--如果结果集为空，提示没有记录-->
           <logic:equal name="queryPlcxForm" property="queryCache.pageCount" scope="session" value="0">
            <td class="2-td2-t-center"> <div align="center">没有你要的记录，请重新查询</div></td>
           </logic:equal>
           <logic:notEqual name="queryPlcxForm" property="queryCache.pageCount" scope="session" value="0">
              <td class="2-td2-t-center"> <div align="right">
               共<bean:write name="queryPlcxForm" property="queryCache.countNumber"/>条记录
               第<bean:write name="queryPlcxForm" property="queryCache.currentPageNum"/>/
               <bean:write name="queryPlcxForm" property="queryCache.pageCount"/>页
                ...
                <!--如果只有一页，下面按钮不显示-->
                <logic:equal name="queryPlcxForm" property="queryCache.isOnePage" scope="session" value="false">
                  <!--如果是第一页，前页不显示-->
                  <logic:equal name="queryPlcxForm" property="queryCache.hasPrev" scope="session" value="true">
                  ...
                  <!--如果是最后一页，后页不显示-->
                  <logic:equal name="queryPlcxForm" property="queryCache.hasNext" scope="session" value="true">
      ...
      <logic:iterate id="data" indexId="index" length="length" name="queryPlcxForm" property="queryCache.currentPage"
            type="com.creationstar.bjtax.qsgl.model.bo.PlcxBo">
            <tr>
              <td class="2-td2-left"><div align="left">
              <a href="<%=response.encodeURL("/qsgl/plsl/pltjDetail.do?operationType=Query&zt="+Constants.PC+"&pch=")%><bean:write name="data" property="pch"/>">
              ...
              <logic:notEqual value="0" name="data" property="drbs">
                  <a href="<%=response.encodeURL("/qsgl/plsl/pltjDetail.do?operationType=Query&zt="+Constants.DRZB_ZT_XINZENG+"&pch=")%><bean:write name="data" property="pch"/>">
              ...
              <logic:notEqual value="0" name="data" property="tjbs">
                  <a href="<%=response.encodeURL("/qsgl/plsl/pltjDetail.do?operationType=Query&zt="+Constants.DRZB_ZT_RECIVE+"&pch=")%><bean:write name="data" property="pch"/>">
              ...
              <logic:notEqual value="0" name="data" property="sltgbs">
                  <a href="<%=response.encodeURL("/qsgl/plsl/pltjDetail.do?operationType=Query&zt="+Constants.SBZB_ZT_SHOULI+"&pch=")%><bean:write name="data" property="pch"/>">
              ...
              <logic:notEqual value="0" name="data" property="shtgbs">
                  <a href="<%=response.encodeURL("/qsgl/plsl/pltjDetail.do?operationType=Query&zt="+Constants.SBZB_ZT_SHENHE+"&pch=")%><bean:write name="data" property="pch"/>">
              ...
              <logic:notEqual value="0" name="data" property="fstgbs">
                  <a href="<%=response.encodeURL("/qsgl/plsl/pltjDetail.do?operationType=Query&zt="+Constants.SBZB_ZT_FUHE+"&pch=")%><bean:write name="data" property="pch"/>">
