...
<%@ page import="com.creationstar.bjtax.qsgl.VisionLogic.form.PlslForm"%>
...
function upload(){
   document.forms[0].setz.value='<bean:write name="plslForm" property="setz"/>';
}
...
<BODY bgColor=#ffffff leftMargin=0 style="MARGIN: 0px" topMargin=0 marginheight="0" marginwidth="0" onload="upload()">
...
<br>
 <html:form action="/plsl/plslDetail.do">
          ...
          <TD class=1-td2 vAlign=top>
            ...
            <TABLE border=0 cellSpacing=0 class=tabled-99 width="99%">
			  ...
			  <TR>
				...
				<logic:equal name="plslForm" property="tdbm"  value="1">
				<bean:write name="plslForm" property="tufwxx.fwtdbmdm" />
				</logic:equal>
				</DIV></TD>
			  </TR>
			  </TBODY>
            ...
            <TABLE border=0 cellSpacing=0 class=tabled-99 width="99%">
               <TR>
				...
				<TD class=2-td2-t-left><select name="setz" onchange="checkSelectOne()"><option value="2">全额征收</option>
						<option value="1">减半征收</option>
				<logic:equal name="plslForm" property="person"  value="1">
...
<logic:equal name="plslForm" property="person"  value="1">
              <TR>
                ...
                <DIV align=right>&nbsp; </DIV>
                  <TD class=2-td2-t-left width="20%">
                    <DIV align=left>&nbsp;<bean:write name="plslForm" property="grxx.nsrmc" /> </DIV></TD>
                <TD class=2-td2-t-left width="25%">
                  <DIV align=right>联系电话&nbsp; </DIV></TD>
                <TD colspan="2"  class=2-td2-t-center width="25%">
                   <DIV align=left>&nbsp;<bean:write name="plslForm" property="grxx.lxdh" /> </DIV></TD>
                  </TR>
               <TR>
                 <TD class=2-td2-left >
                ...
                <TD class=2-td2-left >
                  <DIV align=left>
                   &nbsp; <bean:write name="plslForm" property="grxx.sfzjlxmc"/>
                    </DIV></TD>
                <TD   class=2-td2-left >
                  <DIV align=right>身份证件号码&nbsp;</DIV></TD>
                <TD colspan="2"  class=2-td2-center>
                   <DIV align=left>&nbsp;<bean:write name="plslForm" property="grxx.sfzjhm"/> </DIV></TD>
                  </TR>
               <TR>
                 <TD class=2-td2-left >
                ...
                <TD class=2-td2-center colspan="4">
                  <DIV align=left>
                    &nbsp;<bean:write name="plslForm" property="grxx.gjmc"/>
                    </DIV></TD>
                  </TR>
</logic:equal>
...
<logic:equal name="plslForm" property="person"  value="0">
               <html:hidden property="person" value="false"/>
                ...
                <DIV align=right>&nbsp; </DIV>
                  <TD class=2-td2-t-left width="20%">
                    <DIV align=left>
                        &nbsp;<bean:write name = "plslForm" property = "fgrxx.jsjdm" />
                    </DIV>
                  </TD>
                ...
                <TD colspan="2"  class=2-td2-t-center width="25%">
                   <DIV align=left>
                       &nbsp;<bean:write name = "plslForm" property = "fgrxx.nsrlxmc" />
                   </DIV>
                </TD>
             </TR>
             <TR>
                ...
                <TD colspan="4"  class=2-td2-center style="word-break:break-all" >
                   <DIV align=left>
                       &nbsp;<bean:write name = "plslForm" property = "fgrxx.nsrmc" />
                   </DIV>
                 </TD>
                  </TR>
                  <TR>
                ...
                <TD class=2-td2-left >
                  <DIV align=left>
                      &nbsp;<bean:write name = "plslForm" property = "fgrxx.khyhmc" />
                  </DIV>
                </TD>
                <TD class=2-td2-left >
                ...
                <TD colspan="2" class=2-td2-center >
                   <DIV align=left>
                       &nbsp;<bean:write name = "plslForm" property = "fgrxx.yhzh" />
                   </DIV>
                 </TD>
                </TR>
                <TR>
                ...
                <TD class=2-td2-left >
                   <DIV align=left>
                       &nbsp;<bean:write name = "plslForm" property = "fgrxx.lxrxm" />
                   </DIV>
                </TD>
                <TD class=2-td2-left >
                  <DIV align=right>联系电话&nbsp;</DIV></TD>
                <TD colspan="2"  class=2-td2-center>
                   <DIV align=left>
                       &nbsp;<bean:write name = "plslForm" property = "fgrxx.lxdh" />
                   </DIV>
                </TD>
                </TR>
</logic:equal>
...
<logic:equal name="plslForm" property="sp"  value="1">
				<bean:define id="spxx" name="plslForm" property="spjgxx" type="com.creationstar.bjtax.qsgl.BizLogic.vo.Spjgxx"/>
               <TR>
                ...
                <TD colspan="4" class=2-td2-center >
                 <DIV align=left>&nbsp;<bean:write name="plslForm" property="spjgxx.hdtzszh"/> </DIV></TD>
              </TR>
               <TR>
                  <TD class=2-td2-left >
...
<logic:equal name="plslForm" property="sp"  value="0">
               <TR>
                <TD class=2-td2-left rowspan = "2">
                  <DIV align=right>税务机关</DIV>
                  <DIV align=right>审核减免税</DIV></TD>
               ...
               <TR>
                ...
                <TD colspan="5" class=2-td2-center >
                  <DIV align=left>&nbsp;<bean:write name="plslForm" property="tufwxx.bz" />
				</DIV></TD>
                </TR>

	<!-- 房屋基本信息-->
    		    <bean:define id="fwtdVo" name="plslForm" property="tufwxx" type="com.creationstar.bjtax.qsgl.BizLogic.vo.Tufwxx" />
				  <tr>
      ...
      <logic:iterate id="cqdata" indexId="cqindex" length="length" name="plslForm" property="cqxxList"
      ...
      <logic:iterate id="gydata" indexId="gfindex" length="length" name="plslForm" property="gyzfxxList"
           ...
           <!-- 显示房产交换信息-->
      <logic:iterate id="fwjhBo" indexId="fjindex" length="length" name="plslForm" property="fwjhxxList"
	...
	<logic:equal name="plslForm" property="back"  value="dr">
	<tr >
			<td align=center>
	...
	<logic:equal name="plslForm" property="back"  value="cx">
		<tr>
		<logic:equal name="plslForm" property="del"  value="1">
