...
function doSubmitForm(operationType)
{
 ...
 function importConfirm(){
   var ret;
   var drbs=document.forms[0].drbs.value;
   if (drbs=='1'){
      ret = window.showModalDialog("/qsgl/plsl/importFileConfirm.html", "",
          "dialogHeight: 200px;dialogWidth: 300px;status:0");
   }
   if(ret=='yes'){
        document.forms[0].jkfsmc.value = document.forms[0].jkfsdm.options[document.forms[0].jkfsdm.selectedIndex].text;
        document.all.operationType.value = 'ReUpload';
        document.forms[0].submit();
   }
   if(ret=='no'){
        document.all.operationType.value = 'Return';
        document.forms[0].submit();
   }
 }
</script></HEAD>

<BODY bgColor=#ffffff leftMargin=0 topMargin=0 marginheight="0" marginwidth="0" onload="importConfirm()">
<jsp:include page="/include/Header.jsp" flush="true">
<jsp:param name="subtitle" value="批量受理&gt;导入文件"/>
...
<TR>
  <td vAlign=top>
    <TABLE align=center cellSpacing=0 class=table-99>
      <TR>
        <td class=1-td1>导入文件</td>
      </TR>
      <TR>
        <td class=1-td2 vAlign=top>
          <html:form action="/plsl/importFile.do" enctype="multipart/form-data">
            <html:hidden property="operationType"/>
            <html:hidden property="drbs"/>
            <br>
            <table cellspacing="0" class="table-60">
              <tr>
                <td class="2-td2-t-left">选择文件</td>
                <td class="2-td2-t-center">
                  <html:file name="queryPlslForm" property="mofile" size="30"/><FONT color=red>*</FONT>
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">导入批次号</td>
                <td class="2-td2-center">
                  <bean:write name="queryPlslForm" property="msDrpch"/>
              ...
              <tr>
                ...
                <td class="2-td2-center">
                                          <bean:define id="data" name="queryPlslForm" property="jkfsList"  />
            ...
            <table border="0" cellSpacing=0 class=table-99>
              <TBODY>
                <logic:equal name="queryPlslForm" property="mbIsSucceed" scope="session" value="false">
                  <tr>
                  ...
                  <logic:iterate id="data" indexId="index" length="length" name="queryPlslForm" property="mlErrRecords">
                    <tr>
                      <td class="2-td2-left">
