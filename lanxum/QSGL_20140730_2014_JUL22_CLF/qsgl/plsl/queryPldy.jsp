    ...
    <td vAlign=top>
        ...
        <TR>
          <td class=1-td2 vAlign=top>
            <html:form action="/plsl/pldy.do">
              ...
              <logic:equal name="pldyForm" property="status" scope="session" value="Result">
      ...
      <logic:iterate id="data" indexId="index" length="length" name="pldyForm" property="queryCache.currentPage"
            ...
            <tr>
              ...
              <a href="<%=response.encodeURL("/qsgl/plsl/pldy.do?operationType=View&zt="+Constants.PC+"&pch=")%><bean:write name="data" property="drpch"/>">
