...
<HTML><HEAD><TITLE>不征申报数据信息查询表</TITLE>
...
<jsp:include page="/include/Header.jsp" flush="true">
 <jsp:param name="subtitle" value="不征契税查询&gt;不征申报数据信息查询表"/>
  ...
  <TR>
    <TD vAlign=top>
      <TABLE align=center cellSpacing=0 class=table-99>
        <TBODY>
        <TR>
          <TD class=1-td1>查询不征申报数据信息</TD></TR>
        <TR>
          <TD class=1-td2 vAlign=top>
            <html:form action="/bzqslr/queryBzqs">
            <html:hidden property="fromPage" value="1"/>
            ...
            <br>
             <TABLE border="0" cellSpacing=0 class=table-89>
              <TBODY>
               <tr>
                <td class="2-td2-t-left">纳税申报表号</td>
                <td class="2-td2-t-left">
                    <div align=left>
						<html:text property="sbbh" size="20" maxlength="20"/>
					</div>
                </td>
                <td class="2-td2-t-left">申请人类型</td>
                <td class="2-td2-t-left">
					<div align=left>
              ...
              <tr>
                ...
                <td  class="2-td2-left">
                    <div align=left>
                      ...
                      <html:hidden property="jmsbs" value="<%=Constants.ZB_BLJMSBS_BZ%>"/>
                <td class="2-td2-left">申报日期</td>
                <td  class="2-td2-left" colspan='3'>
                    <div align=left>
						<html:text property="sbrq" size="14" maxlength="20"/>
					</div>
                </td>
              </tr>
              <!--增加建委业务编号 合同编号查询字段 ，modify by fujx-->
              <tr>
