...
<jsp:include page="/include/Header.jsp" flush="true">
	<jsp:param name="subtitle" value="契税减免申报查询&gt;契税减免申报数据信息查询表" />
				...
				<TBODY>
					...
					<TR>
						<TD class=1-td2 vAlign=top><html:form
							action="/jmsb/queryJmsb">
							<html:hidden property="fromPage" value="4" />
							...
							<TABLE border="0" cellSpacing=0 class=table-89>
								<TBODY>
									...
									<tr>
										...
										<td class="2-td2-left">
										<div align=left><html:select property="ztbs">
											<html:option value=""></html:option>
										...
										<logic:iterate id="data" indexId="index" length="length"
											...
											<tr>
												<td class="2-td2-left"><a
													href="<%=response.encodeURL("/qsgl/jmsb/queryJmsb.do?operationType=View&viewIndex=") + index.intValue()%>">
