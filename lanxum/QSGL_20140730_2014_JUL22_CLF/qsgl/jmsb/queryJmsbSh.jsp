				...
				<TBODY>
					...
					<TR>
						<TD class=1-td2 vAlign=top><html:form
							action="/jmsb/queryJmsbSh">
							<html:hidden property="fromPage" value="5" />
										...
										<logic:iterate id="data" indexId="index" length="length"
											...
											<tr>
												<td class="2-td2-left"><a
													href="<%=response.encodeURL("/qsgl/jmsb/queryJmsbSh.do?operationType=View&viewIndex=") + index.intValue()%>">
