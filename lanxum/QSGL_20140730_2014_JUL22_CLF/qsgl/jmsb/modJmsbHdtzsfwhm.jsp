				...
				<TBODY>
					...
					<TR>
						<TD class=1-td2 vAlign=top><html:form
							action="/jmsb/modJmsbHdtzsfwhm.do">
							...
							<TABLE border="0" cellSpacing=0 class=table-89>
								<TBODY>
									...
									<tr>
										...
										<td class="2-td2-t-center" colspan="5">
										<div align=left>&nbsp;<%=printHdtzsh%></div>
										</td>
									</tr>
									<tr>
										...
										%> <html:text
											property="fwhm" maxlength="11" value='' /> <%
 } else {
 %> <html:text
											property="fwhm" maxlength="11" value='<%=form.getFwhm()%>' />
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <IMG
								...
								style="cursor:hand" height="22"></DIV>
							<BR>
