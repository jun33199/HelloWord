...
/**
 * <p>Title: 北京地税核心征管系统－－上门申报</p>
 * <p>Description: 个体工商户完税证撤销</p>
 * @author 开发六组－－陆峰
 * @version 1.1
 */
public class GtgshCxwszAction
    extends SmsbAction
{
...

    {
        ...
        request.setAttribute(CodeConstant.SMSB_HEADER_HELP,
                             "help/smsb/gtgsh/Gwszcx-000.htm");
    ...
    public ActionForward doShow (ActionMapping mapping,
        ...
        BaseException
    {
        GtgshCxwszForm pf = (GtgshCxwszForm) form;
        try
        {
            //获得当前的userData对象
        ...
        BaseException
    {
        ...
        try
        {
            ...
            vo.setData(pf);
            vo.setUserData(ud);
            vo.setProcessor(CodeConstant.GTGSH_CXWSZ_PROCESSOR);

            //调用processor
            pf = (GtgshCxwszForm) ZhsbProxy.getInstance().process(vo);
