...
import com.ttsoft.bjtax.smsb.zhsb.web.ZhsbjksypysAction;
import com.ttsoft.framework.exception.BaseException;
import com.ttsoft.framework.exception.ExceptionUtil;

/**
 * <p>Title: 北京地税核心征管系统－－上门申报</p>
 * <p>Description: 一票一税查看页面</p>
 * @author 开发六组－－陆峰
 * @version 1.1
 */
public class GtgshJksYpysAction
    extends ZhsbjksypysAction
{
        ...
        BaseException
    {
        try
        {
            GtgshJksYpysForm pf1 = (GtgshJksYpysForm) form;
