...
import com.ttsoft.bjtax.smsb.zhsb.pgbs.web.ZhsbPgbsGzsxActionForm;
...
public class ZhsbPgbsProcessor
    implements Processor
{
    private Map CDF = null;

    public ZhsbPgbsProcessor ()
    {
    }
        ...
        throws BaseException
    {
        ...
        //获取评估补税form对象
        ZhsbPgbsActionForm form = (ZhsbPgbsActionForm) vo.getData();
        ...
        try
        {
            ...
            //税款类型
            //将税款类型固定为"评估补税",在数据库表中"评估补税"的字段值对应为'600'
            orObj.setSklxdm("600");
...
*/
    ...
    {
    	//评估补税
    	ZhsbPgbsGzsxActionForm form = (ZhsbPgbsGzsxActionForm) vo.getData();
