...
/**
 * <p>Title: 北京地税综合管理系统  申报征收-上门模块</p>
 * <p>Description: 综合申报JavaBean </p>
 * @author Shi Yanfeng
 * @version 1.1
 */

public class ZhsbActionForm
    extends BaseForm
{
     ...
     * Description：减免数据
     */
    private Map jmDateMap = new HashMap();
    
    /**
     * Description：单一条目
     */
    private Map jmMap = new HashMap();
    
    /**
     * Description：减免类型： 0--营业税月度；1--营业税季度；2--文化事业建筑费
     */
    private int check_jmLx;
    ...
    /**
	 * @description: getter-- check_jmLx
	 * @return the check_jmLx
	 */
	public int getCheck_jmLx() {
		return check_jmLx;
	}

	/**
	 * @description: setter-- check_jmLx
	 * @param check_jmLx the check_jmLx to set
	 */
	public void setCheck_jmLx(int check_jmLx) {
		this.check_jmLx = check_jmLx;
	}
	...
	/**
	 * @description: setter-- jmMap
	 * @param jmMap the jmMap to set
	 */
	public void setJmMap(Map jmMap) {
		this.jmMap = jmMap;
	}
    ...
    /**
	 * @description: getter-- jmDateMap
	 * @return the jmDateMap
	 */
	public Map getJmDateMap() {
		return jmDateMap;
	}

	/**
	 * @description: setter-- jmDateMap
	 * @param jmDateMap the jmDateMap to set
	 */
	public void setJmDateMap(Map jmDateMap) {
		this.jmDateMap = jmDateMap;
	}
