    ...
    extends SmsbAction
{
      ...
      BaseException
  {
    try
    {
      ZhsbGzsxActionForm form = (ZhsbGzsxActionForm) actionForm;
...
//如果有非正常告知事项，设置非正常标志
  ...
  {
    ZhsbGzsxActionForm form = (ZhsbGzsxActionForm) actionForm;
    ZhsbActionForm zhsb = new ZhsbActionForm();
    zhsb.setJsjdm(form.getJsjdm());
    zhsb.setSbrq(form.getSbrq());
    //zhsb.setJsjdm("06123456");
    zhsb.setGzsx("1");
    httpServletRequest.setAttribute("zhsbActionForm", zhsb);
