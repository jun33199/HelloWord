...
public class ZhsbPgbsjksypdsAction
    extends SfglAction
{
    /**
    ...
    {
    	//评估补税
        ZhsbPgbsjksypdsActionForm form = (ZhsbPgbsjksypdsActionForm) actionForm;
        //获得当前的userData对象
        ...
        //评估补税
        vo.setProcessor("com.ttsoft.bjtax.smsb.zhsb.pgbs.processor.ZhsbPgbsjksypdsProcessor");
        vo.setData(form);
        vo.setUserData(ud);
        try
        {
        	//评估补税
        	form = (ZhsbPgbsjksypdsActionForm) ZhsbProxy.getInstance().process(vo);
        ...
        BaseException
    {
        ...
        //评估补税
        vo.setProcessor(
            "com.ttsoft.bjtax.smsb.zhsb.pgbs.processor.ZhsbPgbsjksypdsProcessor");
        //获得当前的userData对象
        UserData ud = this.getUserData(httpServletRequest);
        vo.setUserData(ud);
        vo.setData(form);
