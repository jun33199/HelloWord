 ...
 * <p>Description:出具缴款书Action </p>
 * @author wangxq
 * @version 1.0
 */

public class GdzysCjjksAction extends SmsbAction{
	  /**
	  ...
	  public ActionForward doShow(ActionMapping mapping,
	      ...
	      BaseException
	  {
		  GdzysCjjksForm pf = (GdzysCjjksForm) form;
	    try
	    {
	      //设置查询结果提示标识未0
		  pf.setCxJgTsFlag("0");
	    System.out.println("##############GdzysCjjksAction.doShow");
	      //获得当前的userData对象
	 ...
	 /**
	  ...
	  public ActionForward doQuery(ActionMapping mapping,
	      ...
	      BaseException
	  {
		  System.out.println("##############GdzysCjjksAction.doQuery");
	    //获得当前的userData对象
	    UserData ud = this.getUserData(request);
	    ...
	    try
	    {
	      ...
	      vo.setData(pf);
	      vo.setUserData(ud);
	      vo.setProcessor(GdzysCodeConstant.GDZYS_SBZS_CJJKS_PROCESSOR);

	      //调用processor
	      pf = (GdzysCjjksForm) ZhsbProxy.getInstance().process(vo);
