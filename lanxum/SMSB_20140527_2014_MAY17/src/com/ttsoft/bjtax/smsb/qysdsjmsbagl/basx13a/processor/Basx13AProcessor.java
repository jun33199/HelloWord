...
public class Basx13AProcessor implements Processor{
	...
	private Object doShow(VOPackage vo) throws BaseException {
		...
		try {
			...
			ex.printStackTrace();
			throw new ApplicationException("数据库查询记录失败！" + basx13AForm.getJsjdm()	+ ":" + ex.getMessage());
		} finally {		
	...
	private Object doSave(VOPackage vo) throws BaseException {
		...
		try {
			...
			ex.printStackTrace();
			throw new ApplicationException("数据库保存记录失败！" + basx13AForm.getJsjdm()	+ ":" + ex.getMessage());
		} finally {		
			SfDBResource.freeConnection(conn);
		}
		return basx13AForm;
	...
	private Object doCheck(VOPackage vo) throws BaseException {
		...
		try {
			...
			ex.printStackTrace();
			throw new ApplicationException("数据库审核记录失败！" + basx13AForm.getJsjdm()	+ ":" + ex.getMessage());
		} finally {
			SfDBResource.freeConnection(conn);
		}
		return basx13AForm;
