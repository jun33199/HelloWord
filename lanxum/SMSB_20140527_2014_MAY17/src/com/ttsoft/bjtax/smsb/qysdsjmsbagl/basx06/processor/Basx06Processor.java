...
public class Basx06Processor implements Processor{
	...
	private Object doShow(VOPackage vo) throws BaseException {
		...
		try {
			...
			ex.printStackTrace();
			throw new ApplicationException("数据库查询记录失败！" + basx06Form.getJsjdm()	+ ":" + ex.getMessage());
		} finally {		
	...
	private Object doSave(VOPackage vo) throws BaseException {
		...
		try {
			...
			ex.printStackTrace();
			throw new ApplicationException("数据库保存记录失败！" + basx06Form.getJsjdm()	+ ":" + ex.getMessage());
		} finally {		
			SfDBResource.freeConnection(conn);
		}
		return basx06Form;
	...
	private Object doCheck(VOPackage vo) throws BaseException {
		...
		try {
			...
			ex.printStackTrace();
			throw new ApplicationException("数据库审核记录失败！" + basx06Form.getJsjdm()	+ ":" + ex.getMessage());
		} finally {
			SfDBResource.freeConnection(conn);
		}
		return basx06Form;
