...
public class Basx13AActionHelper {
	  public static String nullConvertToNbsp(String value){
	    ...
	    public static String getForwardPath(int i,String wsh){
	    	...
	    	switch (i) {
			case 1:
				basqwsh = "/webapp/smsb/qysds/jmsbagl/Basx13AAction.do?actionType=Show&basqwsh="+wsh;
				break;
			case 2:
				basqwsh = "/webapp/smsb/qysds/jmsbagl/Basx13AAction.do?actionType=Check&czlx=2&xh="+wsh;
				break;
			case 3:
				basqwsh = "/webapp/smsb/qysds/jmsbagl/Basx13AAction.do?actionType=Check&czlx=3&xh="+wsh;
				break;
			case 4:
				basqwsh = "/webapp/smsb/qysds/jmsbagl/Basx13AAction.do?actionType=Check&czlx=4&xh="+wsh;
				break;
			}
