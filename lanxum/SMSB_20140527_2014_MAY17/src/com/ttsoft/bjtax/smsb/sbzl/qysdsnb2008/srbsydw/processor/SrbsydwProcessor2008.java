package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.srbsydw.processor;
...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.srbsydw.web.SrbsydwForm2008;
 ...
 * @version 1.0
 */
public class SrbsydwProcessor2008 implements Processor {
    /**
     * 实现Processor接口
     *
     * @param vo
    ...
    private Object doShow(VOPackage vo) throws BaseException {
        ...
        SrbsydwForm2008 srbsydwForm = (SrbsydwForm2008) vo.getData();
        ...
        try {
            ...
            QysdsUtil2008.setQysdsReport(report, srbsydwForm);
            ...
            // 将数据库中的数据翻译成页面所需数据格式
            int[] arrs = {1, 16};
            srbsydwForm.setDataList(this.translate2Page(QysdsUtil2008.putSpace(
                    table, arrs)));
        } catch (Exception ex) {
            // 抛出异常
            ex.printStackTrace();
    ...
    private Object doDelete(VOPackage vo) throws BaseException {
        ...
        try {
            ...
            table.setTableName(CodeConstant.TABLE_NAME_2008_1_3);
            table.setTbblx(Constants.CREPORTS_IBBQLX_TYPE_YEAR);
            table = (QysdsReportsTableDeclare) report.getTableContentList()
                    .get(CodeConstant.TABLE_ID_2008_1_3);
            // 取list
            int[] arrs = {1, 16};
            srbsydwForm.setDataList(this.translate2Page(QysdsUtil2008.putSpace(
                    table, arrs)));
     ...
     * @return 企业所得税报表申明对象
     */
    private QysdsReportsDeclare translate2Interface(SrbsydwForm2008 form) {
