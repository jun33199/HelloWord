 ...
 *
 */
package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.zcjztzmx.processor;
...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.zcjztzmx.web.ZcjztzmxForm;
...
public class ZcjztzmxProcessor implements Processor {
	...
	private Object doShow(VOPackage vo) throws BaseException {
		...
		try {
			...
			QysdsUtil2009.setQysdsReport(report, ZcjztzmxForm);
			table.setTableId(CodeConstant.TABLE_ID_2009_10);
			table.setTableName(CodeConstant.TABLE_NAME_2009_10);
			...
			table = (QysdsReportsTableDeclare) report.getTableContentList()
					.get(CodeConstant.TABLE_ID_2009_10);

			int[] arra1 = { 1, 84 };
			ZcjztzmxForm.setDataList(this.FGXtranslate2Page(QysdsUtil2009
