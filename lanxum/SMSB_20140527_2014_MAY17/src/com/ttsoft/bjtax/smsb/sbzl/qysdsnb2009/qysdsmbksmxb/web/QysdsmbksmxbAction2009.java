...
public class QysdsmbksmxbAction2009 extends 
   SmsbAction 
   {
	/**
     * 操作员数据
    ...
    public ActionForward doShow (ActionMapping mapping,
        ...
        BaseException
    {
    	QysdsmbksmxbForm2009 mbksmxbForm = (QysdsmbksmxbForm2009)form;
        ...
        vo.setProcessor(CodeConstant.SBZL_QYSDSNB2009_QYSDSMBKSMXB_PROCESSOR2009); //设置Processor
        try
        {
        	mbksmxbForm=(QysdsmbksmxbForm2009)SbzlProxy.getInstance().process(vo);
...
//		 -------------对数据库操作的Method进行修改，防止刷新或重复提交----------------------------------------
		...
		try
		{
			...
			if(mbksmxbForm.getCheckList()==null){
				...
				request.setAttribute(CodeConstant.CHECK_RESULT_HTML, QysdsUtil2009.getCheckResults(mbksmxbForm.getCheckList()));
			}
			return mapping.findForward("Show");
		}
		catch (Exception ex)
	 ...
	 * @return
	 */
	private void getBaseForm(HttpServletRequest request,QysdsmbksmxbForm2009 form)
	{
		...
		if(baseForm!=null)
		{
			...
			form.setNextTableURL(QysdsUtil2009.getTableURL(baseForm,"N_"+CodeConstant.TABLE_ID_2009_4));
			form.setPreviousTableURL(QysdsUtil2009.getTableURL(baseForm,"P_"+CodeConstant.TABLE_ID_2009_4));
		}
	}
