...
public class QyqssdsHisglForm extends QyqssdsBaseForm {
	...
	private boolean isExistedSb;//备案信息是否已经存在
	...
	public boolean getIsExistedSb(){
		return isExistedSb;
	}
	public void setIsExistedSb(boolean isExistedSb){
		this.isExistedSb = isExistedSb;
	}
