 ...
 * <p>Description: 北京市外国企业营业税纳税申报表－－按实申报－－Action</p>
 * @author 开发六组－－诸光林
 * @version 1.1
 */
public class WqyysassbAction
    extends SmsbAction
{
    private UserData userData = null;

    /**
     * 公共的前置处理方法，每次进入页面调用<BR>
     * 设置页面显示时使用的导航信息和标题
    ...
    /**
     * 取业务信息
     * 1、取得WqyysassbForm，产生一个VOPackage。
     * 2、取业务数据的参数，设置它为voPackage的data域。
     * 3、设置voPackage的Processor域为
     * 	com.ttsoft.bjtax.smsb.sbzl.wqyys.processor.WqyysassbProcessor，
     *         voPackage的Data域为WqyysassbForm
     ...
     * @param actionForm WqyysassbForm
     * @param httpServletRequest HttpServletRequest
        ...
        BaseException
    {
        ...
        //当前的ActionForm
        WqyysassbForm form = (WqyysassbForm) actionForm;
        ...
        try
        {
            ...
            form = (WqyysassbForm) SbzlProxy.getInstance().process(vo);
            //流转
            Debug.out("Forword!");
