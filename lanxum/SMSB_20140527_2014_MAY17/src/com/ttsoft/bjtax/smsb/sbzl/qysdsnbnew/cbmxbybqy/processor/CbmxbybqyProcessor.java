...
package com.ttsoft.bjtax.smsb.sbzl.qysdsnbnew.cbmxbybqy.processor;
...
public class CbmxbybqyProcessor implements Processor {
	...
	private Object doShow(VOPackage vo) throws BaseException {
		...
		CbmxbybqyForm cbmxbybqyForm = (CbmxbybqyForm) vo.getData();
		...
		try {
			...
			QysdsNewUtil.setQysdsReport(report, cbmxbybqyForm);
			...
			// 将数据库中的数据翻译成页面所需数据格式
			int[] arrs = { 1, 32 };
			cbmxbybqyForm.setDataList(this.translate2Page(QysdsNewUtil
					.putSpace(table, arrs)));
	 ...
	 * @return 企业所得税报表申明对象
	 */
	private QysdsReportsDeclare translate2Interface(CbmxbybqyForm form) {
