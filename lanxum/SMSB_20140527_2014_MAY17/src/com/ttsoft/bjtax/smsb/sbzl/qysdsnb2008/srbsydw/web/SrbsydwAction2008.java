 ...
 * @version 1.0
 */
public class SrbsydwAction2008 extends SmsbAction {
    /**
     * 操作员数据
     */
    ...
    public ActionForward doShow(ActionMapping mapping, ActionForm form,
        ...
        // 获取SrbsydwForm对象
        SrbsydwForm2008 srbsydwForm = (SrbsydwForm2008) form;
        // 基本信息放入srbsydwForm中
        ...
        vo.setProcessor(CodeConstant.SBZL_QYSDSNB2008_SRBSYDW_PROCESSOR2008);
        try {
            // 调用Proxy，执行processor,获取srbsydwForm返回值
            srbsydwForm = (SrbsydwForm2008) SbzlProxy.getInstance().process(vo);
        ...
        try {
            ...
            if (srbsydwForm.getCheckList() == null) {
                ...
                request.setAttribute(CodeConstant.CHECK_RESULT_HTML,
                                     QysdsUtil2008.getCheckResults(srbsydwForm.
                        getCheckList()));
            }
     ...
     * @return
     */
    private void getBaseForm(HttpServletRequest request, SrbsydwForm2008 form) {
        // 获取本缴费系统用户信息
        userData = this.getUserData(request);
        ...
        if (baseForm != null) {
            ...
            form.setNextTableURL(QysdsUtil2008.getTableURL(baseForm,
                    "N_" + CodeConstant.TABLE_ID_2008_1_3));
            form.setPreviousTableURL(QysdsUtil2008.getTableURL(baseForm,
                    "P_" + CodeConstant.TABLE_ID_2008_1_3));
        }
    }
