...
public class SsyhmxAction2008 extends SmsbAction {
	/**
	 * 操作员数据 
	 */
	...
	{   SsyhmxForm SsyhmxForm=new SsyhmxForm();
		...
		vo.setProcessor(CodeConstant.SBZL_QYSDSNB2008_SSYHMX_PROCESSOR);
		try {
...
//			调用processor
			...
			{
				request.setAttribute(CodeConstant.CHECK_RESULT_HTML, QysdsUtil2008.getCheckResults(SsyhmxForm.getCheckList()));
			}	
...
//			SsyhmxForm.reset(mapping, request);
	...
	private void getBaseForm(HttpServletRequest request,SsyhmxForm form)
	{
		...
		if(baseForm!=null)
		{
			...
			form.setNextTableURL(QysdsUtil2008.getTableURL(baseForm,"N_"+CodeConstant.TABLE_ID_2008_5));
			form.setPreviousTableURL(QysdsUtil2008.getTableURL(baseForm,"P_"+CodeConstant.TABLE_ID_2008_5));
		}
	}
}
