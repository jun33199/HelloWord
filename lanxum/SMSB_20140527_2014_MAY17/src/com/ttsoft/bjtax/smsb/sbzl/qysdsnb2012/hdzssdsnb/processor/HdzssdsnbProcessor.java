...
package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2012.hdzssdsnb.processor;
...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2012.hdzssdsnb.web.HdzssdsnbForm;
...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2012.util.QysdsUtil2012;
...
public class HdzssdsnbProcessor implements Processor {
	...
	private Object doQuery(VOPackage vo) throws BaseException {
		...
		try {
			...
			QysdsUtil2012.setQysdsReport(report, hdzssdsnbForm);
...
//			System.out.println("企业征收类型_" + hdzssdsnbForm.getQyzslx());
	...
	private Object doSave(VOPackage vo) throws BaseException {
		...
		try {
			...
			QysdsReportsTableDeclare table = (QysdsReportsTableDeclare) report
					.getTableContentList().get(CodeConstant.TABLE_ID_2009_12);
	...
	private QysdsReportsDeclare translate2Interface(HdzssdsnbForm form,String zsfs) {
		...
		report.getTableContentList().put(table.getTableId(), QysdsUtil2012.cleanSpace(table));
		return report;
	}
