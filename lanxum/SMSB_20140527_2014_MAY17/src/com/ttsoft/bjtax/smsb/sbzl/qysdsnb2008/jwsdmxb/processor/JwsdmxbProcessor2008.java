...
package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.jwsdmxb.processor;
...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.jwsdmxb.web.JwsdmxbForm2008;
...
public class JwsdmxbProcessor2008 implements Processor {
	...
	public static void main(String[] args) {
		...
		JwsdmxbForm2008 form=new JwsdmxbForm2008();
		JwsdmxbProcessor2008 p=new JwsdmxbProcessor2008();
	...
	private Object doShow(VOPackage vo) throws BaseException {
		...
		JwsdmxbForm2008 jwsdmxbForm = (JwsdmxbForm2008) vo.getData();
		...
		try {
			...
			QysdsUtil2008.setQysdsReport(report, jwsdmxbForm);

			QysdsReportsTableDeclare table = new QysdsReportsTableDeclare();
			table.setTableId(CodeConstant.TABLE_ID_2008_6);
			table.setTableName(CodeConstant.TABLE_NAME_2008_6);
			...
			table = (QysdsReportsTableDeclare) report.getTableContentList()
					.get(CodeConstant.TABLE_ID_2008_6);
	...
	private Object doDelete(VOPackage vo) throws BaseException {
		...
		try {
			...
			QysdsReportsTableDeclare table=new QysdsReportsTableDeclare();
			table.setTableId(CodeConstant.TABLE_ID_2008_6);
			table.setTableId(CodeConstant.TABLE_NAME_2008_6);
			table.setTbblx(Constants.CREPORTS_IBBQLX_TYPE_YEAR);
			table=(QysdsReportsTableDeclare)report.getTableContentList().get(CodeConstant.TABLE_ID_2008_6);
			int []array ={15,26};
			jwsdmxbForm=this.translate2Page(jwsdmxbForm,QysdsUtil2008.putSpace(table,array));
		} catch (Exception ex) {
			// 抛出异常
			ex.printStackTrace();
			throw ExceptionUtil.getBaseException(ex);
	...
	private QysdsReportsDeclare translate2Interface(JwsdmxbForm2008 form) {
...
//			String hc=(String)map.get("jjhc");
	 ...
	 * @return
	 */
	private JwsdmxbForm2008 translate2Page(JwsdmxbForm2008 form,QysdsReportsTableDeclare table){
