...
package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.cbmxbybqy.processor;
...
public class CbmxbybqyProcessor2009 implements Processor {
	...
	private Object doShow(VOPackage vo) throws BaseException {
		...
		CbmxbybqyForm2009 cbmxbybqyForm = (CbmxbybqyForm2009) vo.getData();
		...
		try {
			...
			table = (QysdsReportsTableDeclare) report.getTableContentList()
					.get(CodeConstant.TABLE_ID_2009_2_1);
			// 将数据库中的数据翻译成页面所需数据格式
			int[] arrs = { 1, 28 };
			cbmxbybqyForm.setDataList(this.translate2Page(QysdsUtil2009
					.putSpace(table, arrs)));
	 ...
	 * @return 企业所得税报表申明对象
	 */
	private QysdsReportsDeclare translate2Interface(CbmxbybqyForm2009 form) {
