...
package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2013.jbxxb.processor;
...
public class JbxxbProcessor2013 implements Processor {
	// /**
	// * 企业所得税税率
	// */
	...
	private Object doShow(VOPackage vo) throws BaseException {
		...
		JbxxbForm2013 jbxxbForm = (JbxxbForm2013) vo.getData();
...
//				jbxxbForm.setGzglxsdm_old(rs.getString("GZGLXS"));
	...
	private Object doSave(VOPackage vo) throws BaseException {
		...
		try {
			 ...
			 */
			if(Integer.valueOf(jbxxbForm.getSknd()).intValue()>2012){
				if(jbxxbForm.getQueryFlag().equals("1") && !bbmsf_old.equals(jbxxbForm.getBbmsf())){
					...
					bf.append(" delete ")
					.append(" from sbdb.sb_jl_qysds_nsrjbxxb t1 ")
					.append(" where  t1.nsrjsjdm = ").append(SBStringUtils.getSQLStr(jbxxbForm.getJsjdm()))
					.append(" and t1.nd = ").append(SBStringUtils.getSQLStr(jbxxbForm.getSknd()));

					st.execute(bf.toString());
					
					jbxxbForm.setBbmsf("");
					//999作为删除基本信息表数据的标志用于前台的提示使用
					jbxxbForm.setQueryFlag("999");
					jbxxbForm.setZczbje("");
					jbxxbForm.setZcze("");
					jbxxbForm.setLxdh("");
...
//					iApp.deleteSingleTable(qd);
	...
	private void initForm(JbxxbForm2013 jbxxbForm) throws BaseException {
	 ...
	 * @param form
	 */
	public QysdsReportsDeclare setQysdsReport(JbxxbForm2013 form) {
	 ...
	 */
	public String DoQueryData(JbxxbForm2013 form)  
	{
		Connection conn = null;
