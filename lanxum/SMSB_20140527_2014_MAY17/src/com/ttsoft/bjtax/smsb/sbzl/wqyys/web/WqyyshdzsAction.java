 ...
 * <p>Description: 北京市外国企业营业税纳税申报表－－核定征收－－Action</p>
 * @author 开发六组－－诸光林
 * @version 1.1
 */
public class WqyyshdzsAction
    extends SmsbAction
{
     ...
     * @param actionForm WqyyshdzsForm
    ...
    /**
     * 取业务信息
     * 1、取得WqyyshdzsForm，产生一个VOPackage。
     * 2、取业务数据的参数，设置它为voPackage的data域。
     * 3、设置voPackage的Processor域为
     * 	com.ttsoft.bjtax.smsb.sbzl.wqyys.processor.WqyyshdzsProcessor，
     *         voPackage的Data域为WqyyshdzsForm
        ...
        BaseException
    {
        ...
        //当前的ActionForm
        WqyyshdzsForm form = (WqyyshdzsForm) actionForm;
        ...
        try
        {
            ...
            form = (WqyyshdzsForm) SbzlProxy.getInstance().process(vo);
