...
public class HdzssdsjbAction extends SmsbAction {
...

	{
		...
		httpServletRequest
				.setAttribute(
						...
						"<font color=\"#A4B9C6\">综合服务管理信息系统</font>&gt;<font color=\"#7C9AAB\">申报资料录入</font>&gt;企业所得税月(季)度预缴纳税申报表(B类)</td>");
	...
	public ActionForward doShow(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			//初始化代码表
			QysdsUtil2014.initCodeTable(hdzssdsjbForm);
			// 初始化数据传递容器
			...
			vo.setProcessor(CodeConstant.SBZL_QYSDSJB2014_HDZSSDS_PROCESSOR);
...
//			hdzssdsjbForm.setJdlx(checkBean.getJdlx());
	...
	private CheckBean setCheckInf(HdzssdsjbForm hdzssdsjbForm)
	{
		...
		checkBean.setCurrentTime(hdzssdsjbForm.getSkssjsrq().substring(0,8));
		checkBean.setVersionStartTime("20140331");
		checkBean.setVersionEndTime("#");
		
		checkBean.setJsjdm(hdzssdsjbForm.getJsjdm());
		
		checkBean.setSkssrqq(hdzssdsjbForm.getSkssksrq());
		checkBean.setSkssrqz(hdzssdsjbForm.getSkssjsrq());
		return checkBean;
	}
}
