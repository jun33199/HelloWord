...
package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.gg.processor;
...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.gg.web.GgForm2008;
...
public class GgProcessor2008 implements Processor 
{
	/**
	 * 实现Processor接口
	 * 
	...
	private Object doShow(VOPackage vo) throws BaseException {
		...
		GgForm2008 ggForm = (GgForm2008) vo.getData();
		...
		try {
			...
			QysdsUtil2008.setQysdsReport(report, ggForm);
			
			QysdsReportsTableDeclare table = new QysdsReportsTableDeclare();
			table.setTableId(CodeConstant.TABLE_ID_2008_8);
			table.setTableName(CodeConstant.TABLE_NAME_2008_8);
			...
			table = (QysdsReportsTableDeclare) report.getTableContentList().get(CodeConstant.TABLE_ID_2008_8);
			int []array = {1,11};
	...
	private Object doDelete(VOPackage vo) throws BaseException {
		...
		try {
			...
			QysdsReportsTableDeclare table=new QysdsReportsTableDeclare();
			table.setTableId(CodeConstant.TABLE_ID_2008_8);
			table.setTableId(CodeConstant.TABLE_NAME_2008_8);
			table.setTbblx(Constants.CREPORTS_IBBQLX_TYPE_YEAR);
			table=(QysdsReportsTableDeclare)report.getTableContentList().get(CodeConstant.TABLE_ID_2008_8);
	 ...
	 * @return 企业所得税报表申明对象
	 */
	private QysdsReportsDeclare translate2Interface(GgForm2008 ggForm) {
