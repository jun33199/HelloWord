...
import com.ttsoft.bjtax.smsb.sbzl.wqyys.web.WqyysassbForm;
 ...
 * <p>Description: 北京市外国企业营业税纳税申报表－－按实申报</p>
 * @author 开发六组－－诸光林
 * @version 1.1
 */
public class WqyysassbProcessor
    implements Processor
{
        ...
        throws BaseException
    {
        ...
        WqyysassbForm form = (WqyysassbForm) vo.getData();
        ...
        throws BaseException
    {
        ...
        try
        {
            ...
            String zbNames[] =
                ...
                "szmc", "swjgzzjgdm", "lrr", "fsdm", "zsffdm",
                "zsffmc", "qxdm"};
            ...
            if (wqzsf == null)
            {
                throw new ApplicationException("操作人员注意：该计算机代码不能进行按实申报！");
            }
            else
            {
            ...
            //判断是否属于按实申报
            if (! (wqzsf.getWqzsfsdm().equals(CodeConstant.WQYYSZSFS_ASSB)))
            {
                form.setZsfs("no");
                throw new ApplicationException("操作人员注意：该计算机代码不能进行按实申报！");
            }
        ...
        throws BaseException
    {
        ...
        try
        {
            ...
            for (int i = 0; i < mxMapData.size(); i++)
            {
                ...
                orMx.setZsffdm(CodeConstant.WQYYSZSFS_ASSB);
                mxData.add(orMx);
            }
            try
            {
