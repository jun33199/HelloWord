 ...
 * <p>Copyright: (C) 2008-2009 北京市地方税务局，清华同方软件股份有限公司，版权所有. </p>
 * <p>Company: 清华同方软件股份有限公司</p>
 */

package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.zb.web;
...
public class ZbAction2008 extends SmsbAction {
	...
	public ActionForward doShow(ActionMapping mapping, ActionForm form,
		...
		// 获取ZbForm对象
		ZbForm2008 zbForm = (ZbForm2008) form;
		...
		vo.setProcessor("com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.zb.processor.ZbProcessor2008");
		try {
			// 调用Proxy，执行processor,获取zbForm返回值
			zbForm = (ZbForm2008) SbzlProxy.getInstance().process(vo);
	...
	public ActionForward doCheck(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if(zbForm.getCheckList()==null){
				...
				request.setAttribute(CodeConstant.CHECK_RESULT_HTML, QysdsUtil2008.getCheckResults(zbForm.getCheckList()));
			}
			return mapping.findForward("Show");
		} catch (Exception ex) {
			// 系统捕捉异常，根据异常类型抛出
	 ...
	 * @return
	 */
	private void getBaseForm(HttpServletRequest request, ZbForm2008 form) {
		// 获取本缴费系统用户信息
		userData = this.getUserData(request);
		...
		// 把基本信息放入到zbForm对象中
		if (baseForm != null) {
			Debug.out("2008版企业所得税 主表 ZbAction2008 getBaseForm ");
...
//			form.setJmlx(baseForm.getJmlx());
			form.setNextTableURL(QysdsUtil2008.getTableURL(baseForm,"N_"+CodeConstant.TABLE_ID_2008_ZB));
		}
	}
