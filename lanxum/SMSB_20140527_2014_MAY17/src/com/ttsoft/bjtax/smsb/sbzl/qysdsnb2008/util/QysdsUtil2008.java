package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.util;
...
//		System.out.println(getTimestamp("2006-10-10"));
	...
	public static void setQysdsReport(QysdsReportsDeclare report,QysdsNewForm form){
		 ...
		 * 版本号
		 */
		report.setVersion(CodeConstant.QYSDS_VERSION_2008);
		/**
		 * 纳税人计算机代码
		 */
...
//			form.setJmlx(rs.getString("JMLX"));
	...
	private static List getTableList(String ckzd){
		...
		//主表
		zb.setTableID(CodeConstant.TABLE_ID_2008_ZB);
		zb.setTableName(CodeConstant.TABLE_NAME_2008_ZB);
		zb.setURL("zbAction2008.do?actionType=Show");
		...
		if(ckzd!=null && "99".equals(ckzd) ){
			...
			table_1_1.setTableID(CodeConstant.TABLE_ID_2008_1_1);
			table_1_1.setTableName(CodeConstant.TABLE_NAME_2008_1_1);
			table_1_1.setURL("srmxbAction2008.do?actionType=Show");
			list.add(table_1_1);
			
			//附表一（2）金融企业收入明细表
			QysdsTabelInfo table_1_2 =new QysdsTabelInfo();
			table_1_2.setTableID(CodeConstant.TABLE_ID_2008_1_2);
			table_1_2.setTableName(CodeConstant.TABLE_NAME_2008_1_2);
			table_1_2.setURL("jrqysrmxAction2008.do?actionType=Show");
			list.add(table_1_2);
			
			//附表一（3）事业单位、社会团体、民办非企业单位收入明细表
			QysdsTabelInfo table_1_3 =new QysdsTabelInfo();
			table_1_3.setTableID(CodeConstant.TABLE_ID_2008_1_3);
			table_1_3.setTableName(CodeConstant.TABLE_NAME_2008_1_3);
			table_1_3.setURL("srbsydw2008Action.do?actionType=Show");
			list.add(table_1_3);
			
			//附表二（1）成本费用明细表
			QysdsTabelInfo table_2_1 =new QysdsTabelInfo();
			table_2_1.setTableID(CodeConstant.TABLE_ID_2008_2_1);
			table_2_1.setTableName(CodeConstant.TABLE_NAME_2008_2_1);
			table_2_1.setURL("cbmxbybqyAction2008.do?actionType=Show");
			list.add(table_2_1);
			
			//附表二（2）金融企业成本费用明细表
			QysdsTabelInfo table_2_2 =new QysdsTabelInfo();
			table_2_2.setTableID(CodeConstant.TABLE_ID_2008_2_2);
			table_2_2.setTableName(CodeConstant.TABLE_NAME_2008_2_2);
			table_2_2.setURL("jrqycbfymxbAction2008.do?actionType=Show");
			list.add(table_2_2);
			
			//附表二(3) 事业单位、社会团体、民办非企业单位支出明细表
			QysdsTabelInfo table_2_3 =new QysdsTabelInfo();
			table_2_3.setTableID(CodeConstant.TABLE_ID_2008_2_3);
			table_2_3.setTableName(CodeConstant.TABLE_NAME_2008_2_3);
			table_2_3.setURL("systmbfqyzcmxAction2008.do?actionType=Show");
			list.add(table_2_3);
		}
		...
		table_3.setTableID(CodeConstant.TABLE_ID_2008_3);
		table_3.setTableName(CodeConstant.TABLE_NAME_2008_3);
		table_3.setURL("nstzmxbAction2008.do?actionType=Show");
		list.add(table_3);
		
		//附表四 企业所得税弥补亏损明细表
		QysdsTabelInfo table_4 =new QysdsTabelInfo();
		table_4.setTableID(CodeConstant.TABLE_ID_2008_4);
		table_4.setTableName(CodeConstant.TABLE_NAME_2008_4);
		table_4.setURL("qysdsmbksmxbAction2008.do?actionType=Show");
		list.add(table_4);
		
		//附表五 税收优惠明细表
		QysdsTabelInfo table_5 =new QysdsTabelInfo();
		table_5.setTableID(CodeConstant.TABLE_ID_2008_5);
		table_5.setTableName(CodeConstant.TABLE_NAME_2008_5);
		table_5.setURL("ssyhmxAction2008.do?actionType=Show");
		list.add(table_5);
		
		//附表六 境外所得税抵免计算明细表
		QysdsTabelInfo table_6 =new QysdsTabelInfo();
		table_6.setTableID(CodeConstant.TABLE_ID_2008_6);
		table_6.setTableName(CodeConstant.TABLE_NAME_2008_6);
		table_6.setURL("jwsdmxbAction2008.do?actionType=Show");
		list.add(table_6);
		
		//附表七 以公允价值计量资产纳税调整表
		QysdsTabelInfo table_7 =new QysdsTabelInfo();
		table_7.setTableID(CodeConstant.TABLE_ID_2008_7);
		table_7.setTableName(CodeConstant.TABLE_NAME_2008_7);
		table_7.setURL("ygyjzjlnstzbAction.do?actionType=Show");
		list.add(table_7);
		
		//附表八 广告费和业务宣传费跨年度纳税调整表
		QysdsTabelInfo table_8 =new QysdsTabelInfo();
		table_8.setTableID(CodeConstant.TABLE_ID_2008_8);
		table_8.setTableName(CodeConstant.TABLE_NAME_2008_8);
		table_8.setURL("ggAction2008.do?actionType=Show");
		list.add(table_8);
		
		//附表九 资产折旧、摊销纳税调整明细表
		QysdsTabelInfo table_9 =new QysdsTabelInfo();
		table_9.setTableID(CodeConstant.TABLE_ID_2008_9);
		table_9.setTableName(CodeConstant.TABLE_NAME_2008_9);
		table_9.setURL("zczjtxnstzmxbAction2008.do?actionType=Show");
		list.add(table_9);
		
		//附附表十 资产减值准备项目调整明细表
		QysdsTabelInfo table_10 =new QysdsTabelInfo();
		table_10.setTableID(CodeConstant.TABLE_ID_2008_10);
		table_10.setTableName(CodeConstant.TABLE_NAME_2008_10);
		table_10.setURL("zcjztzmxAction2008.do?actionType=Show");
		list.add(table_10);
		
		//附表十一 股权投资所得（损失）明细表
		QysdsTabelInfo table_11 =new QysdsTabelInfo();
		table_11.setTableID(CodeConstant.TABLE_ID_2008_11);
		table_11.setTableName(CodeConstant.TABLE_NAME_2008_11);
...
//	//从申报页面取得申报日期和税款所属日期
//	Timestamp sbrq = QysdsUtil2008.getNxetTimestamp(form.getSkssjsrq());
//	
////	Map getsbjd = this.quarterSkssrq(sbrq);
//	Timestamp skssksrq = QysdsUtil2008.getTimestamp(form.getSkssksrq());
//	Timestamp skssjsrq = QysdsUtil2008.getTimestamp(form.getSkssjsrq());
//	
//	
