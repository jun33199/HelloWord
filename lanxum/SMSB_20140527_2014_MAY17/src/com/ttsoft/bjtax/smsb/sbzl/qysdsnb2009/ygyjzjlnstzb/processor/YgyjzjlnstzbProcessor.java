package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.ygyjzjlnstzb.processor;
...
//			将ActionForm中的数据结构转换置入数据库接口参数要求的数据结构
            ...
            table.setTableId(CodeConstant.TABLE_ID_2009_7);
            table.setTableName(CodeConstant.TABLE_NAME_2009_7);
...
//			获取数据库接口，调用save方法进行数据保存
            ...
            try {
                ...
                table = (QysdsReportsTableDeclare) report.getTableContentList().
                        get(CodeConstant.TABLE_ID_2009_7);
                int[] arrs = {1, 50};
                List listgd = (List)this.translate2Page(QysdsUtil2009.putSpace(
                        table, arrs)).get("GD");
