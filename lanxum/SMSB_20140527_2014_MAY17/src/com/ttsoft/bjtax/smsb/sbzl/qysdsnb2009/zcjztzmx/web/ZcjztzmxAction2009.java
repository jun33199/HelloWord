package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.zcjztzmx.web;
...
public class ZcjztzmxAction2009 extends SmsbAction {
	/**
	 * 操作员数据
	 */
	...
	BaseException
	{
		...
		vo.setProcessor(CodeConstant.SBZL_QYSDSNB2009_ZCJZTZMX_PROCESSOR);
...
//		 -------------对数据库操作的Method进行修改，防止刷新或重复提交----------------------------------------
		...
		try
		{
			...
			{
				request.setAttribute(CodeConstant.CHECK_RESULT_HTML, QysdsUtil2009.getCheckResults(ZcjztzmxForm.getCheckList()));
			}
...
//		 -------------对数据库操作的Method进行修改，防止刷新或重复提交----------------------------------------
	...
	private void getBaseForm(HttpServletRequest request,ZcjztzmxForm form)
	{
		...
		if(baseForm!=null){
			...
			form.setNextTableURL(QysdsUtil2009.getTableURL(baseForm,"N_"+CodeConstant.TABLE_ID_2009_10));
			form.setPreviousTableURL(QysdsUtil2009.getTableURL(baseForm,"P_"+CodeConstant.TABLE_ID_2009_10));
		}
	}
