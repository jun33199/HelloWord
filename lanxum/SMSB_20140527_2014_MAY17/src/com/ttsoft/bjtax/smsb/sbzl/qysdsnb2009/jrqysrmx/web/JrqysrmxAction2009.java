package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.jrqysrmx.web;
...
public class JrqysrmxAction2009 extends SmsbAction {
	/**
	 * 操作员数据
	 */
	...
	{   JrqysrmxForm JrqysrmxForm=new JrqysrmxForm();
		...
		vo.setProcessor(CodeConstant.SBZL_QYSDSNB2009_JRQYSRMX_PROCESSOR);
		try {
...
//				System.out.println("checked2 passed");
			...
			{
				request.setAttribute(CodeConstant.CHECK_RESULT_HTML, QysdsUtil2009.getCheckResults(JrqysrmxForm.getCheckList()));
			}	
...
//			JrqysrmxForm.reset(mapping, request);
	...
	private void getBaseForm(HttpServletRequest request,JrqysrmxForm form)
	{
		...
		if(baseForm!=null)
		{
			...
			form.setNextTableURL(QysdsUtil2009.getTableURL(baseForm,"N_"+CodeConstant.TABLE_ID_2009_1_2));
			form.setPreviousTableURL(QysdsUtil2009.getTableURL(baseForm,"P_"+CodeConstant.TABLE_ID_2009_1_2));
		}
	}
}
