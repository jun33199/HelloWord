	...
	private Object doQuery(VOPackage vo) throws BaseException {
		...
		try {
			...
			if (!(CodeConstant.ZSFSDM_CZZS.equals(zsfs))) {
				throw new ApplicationException("该企业已认定为核定征收户，不能在此录入，请录入相应季度申报表！");
			}
			...
			System.out.println("申报数据行数_"+ CzzssdsjbForm.getQysdsjbList().size());
