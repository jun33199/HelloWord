 ...
 */
package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.zczjtxnstzmxb.processor;
...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.zczjtxnstzmxb.web.ZczjtxnstzmxbForm2009;
...
public class ZczjtxnstzmxbProcessor2009 implements Processor
{
	...
	{
		ZczjtxnstzmxbForm2009 zcmxbForm = (ZczjtxnstzmxbForm2009) vo.getData();
		...
		try {
			...
			QysdsUtil2009.setQysdsReport(report,zcmxbForm);
			QysdsReportsTableDeclare table=new QysdsReportsTableDeclare();
			table.setTableId(CodeConstant.TABLE_ID_2009_9);
			table.setTableName(CodeConstant.TABLE_NAME_2009_9);
			...
			int[] arrs={1,118};
			table = (QysdsReportsTableDeclare) report.getTableContentList().get(CodeConstant.TABLE_ID_2009_9);
			zcmxbForm.setDataList(this.translate2Page(QysdsUtil2009.putSpace(table,arrs)));
		} catch (Exception ex) {
			ex.printStackTrace();
	 ...
	 * @throws BseException
	 */
	private void initForm(ZczjtxnstzmxbForm2009 zcmxbForm) throws BaseException {
	 ...
	 * 将ActionForm中的数据结构转换置入数据库接口参数要求的数据结构
	 * 页面数据结构-->接口数据结构
	 * @param ZczjtxnstzmxbForm2009 
	 * @return 企业所得税报表申明对象
	 */
	private QysdsReportsDeclare translate2Interface(ZczjtxnstzmxbForm2009 form){
