...
import com.ttsoft.bjtax.smsb.sbzl.wqyys.web.WqyysjfhsForm;
...
/**
 * <p>Title: 北京地税核心征管系统－－上门申报</p>
 * <p>Description: 北京市外国企业营业税纳税申报表－－经费换算</p>
 * @author 开发六组－－诸光林
 * @version 1.1
 */
public class WqyysjfhsProcessor
    implements Processor
{
     ...
     */
    //系统当前时间
    private Timestamp curTime = new Timestamp(System.currentTimeMillis());
        ...
        throws BaseException
    {
        ...
        WqyysjfhsForm form = (WqyysjfhsForm) vo.getData();
        ...
        throws BaseException
    {
        ...
        try
        {
            ...
            String zbNames[] =
                {
                "jsjdm", "sbrq", "lrrq", "nsrmc", "skssksrq",
                "skssjsrq",
            ...
            if (wqzsf == null)
            {
                throw new ApplicationException("操作人员注意：该计算机代码不能进行经费换算！");
            }
            else
            {
            ...
            //判断是否属于经费换算
            if (! (wqzsf.getWqzsfsdm().equals(CodeConstant.WQYYSZSFS_JFHS)))
            {
                form.setZsfs("no");
                throw new ApplicationException("操作人员注意：该计算机代码不能进行经费换算！");
            }
        ...
        throws BaseException
    {
        ...
        try
        {
            ...
            for (int i = 0; i < mxMapData.size(); i++)
            {
                ...
                orMx.setZsffdm(CodeConstant.WQYYSZSFS_JFHS);
                mxData.add(orMx);
            }
            try
            {
