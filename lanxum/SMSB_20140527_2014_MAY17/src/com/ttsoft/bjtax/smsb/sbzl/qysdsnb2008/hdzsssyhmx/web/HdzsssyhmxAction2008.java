package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.hdzsssyhmx.web;
...
public class HdzsssyhmxAction2008 extends SmsbAction {
	/**
	 * 操作员数据
	 */
	...
	public ActionForward doShow(ActionMapping mapping, ActionForm form,
		...
		vo.setProcessor(CodeConstant.SBZL_QYSDSNB2008_HDZSSSYHMX_PROCESSOR);
		try {
		...
		try {
			...
			if (HdzsssyhmxForm.getCheckList() == null) {
				...
				request.setAttribute(CodeConstant.CHECK_RESULT_HTML,
						QysdsUtil2008.getCheckResults(HdzsssyhmxForm
								.getCheckList()));
			}
			System.out
	...
	private void getBaseForm(HttpServletRequest request, HdzsssyhmxForm form) {
		...
		if (baseForm != null) {
			...
			form.setNextTableURL(QysdsUtil2008.getTableURL(baseForm, "N_"
					+ CodeConstant.TABLE_ID_2008_13));
			form.setPreviousTableURL(QysdsUtil2008.getTableURL(baseForm, "P_"
					+ CodeConstant.TABLE_ID_2008_13));
		}
	}
}