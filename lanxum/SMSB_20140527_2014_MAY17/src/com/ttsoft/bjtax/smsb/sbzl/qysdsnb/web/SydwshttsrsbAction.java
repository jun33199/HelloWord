...
public class SydwshttsrsbAction
    extends SmsbAction
{
    /**
     * 操作员数据
     ...
     * @param actionForm SydwshttsrsbForm
...

    {
        ...
        httpServletRequest.setAttribute(CodeConstant.SMSB_HEADER_POSITION,
                                        "<font color=\"#A4B9C6\">综合服务管理信息系统</font>&gt;<font color=\"#7C9AAB\">申报资料录入</font>&gt;事业单位、社会团体收入申报表</td>");
        httpServletRequest.setAttribute(CodeConstant.SMSB_HEADER_TITLE,
                                        "事业单位、社会团体收入申报表");
        httpServletRequest.setAttribute(CodeConstant.SMSB_HEADER_HELP,
            "help/smsb/sbzl/sydwshttsrsb/sydwshttsrsb-000.htm");
        ...
        BaseException
    {
        ...
        SydwshttsrsbForm sbForm = (SydwshttsrsbForm) form;
        userData = this.getUserData(request);
        sbForm.setLrr(userData.getYhid());
        VOPackage vo = new VOPackage();
        vo.setAction(CodeConstant.SMSB_SHOWACTION);
        vo.setData(sbForm);
        vo.setProcessor(CodeConstant.SBZL_SYDWSHTTSRSB_PROCESSOR);
        vo.setUserData(userData);
        try
        {
            //调用processor
            sbForm = (SydwshttsrsbForm) SbzlProxy.getInstance().process(vo);
