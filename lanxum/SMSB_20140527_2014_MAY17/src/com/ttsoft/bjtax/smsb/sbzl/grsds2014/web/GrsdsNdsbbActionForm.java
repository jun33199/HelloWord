...
public class GrsdsNdsbbActionForm extends BaseForm{
	 ...
	 * Description：日期起
	 */
	private String skssrqq="0101";
	
	/**
	 * Description：日期止
	 */
	private String skssrqz="1231";
	...
	public void setSkssqq(String skssqq) {
		this.skssqq = skssqq;
		if(skssqq!=null && skssqq.length()==8){
			this.skssrqq = skssqq.substring(4, 8);
		}
	}
	...
	public void setSkssqz(String skssqz) {
		this.skssqz = skssqz;
		if(skssqz!=null && skssqz.length()==8){
			this.skssrqz = skssqz.substring(4, 8);
		}
	}
