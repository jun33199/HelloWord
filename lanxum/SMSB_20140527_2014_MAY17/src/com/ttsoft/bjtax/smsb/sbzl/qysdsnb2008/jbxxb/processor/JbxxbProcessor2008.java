...
package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.jbxxb.processor;
...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.jbxxb.web.JbxxbForm2008;
...
public class JbxxbProcessor2008 implements Processor {
	// /**
	// * 企业所得税税率
	// */
	...
	private Object doShow(VOPackage vo) throws BaseException {
		...
		JbxxbForm2008 jbxxbForm = (JbxxbForm2008) vo.getData();
...
//				jbxxbForm.setGzglxsdm_old(rs.getString("GZGLXS"));
	...
	private Object doSave(VOPackage vo) throws BaseException {
		...
		try {
			...
			// 设置版本号
			jbxxbForm.setVersion(CodeConstant.QYSDS_VERSION_2008);
			...
			if (!(jbxxbForm.getCwkjzddm().equals(jbxxbForm.getCwkjzddm_old()))) {
				...
				if (CodeConstant.CWKJZD01.equals(jbxxbForm.getCwkjzddm_old())) {
					// 清除附表一1
					table.setTableId(CodeConstant.TABLE_ID_2008_1_1);
				...
				if (CodeConstant.CWKJZD02.equals(jbxxbForm.getCwkjzddm_old())) {
					...
					// 清除附表二2
					table.setTableId(CodeConstant.TABLE_ID_2008_2_2);
					table.setTbblx(Constants.CREPORTS_IBBQLX_TYPE_YEAR);
					// set table
					qd.getTableContentList().put(table.getTableId(), table);
					// 调用delete方法进行数据删除
				...
				if (CodeConstant.CWKJZD03.equals(jbxxbForm.getCwkjzddm_old())) {
					// 清除附表一3
					table.setTableId(CodeConstant.TABLE_ID_2008_1_3);
					table.setTbblx(Constants.CREPORTS_IBBQLX_TYPE_YEAR);
					// set table
					qd.getTableContentList().put(table.getTableId(), table);
					// 调用delete方法进行数据删除
	...
	private void initForm(JbxxbForm2008 jbxxbForm) throws BaseException {
	 ...
	 * @param form
	 */
	public QysdsReportsDeclare setQysdsReport(JbxxbForm2008 form) {
