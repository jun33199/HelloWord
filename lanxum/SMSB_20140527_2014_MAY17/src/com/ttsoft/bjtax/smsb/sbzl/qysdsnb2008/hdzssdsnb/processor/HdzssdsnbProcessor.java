package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.hdzssdsnb.processor;
...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.hdzssdsnb.web.HdzssdsnbForm;
...
//				form = (HdzssdsnbForm) QysdsUtil2008.queryQysdsJbxx(conn, form);
//			}

//			 设置期号
			form.setQh("1");
			// 设置其它基本信息
			form = (HdzssdsnbForm) QysdsUtil2008
					.queryDjxxByInterfaceDJ(conn, form, vo
							.getUserData());
//			 税率信息
			this.getHdxx(form);
			...
			table.setTableId(CodeConstant.TABLE_ID_2008_12);
			table.setTableName(CodeConstant.TABLE_NAME_2008_12);
			...
			table = (QysdsReportsTableDeclare) report.getTableContentList()
					.get(CodeConstant.TABLE_ID_2008_12);
			int[] arra = { 1, 8 };
			List list = this.translate2Page(QysdsUtil2008.putSpace(
					table, arra));
			if (form.isFbreturnbs()) {
...
//                    qysdsSet.setZsfs(zsfs);
	...
	private Object doDelete(VOPackage vo) throws BaseException {
		...
		try {
			...
			table = (QysdsReportsTableDeclare) report.getTableContentList()
					.get(CodeConstant.TABLE_ID_2008_12);
			form.setDataList(this.translate2Page(QysdsUtil2008
					.putSpace(table, arra)));
