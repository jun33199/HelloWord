package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.nstzmxb.processor;
...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.nstzmxb.web.NstzmxbForm2009;
 ...
 * @version 1.0
 */
public class NstzmxbProcessor2009 implements Processor {
    /**
     * 实现Processor接口
     * @param vo 业务参数
    ...
    private Object doShow(VOPackage vo) throws BaseException {
        ...
        NstzmxbForm2009 nbForm = (NstzmxbForm2009) vo.getData();
...
//			将ActionForm中的数据结构转换置入数据库接口参数要求的数据结构
            ...
            table.setTableId(CodeConstant.TABLE_ID_2009_3);
            table.setTableName(CodeConstant.TABLE_NAME_2009_3);
...
//			 获取数据库接口，调用save方法进行数据保存
            ...
            table = (QysdsReportsTableDeclare) report.getTableContentList().get(
                    CodeConstant.TABLE_ID_2009_3);
            List listgd = (List)this.translate2Page(QysdsUtil2009.putSpace(
                    table, arrs)).get("GD");
...
//			抛出异常
    ...
    private Object doSave(VOPackage vo) throws BaseException {
        ...
        NstzmxbForm2009 nstzmxzjbForm = (NstzmxbForm2009) vo.getData();
        Connection con = null;
        try {
            //获取数据库连接
...
//			更新审核状态为“保存成功”
    ...
    private Object doDelete(VOPackage vo) throws BaseException {
        NstzmxbForm2009 form = (NstzmxbForm2009) vo.getData();
        Connection conn = null;
        try {
//			获取数据库连接
...
//			获取数据库接口，调用save方法进行数据保存
            ...
            try {
                ...
                table = (QysdsReportsTableDeclare) report.getTableContentList().
                        get(CodeConstant.TABLE_ID_2009_3);
                int[] arrs = {1, 134};
                List listgd = (List)this.translate2Page(QysdsUtil2009.putSpace(
                        table, arrs)).get("GD");
...
//			释放数据库连接
     ...
     * @return 企业所得税报表申明对象
     */
    private QysdsReportsDeclare translate2Interface(NstzmxbForm2009 nbForm) throws
