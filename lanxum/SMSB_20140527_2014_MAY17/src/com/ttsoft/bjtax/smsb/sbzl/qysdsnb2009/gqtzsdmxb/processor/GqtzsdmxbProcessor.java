package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.gqtzsdmxb.processor;
...
//			将ActionForm中的数据结构转换置入数据库接口参数要求的数据结构
            ...
            table.setTableId(CodeConstant.TABLE_ID_2009_11);
            table.setTableName(CodeConstant.TABLE_NAME_2009_11);
...
//			 获取数据库接口，调用save方法进行数据保存
            ...
            table = (QysdsReportsTableDeclare) report.getTableContentList().get(
                    CodeConstant.TABLE_ID_2009_11);
            int[] arrs = {17, 58};
            List listgd = (List)this.translate2Page(QysdsUtil2009.putSpace(
                    table, arrs)).get("GD");
            List listhj = (List)this.translate2Page(QysdsUtil2009.putSpace(
                    table, arrs)).get("HJ");
            List listpczl = (List)this.translate2Page(QysdsUtil2009.putSpace(
                    table, arrs)).get("PC");
...
//			获取数据库接口，调用save方法进行数据保存
            ...
            try {
                ...
                table = (QysdsReportsTableDeclare) report.getTableContentList().
                        get(CodeConstant.TABLE_ID_2009_11);
                int[] arrs = {17, 58};
                List listgd = (List)this.translate2Page(QysdsUtil2009.putSpace(
                        table, arrs)).get("GD");
                List listhj = (List)this.translate2Page(QysdsUtil2009.putSpace(
                        table, arrs)).get("HJ");
                List listpczl = (List)this.translate2Page(QysdsUtil2009.
                        putSpace(
                                table, arrs)).get("PC");
