...
package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.cbmxbybqy.web;
 ...
 * @version 1.1
 */
public class CbmxbybqyAction2009 extends SmsbAction {
	...
	public ActionForward doShow(ActionMapping mapping, ActionForm form,
			...
			throws BaseException {
		// 获取CbmxbybqyForm对象
		CbmxbybqyForm2009 cbmxbybqyForm = (CbmxbybqyForm2009) form;
		// 获取本缴费系统用户信息
		userData = this.getUserData(request);
		// 基本信息放入cbmxbybqyForm2009中
		...
		vo.setProcessor(CodeConstant.SBZL_QYSDSNB2009_CBMXBYBQY_PROCESSOR2009);
		// 设置本缴费系统用户信息
		vo.setUserData(userData);
		try {
			// 调用Proxy，执行processor,获取cbmxbybqyForm返回值
			cbmxbybqyForm = (CbmxbybqyForm2009) SbzlProxy.getInstance().process(vo);
	...
	public ActionForward doSave(ActionMapping mapping, ActionForm form,
		...
		// 获取CbmxbybqyForm对象
		CbmxbybqyForm2009 cbmxbybqyForm = (CbmxbybqyForm2009) form;
		// 按照columns中的字段提取所需要的前台列表数据，赋给cbmxbybqyForm2009的DataList中
	...
	public ActionForward doCheck(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if(cbmxbybqyForm.getCheckList()==null){
				...
				request.setAttribute(CodeConstant.CHECK_RESULT_HTML, QysdsUtil2009.getCheckResults(cbmxbybqyForm.getCheckList()));
			}
	...
	/**
	 * 从session中获取基本信息，并放入CbmxbybqyForm2009对象中
	 * 
	 * @param request
	 * @return
	 */
	private void getBaseForm(HttpServletRequest request, CbmxbybqyForm2009 form) {
		// 获取本缴费系统用户信息
		userData = this.getUserData(request);
		...
		if (baseForm != null) {
			...
			form.setNextTableURL(QysdsUtil2009.getTableURL(baseForm,"N_"+CodeConstant.TABLE_ID_2009_2_1));
			form.setPreviousTableURL(QysdsUtil2009.getTableURL(baseForm,"P_"+CodeConstant.TABLE_ID_2009_2_1));
		}
	}
}