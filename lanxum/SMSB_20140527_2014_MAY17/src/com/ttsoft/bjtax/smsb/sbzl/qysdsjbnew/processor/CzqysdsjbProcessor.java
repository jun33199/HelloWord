...
public class CzqysdsjbProcessor implements Processor {
	...
	private Object doQuery(VOPackage vo) throws BaseException {
		...
		try {
			...
			System.out.println(czqysdsjbForm.getJsjdm()
					+ "的czqysdsjbForm.getSbrq()：" + czqysdsjbForm.getSbrq());
			System.out.println(czqysdsjbForm.getJsjdm() + "的jd：" + jd);
			...
			System.out.println(czqysdsjbForm.getJsjdm()
					+ "的czqysdsjbForm.setSknd：" + czqysdsjbForm.getSknd());
			...
			System.out.println(czqysdsjbForm.getJsjdm() + "的征收方式代码：" + zsfs);
	...
	private Object doSave(VOPackage vo) throws BaseException {
		...
		// 设置年度
		czqysdsjbForm.setSknd(nd);
		System.out.println(czqysdsjbForm.getJsjdm() + "的czqysdsjbForm.setSknd："
		...
		try {
			...
			for (int i = 0; i < (list.size() - 3); i++) {
				...
				if (i == 7) {
					...
					System.out.println(czqysdsjbForm.getJsjdm() + "的减免行次:"
							+ (String) map.get("hc"));
					System.out.println(czqysdsjbForm.getJsjdm() + "的减免行次:"
							+ (String) map.get("ljje"));
