...
public class CzzssdsjbProcessor implements Processor {
		...
		try {
			...
			if (!(CodeConstant.ZSFSDM_CZZS.equals(zsfs))) {
				throw new ApplicationException(
						"该企业已认定为核定征收户，不能在此录入，请录入相应季度申报表！");
			}
	...
	private List translate2Page(QysdsReportsTableDeclare table, String zsfs) {
		...
		if (table.getCellContentList().get("24") != null) {
			map24.put("hc", "24");
			map24.put("lje", ((QysdsReportsItemDeclare) table
					.getCellContentList().get("24")).getItemValue());
			pagelist.add(map24);
		}
		if (table.getCellContentList().get("25") != null) {
			map25.put("hc", "25");
			map25.put("lje", ((QysdsReportsItemDeclare) table
					.getCellContentList().get("25")).getItemValue());
			pagelist.add(map25);
		}
		if (table.getCellContentList().get("26") != null) {
			map26.put("hc", "26");
			map26.put("lje", ((QysdsReportsItemDeclare) table
					.getCellContentList().get("26")).getItemValue());
			pagelist.add(map26);
		}
		if (table.getCellContentList().get("27") != null) {
			map27.put("hc", "27");
			map27.put("lje", ((QysdsReportsItemDeclare) table
					.getCellContentList().get("27")).getItemValue());
			pagelist.add(map27);
		}
		if (table.getCellContentList().get("28") != null) {
			map28.put("hc", "28");
			map28.put("lje", ((QysdsReportsItemDeclare) table
					.getCellContentList().get("28")).getItemValue());
			pagelist.add(map28);
		}
		if (table.getCellContentList().get("29") != null) {
			map29.put("hc", "29");
			map29.put("lje", ((QysdsReportsItemDeclare) table
					.getCellContentList().get("29")).getItemValue());
			pagelist.add(map29);
		}
