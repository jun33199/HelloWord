package com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.systmbfqyzcmx.web;
...
public class SystmbfqyzcmxAction2008 extends SmsbAction {
	/**
	 * 操作员数据
	 */
	...
	{   SystmbfqyzcmxForm SystmbfqyzcmxForm=new SystmbfqyzcmxForm();
		...
		vo.setProcessor(CodeConstant.SBZL_QYSDSNB2008_SYSTMBFQYZCMX_PROCESSOR);
		try {
...
//			调用processor
			...
			{
				request.setAttribute(CodeConstant.CHECK_RESULT_HTML, QysdsUtil2008.getCheckResults(SystmbfqyzcmxForm.getCheckList()));
			}	
...
//			SystmbfqyzcmxForm.reset(mapping, request);
	...
	private void getBaseForm(HttpServletRequest request,SystmbfqyzcmxForm form)
	{
		...
		if(baseForm!=null)
		{
			...
			form.setNextTableURL(QysdsUtil2008.getTableURL(baseForm,"N_"+CodeConstant.TABLE_ID_2008_2_3));
			form.setPreviousTableURL(QysdsUtil2008.getTableURL(baseForm,"P_"+CodeConstant.TABLE_ID_2008_2_3));
		}
	}
}
