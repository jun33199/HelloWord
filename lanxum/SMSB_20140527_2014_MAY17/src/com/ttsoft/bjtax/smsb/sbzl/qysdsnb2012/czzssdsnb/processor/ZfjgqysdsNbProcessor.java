...
import com.ttsoft.bjtax.smsb.sbzl.qysdsnb2012.czzssdsnb.web.ZfjgqysdsNbForm;
...
public class ZfjgqysdsNbProcessor implements Processor
{
    ...
    {
        // 得到Action传递过来ZfjgqysdsNbForm对象
    	Map dataMap=(Map) vo.getData();
    	
    	CzzssdsNbForm czzssdsNbForm = (CzzssdsNbForm) dataMap.get("CzzssdsNbForm");
        ZfjgqysdsNbForm zfjgForm = (ZfjgqysdsNbForm) dataMap.get("ZfjgqysdsNbForm");
        ...
        try {
            ...
            zfjgForm.setSknd(nd);
            // 设置form中其它所需属性
            zfjgForm = (ZfjgqysdsNbForm) QysdsNb2012Util.queryDjxxByInterfaceDJ(conn, zfjgForm, vo.getUserData());
            //机构类型为分支机构
            ...
            //查询查帐征收表关联分配表数据
            this.getFtseFormCzzs(conn, zfjgForm, czzssdsNbForm);
            zfjgForm.setJsjdm(zfjgForm.getJsjdm());
            zfjgForm.setSbrq(czzssdsNbForm.getSbrq());
            zfjgForm.setSkssksrq(czzssdsNbForm.getSkssksrq());
            zfjgForm.setSkssjsrq(czzssdsNbForm.getSkssjsrq());
     ...
     * @throws BaseException
     */
    private void getHdxx(ZfjgqysdsNbForm form) throws BaseException
    {
     ...
     * @param form ZfjgqysdsNbForm
     * @return int
     * @throws BaseException
     */
    private int checkCzzsNsff(Connection conn, ZfjgqysdsNbForm form) throws BaseException
    {
     ...
     * @throws BaseException
     */
    private void getCzzsFtse(Connection conn, ZfjgqysdsNbForm form) throws BaseException
    {
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        StringBuffer sql = new StringBuffer();
     ...
     */
    private List translate2Page(QysdsReportsTableDeclare table,ZfjgqysdsNbForm zfjgForm)
    {
        // 创建List对象，用来存放页面表单数据
...
//            }
     ...
     * @throws BaseException
     */
    private int getMxDateMaxIndex(Connection con, QysdsReportsDeclare report, ZfjgqysdsNbForm form) throws BaseException
    {
        int maxIndex = 0;
    ...
    private Object doSave(VOPackage vo) throws BaseException {
        ...
        ZfjgqysdsNbForm zfjgForm = (ZfjgqysdsNbForm) vo.getData();
...
//            zfjgForm.setQysdsjbList(this.translate2Page(putSpace(table, arrs)));
            ...
            //zfjgForm = (ZfjgqysdsNbForm) this.doQuery(vo);
     ...
     * @return 企业所得税报表申明对象
     */
    private QysdsReportsDeclare translate2Interface(ZfjgqysdsNbForm form) {
     ...
     */
    private void translateZjgDate2Interface(ZfjgqysdsNbForm form, QysdsReportsTableDeclare table)
    {
     ...
     * @param table QysdsReportsTableDeclare
     */
    private void translateFzjgmxDate2Interface(ZfjgqysdsNbForm form, QysdsReportsTableDeclare table)
    {
...
//            zfjgForm.setQysdsjbList(this.translate2Page(putSpace(table, arrs)));
    ...
    /**
     * 查询查帐征收表关联分配表数据 
     * 第一次录入通过CzzssdsNbForm拼装页面所需要数据
     * @param conn Connection
     * @param form ZfjgqysdsjbForm
     * @throws BaseException
     */
    private void getFtseFormCzzs(Connection conn, ZfjgqysdsNbForm form,CzzssdsNbForm czzssdsNbForm) throws BaseException
    {
     ...
     * @return 页面表单数据的List对象
     */
    private List CzzsForm2Page(ZfjgqysdsNbForm form)
    {
        // 创建List对象，用来存放页面表单数据
        ArrayList pagelist = new ArrayList();
