...
<html:html>
  ...
  <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <html:form action="/webapp/smsb/zhsbjksypysAction.do" method="POST" >
        ...
        <tr>
          <td class="1-td2"  colspan="7" valign="top" width="99%">
                ...
                <td width="55%" valign="top">
                  <table cellspacing="0" border="0" width="100%">
                    ...
                    <tr>                      	
                      ...
                      <td width="30%" class="2-td2-left"><div align="left">(<bean:write name="zhsbjksypysActionForm" property="skgkh"/>)<html:text styleClass="inputnoborder" style="color:#3C5564" readonly="true" property="gkzzjgmc"  size="20"/></div></td>
            ...
            <table class="table-99" cellspacing="0" width="98%" border="1">
				    ...
				    <bean:define id="itemjksprint" name="zhsbjksypysActionForm" property="dataList"/>
              ...
              <tr>
                ...
                <td colspan="8" nowrap class="2-td2-left" height="28"><strong>(大写)&nbsp;&nbsp;&nbsp;&nbsp;</strong><input type="text" name="xthjdx" value='<ttsoft:write name="zhsbjksypysActionForm" property="hjjedx"/>' class="inputnoborder" readonly size ="60"></td>
                <td nowrap class="2-td2-center" height="28">￥<input type="text" name="xthj" value='<ttsoft:write name="zhsbjksypysActionForm" property="hjje"/>' class="inputnoborder" readonly size ="15"></td>
              </tr>
              <tr>
                <td colspan="2" nowrap class="2-td2-left" height="60"><strong>税务机关</strong><br><input type="text" name="dfswjg" value='<ttsoft:write name="zhsbjksypysActionForm" property="dfswjg"/>' class="inputnoborder" readonly size ="40"><br><div align="center"><strong>(盖章)</strong></div><br><div align="left"><strong>&nbsp;&nbsp;填票人</strong></div></td>
                <td colspan="2" nowrap class="2-td2-left" height="60"><strong>缴款单位(人)</strong><br><input type="text" name="nsrmc" value='<ttsoft:write name="zhsbjksypysActionForm" property="nsrmc"/>' class="inputnoborder" readonly size ="40"><br><div align="center"><strong>(盖章)</strong></div><br><div align="left"><strong>&nbsp;&nbsp;经办人</strong></div></td>
                ...
                <td colspan="3" nowrap class="2-td2-center" height="60"><div align="left"><strong>备注</strong></div><br><input type="text" name="bz" value='<ttsoft:write name="zhsbjksypysActionForm" property="bz"/>' class="inputnoborder" readonly size ="40"></td>
              </tr>                          
            </table>
...
<ttsoft:write name="zhsbjksypysActionForm" property="scriptStr" filter="false"/>
...
////////////////////////这里开始打印的程序！///////////////////
function goprint(){
//  var szdm = "<bean:write name="zhsbjksypysActionForm" property="szmc" />"; //税种代码
  var sklx = "<bean:write name="zhsbjksypysActionForm" property="sklx" />"; //税款类型
  var dnbh = "<bean:write name="zhsbjksypysActionForm" property="jkpzh" />"; //电脑编号
  var zclx = "<bean:write name="zhsbjksypysActionForm" property="zclxmc" />"; //注册类型  
//  var tfrq = "<bean:write name="zhsbjksypysActionForm" property="lrrq" />"; //填发日期
  var tfrqn = "<bean:write name="zhsbjksypysActionForm" property="tfrqn" />"; //填发日期年
  var tfrqy = "<bean:write name="zhsbjksypysActionForm" property="tfrqy" />"; //填发日期月    
  var tfrqr = "<bean:write name="zhsbjksypysActionForm" property="tfrqr" />"; //填发日期日    
//  var lsgx = "<bean:write name="zhsbjksypysActionForm" property="lsgx" />"; //隶属关系
  var zsjg = "<bean:write name="zhsbjksypysActionForm" property="swjgzzjgmc" />"; //征收机关
  var jkdwdm = "<bean:write name="zhsbjksypysActionForm" property="jsjdm" />"; //缴款单位代码
//  var jkdwdh = "<bean:write name="zhsbjksypysActionForm" property="jydzlxdm" />"; //缴款单位电话
  var jkdwqc = "<bean:write name="zhsbjksypysActionForm" property="nsrmc" />"; //缴款单位全称
  var jkdwkhyh = "<bean:write name="zhsbjksypysActionForm" property="yhmc" />"; //缴款单位开户银行
  var jkdwzh = "<bean:write name="zhsbjksypysActionForm" property="zh" />"; //缴款单位账号
  var skgk = "(<bean:write name="zhsbjksypysActionForm" property="skgkh"/>)<bean:write name="zhsbjksypysActionForm" property="gkzzjgmc" />"; //收款国库
  var skxjrq = "<bean:write name="zhsbjksypysActionForm" property="xjrq" />"; //税款限缴日期    
  var yskmbm = "<bean:write name="zhsbjksypysActionForm" property="yskmdm" />"; //预算科目编码
  var yskmmc = "<bean:write name="zhsbjksypysActionForm" property="yskmmc" />"; //预算科目名称
//  var yskmjc = "<bean:write name="zhsbjksypysActionForm" property="ysjcmc" />"; //预算科目级次
  var jkmxfcbl = "<bean:write name="zhsbjksypysActionForm" property="mxFcbl" />"; //预算科目分成比例  
  var  jkmxpmmc = "<bean:write name="zhsbjksypysActionForm" property="mxPmmc"/>"; //缴款明细品目名称(TBD)
  var  jkmxkssl = "<bean:write name="zhsbjksypysActionForm" property="mxKssl"/>"; //缴款明细课税数量(TBD)
  var  jkmxjsje = "<bean:write name="zhsbjksypysActionForm" property="mxJsje"/>"; //缴款明细计税金额(TBD)
  var sksssq = "<bean:write name="zhsbjksypysActionForm" property="skssksrq" /> - <bean:write name="zhsbjksypysActionForm" property="skssjsrq" />"; //税款所属时期  
  var  jkmxsjse = "<bean:write name="zhsbjksypysActionForm" property="mxSjse"/>"; //缴款明细实缴税额(TBD)
  var jkjehj = "<bean:write name="zhsbjksypysActionForm" property="hjjedx" />"; //缴款金额合计(TBD)
  var hjje = "￥<bean:write name="zhsbjksypysActionForm" property="hjje" />";//合计金额
  var swjg = "<bean:write name="zhsbjksypysActionForm" property="dfswjg" />"; //地方税务机关(TBD)
  var jkdw = "<bean:write name="zhsbjksypysActionForm" property="nsrmc" />"; //缴款单位(TBD)
  var bz = "<bean:write name="zhsbjksypysActionForm" property="bz" />"; //备注(TBD)
  ...
  var sksssq_qs = "<bean:write name="zhsbjksypysActionForm" property="skssksrq" />";
  var sksssq_jz = "<bean:write name="zhsbjksypysActionForm" property="skssjsrq" />";
  var jkmxslse = " ";
