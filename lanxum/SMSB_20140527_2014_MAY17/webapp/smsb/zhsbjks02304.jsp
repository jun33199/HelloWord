...
<html:form action="/webapp/smsb/zhsbjksypdsAction.do" method="POST" >
...
<html:hidden property="forward" />
      ...
      <table width="96%" align="center" cellspacing="0" class="table-99">
            ...
            <td class="1-td1"  colspan="7">中 华 人 民 共 和 国 税 收 电 子 转 帐 专 用 完 税 凭 
              证<ttsoft:write name="zhsbjksypdsActionForm" property="jkpzh"/>号</td>
                </tr>
                <tr> 
                  <td class="1-td2"  colspan="7" valign="top"> <br>
					<table cellpadding="2" border="0" cellspacing="2" width="100%">
                      <tr> 
					  	<td width="3%">&nbsp;</td>
						<td width="77%"><div align="left" class="black9">填发日期：<ttsoft:write name="zhsbjksypdsActionForm" property="lrrq"/>&nbsp;</div></td>
						<td width="20%">&nbsp;</td>
					  </tr>
					</table>
              ...
              <table class="table-99" cellspacing="0">
                <tr> 
                  ...
                  <td width="37%" class="2-td2-t-left"><ttsoft:write name="zhsbjksypdsActionForm" property="jsjdm"/>&nbsp;</td>
                  <td width="10%" class="2-td2-t-left"><strong>征收机关</strong></td>
                  <td width="41%" class="2-td2-t-center"><ttsoft:write name="zhsbjksypdsActionForm" property="swjgzzjgmc"/>&nbsp;</td>
                </tr>
                <tr>
                  <td class="2-td2-left"><strong>纳税人全称</strong></td>
                  <td class="2-td2-left"><ttsoft:write name="zhsbjksypdsActionForm" property="nsrmc"/><html:hidden property="nsrmc"/>&nbsp;</td>
                  <td class="2-td2-left"><strong>收款银行(邮局)</strong></td>
                  <td class="2-td2-center"><ttsoft:write name="zhsbjksypdsActionForm" property="yhmc"/>&nbsp;</td>
                </tr>
              </table>
					<br>
             <bean:define id="gzlist" name="zhsbjksypdsActionForm" property="dataList"/>
              ...
              <table width="94%" border="0" cellpadding="0" cellspacing="4">
                <tr valign="bottom"> 
				  ...
				  <!--<td width="9%"> <img onClick=""  onMouseOver="MM_swapImage('dy1','','<%=static_contextpath%>images/dy-p2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="打印" id="dy1" src="<%=static_contextpath%>images/dy-p1.jpg" width="79" height="22"></td>-->
                  <!--<td width="9%"><img onClick="doSubmitForm('Back')" onMouseOver="MM_swapImage('tc1','','<%=static_contextpath%>images/fanhui2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="退出" id="tc1" src="<%=static_contextpath%>images/fanhui1.jpg" width="79" height="22"></td>-->
                  <td width="10%"><input type="image" accesskey="f" tabIndex="-1" onClick="doSubmitForm('Back');return false;" style="cursor:hand;" onMouseOver="MM_swapImage('fh1','','<%=static_contextpath%>images/fh-f2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="退出" id="fh1" src="<%=static_contextpath%>images/fh-f1.jpg" width="79" height="22"></td>
...
<html:hidden property="sjly" />
  ...
  <script language="javascript">
				<ttsoft:write name="zhsbjksypdsActionForm" property="scriptStr" filter="false"/>
