...
<html>
<head>
<title>事业单位、社会团体、民办非企业单位支出项目明细表</title>
...
<html:form  action="/webapp/smsb/qysds/cbmxbsydwAction.do">
   ...
   <html:hidden property="previousTableURL" />
	<table width="96%" align="center" cellspacing="0" class="table-99" onkeydown="reponseEnterKey()">
		<tr>
			<td class="1-td1"  colspan="7">事业单位、社会团体、民办非企业单位支出项目明细表</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="1-td2" colspan="7">&nbsp;&nbsp;计算机代码:<bean:write
				name="cbmxbsydwForm" property="jsjdm" scope="request" filter="true" />&nbsp;&nbsp;&nbsp;&nbsp;纳税人名称：<bean:write
				...
				<table id="wrklistTable" border="1" cellspacing="0" class="table-99" align="center" >
				  ...
				  <tr> 
				   ...
				   <input type="hidden" name="hc" value="1"/>
					...
					<td class="2-td2-left-qysds2" nowrap>  结转自筹基建</td>
				  ...
				  <tr> 
					...
					<td class="2-td2-left-qysds2" nowrap> 拨出经费</td>
				   ...
				   <td class="2-td2-left" nowrap>10</td>
					<td class="2-td2-left-qysds2" nowrap>其他支出</td>
                  ...
                  <tr> 
					...
					<td class="2-td2-left-qysds2" nowrap>上缴上级支出</td>
                  ...
                  <tr> 
					...
					<td class="2-td2-left-qysds2" nowrap> 拨出专款</td>
					...
					<td class="2-td2-left-qysds2" nowrap>（1）税收规定不允许扣除的支出项目金额</td>
				   ...
				   <td class="2-td2-left" nowrap>5</td>
					<td class="2-td2-left-qysds2" nowrap>专款支出</td>
				   ...
				   <input type="hidden" name="hc" value="5"/>
					...
					<td class="2-td2-left-qysds2" nowrap> （2）按分摊比例计算的支出项目金额</td>
                  ...
                  <tr> 
					...
					<td class="2-td2-left-qysds2" nowrap> 事业支出</td>
                  ...
                  <tr> 
					...
					<td class="2-td2-left-qysds2" nowrap>经营支出</td>
				  ...
				  <tr> 
					...
					<td class="2-td2-left-qysds2" nowrap> 对附属单位补助</td>
