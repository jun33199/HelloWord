...
<%@ page import="com.ttsoft.bjtax.smsb.sbzl.qysdsnb2008.hdzssdsnb.web.HdzssdsnbForm"%>
...
<html:form method="POST" action="/webapp/smsb/qysds/2008/hdzssdsnbAction2008">
		...
		<tr>
			...
			<table class="table-99" border="0" cellpadding="0" cellspacing="0" width="80%">
				...
				<TR>
					...
					<td width="30%" nowrap class="2-td2-left" align=left>&nbsp;<bean:write name="hdzssdsnbForm2008"
					...
					<td width="30%" nowrap class="2-td2-center" align=left>&nbsp; <bean:write
						name="hdzssdsnbForm2008" property="nsrmc" scope="request"
						filter="true" /> </td>
				</tr>
			</table>
			<br>
...
<script language="JavaScript">
	<%/*初始化*/%>	
	<%
	  HdzssdsnbForm jbForm=(HdzssdsnbForm)request.getAttribute("hdzssdsnbForm2008");
	%>
	function doInit()	
	{
	<%
