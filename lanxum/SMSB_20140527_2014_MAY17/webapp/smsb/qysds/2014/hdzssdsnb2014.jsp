...
<%@ page import="com.ttsoft.bjtax.smsb.sbzl.qysdsnb2014.hdzssdsnb.web.HdzssdsnbForm"%>
...
<html:form method="POST" action="/webapp/smsb/qysds/2014/hdzssdsnbAction2014.do">
		...
		<tr>
			...
			<table class="table-99" border="0" cellpadding="0" cellspacing="0" width="80%">
				...
				<tr>
					...
					<td width="30%" nowrap class="2-td2-left" align=left>&nbsp;<bean:write name="hdzssdsnbForm2014"
					...
					<td width="30%" nowrap class="2-td2-center" align=left>&nbsp; <bean:write
						name="hdzssdsnbForm2014" property="nsrmc" scope="request"
						filter="true" /> </td>
				</tr>
				...
				<tr>
					...
					<td width="30%" nowrap class="2-td2-center" align=left>
						<input  type="hidden" name='lje' id='19_1'  value='0.00' size='13' >
								  <div style="font-size: 9pt; line-height: 26px; color: #3E6071; background-color: #F3F5F8; text-align: left;">
					                ...
					                <bean:define id="dta" name="hdzssdsnbForm2014" property="gjbzhy"/>
...
<script language="JavaScript">
	...
	{
	<%
	HdzssdsnbForm jbForm=(HdzssdsnbForm)request.getAttribute("hdzssdsnbForm2014");
	...
	function doSave()
	{
		...
		if(!compareDate2Save(document.forms[0].skssjsrq))return false;
			...
			var zczeje = document.getElementById('17_1');
...
//		}
	...
	function compute_Row_12(){
		...
		var zczeStr=document.getElementById("17_1").value;
		var zgrsStr=document.getElementById("18_1").value;
		var sshyStr=document.getElementById("19_1").value;
		var ynsdse=0.00;
		var syndZbh6=0.00;
		var syndZbh25=0.00;
		var zcze=0.00;
...
/*		if(ynsdse>30*10000 || ynsdse<=0){
	...
	function compute_Row_13(){
		...
		if(document.getElementById('13_'+1).value == null||document.getElementById('12_'+1).value == ""){
			document.getElementById('13_1').value ='0.00';
		}				
 ...
 */
 ...
 function checkZcze(){
	...
	if(!checkNumber(zczeje.value,15,2,true)){
		alert("资产总额必须为数字，\n小数点后的长度为2位，\n且输入值需大于等于零！");
		zczeje.focus();
		zczeje.select();
		return false;
