...
<%@ page import="com.ttsoft.bjtax.smsb.sbzl.qysdsnb2014.czzsfzjgnb.web.ZfjgfzjgNbForm"%>
...
%>
	...
	{<%System.out.println("init start..........");%>
		...
		<%
			/*分支机构数据回显*/
			ZfjgfzjgNbForm zfjgForm = (ZfjgfzjgNbForm)request.getAttribute("zfjgfzjgNbForm2014");
			
			System.out.println("*******************"+zfjgForm.getQysdsNbList().size());
			//System.out.println(zfjgForm.getJglx());
			if((zfjgForm!=null) && (zfjgForm.getQysdsNbList().size()==0) && ("2".equals(zfjgForm.getJglx())))
			{
		%>	
		...
		<%
			...
			if (zfjgForm!=null && zfjgForm.getQysdsNbList().size()>0)
			{
				//明细数据最大索引
		...
		<%
				//填报数据量
				int size = zfjgForm.getQysdsNbList().size();
				System.out.println("size = " + size);
				//如果size 的值为8或15，则说明查询到的数据为系统自动插入数据，需要对营业收入、职工薪酬、资产总额进行初始化
				if("1".equals(zfjgForm.getJglx())){
					if(size==8){
						for(int i=7; i<10; i++){
		%>
		...
		<%				
				...
				{
					HashMap map = (HashMap) zfjgForm.getQysdsNbList().get(i);
		...
		<% 
			...
			//按机构类型格式化填报项目只读及颜色属性	
			if((zfjgForm!=null)&& ("2".equals(zfjgForm.getJglx())))
			{
		%>	
		...
		fzjgfpbl_zb = '<%=zfjgForm.getFzjgfpbl()%>';
		fzjgfpse_zb = '<%=zfjgForm.getFzjgfpse()%>';
		...
		obj = eval("document.getElementById('3_1')");
		obj.value = '<%=zfjgForm.getYnsdse()%>';
		obj = eval("document.getElementById('4_1')");
		obj.value = '<%=zfjgForm.getZjgftse()%>';
		obj = eval("document.getElementById('5_1')");
		obj.value = '<%=zfjgForm.getZjgfpse()%>';
		obj = eval("document.getElementById('6_1')");
		obj.value = '<%=zfjgForm.getFzjgftse()%>';	
		...
		for(var i=12; i<19; i++)
		{
			...
			switch(i)
			{
				...
				case 16:
					...
					break;
				case 17:
					NewTd.innerHTML = "<td align=left nowrap class='2-td2-left'><input type='text' name='fzjgfpbl' id=\"" + id + "\" style='text-align:right' value='0' size='5' onblur='checkPercent(this)' onchange='compute_Row_10(\"" + end + "\")'></td>";
					break;
				case 18:
...
*/%>
	...
	function doReset()
	{
	    ...
	    if(document.forms[0].jglx.value=='2')
	    {
		    ...
		    objFzjgFtsdse = eval("document.getElementById('6_1')");
	        objFzjgFtsdse.value = "0.00";
	        
		    objFzjgFpbl = eval("document.getElementById('17.1_1')");
	        objFzjgFpbl.value = "0";
	        
	        objFzjgFpse = eval("document.getElementById('18.1_1')");
	        objFzjgFpse.value = "0.00";	
	        
	        objFzjgFpse = eval("document.getElementById('10_1')");
	        objFzjgFpse.value = "0";
	        
	        objFzjgFpse = eval("document.getElementById('11_1')");
	        objFzjgFpse.value = "0.00";	 	   	
	    }
...
//				return false;
//			}
	if(confirm("确认删除企业所得税分支机构年度纳税申报表、企业所得税汇总纳税分支机构分配表?"))
    {
		doSubmitForm('Delete');
	}
//		doSubmitForm('Jump');	
...
*/%>	
	...
	{	
		...
		var nsrsbhArr = document.forms[0].fzjgnsrsbh;
		var zjgNsrshb = document.forms[0].nsrsbh.value;
		var srehj=0.00;
		var gzehj=0.00;
		var zcehj=0.00;
		var fpblhj=0.00;
		...
		{
			alert("各分支机构营业收入之和与合计数不等，请核实修改后再保存！");
			return false;
		}
		...
		{
			alert("各分支机构职工薪酬之和与合计数不等，请核实修改后再保存！");
			return false;
		}
		...
		{
			alert("各分支机构资产总额之和与合计数不等，请核实修改后再保存！");
			return false;
		}
 ...
 */
 function formateNum(obj){
 	...
 	<%/*分配比例合计必须等于100%*/%>
 	<%/*如果分支机构列表中包括总机构识别号，则总机构分摊所得税额必须大于等于分配税额合计；
 		*如果分支机构列表中不包括总机构识别号，则总机构分摊所得税额必须等于分配税额合计
 	  */
 	%>
	function saveCheckNew()
	{	
	
		var fzjgfpbl_new=document.getElementById("17.1_1").value;
		var fzjgfpse_new=document.getElementById("18.1_1").value;
		
		if((parseFloat(fzjgfpbl_zb.replace('%','')).toFixed(2)-parseFloat(fzjgfpbl_new.replace('%','')).toFixed(2)) !=0){
			alert("企业所得税分配表中行1列6（分配比例）应等于企业所得税分支机构年度纳税申报表分支机构分配比例！");
			return false; 
		}
		if((parseFloat(fzjgfpse_zb).toFixed(2)-parseFloat(fzjgfpse_new).toFixed(2)) !=0){
			alert("企业所得税分配表中行1列7（分摊税额）应等于企业所得税分支机构年度纳税申报表分支机构分配所得税额！");
			return false; 
		}
...
//		var fzjgfpse=document.getElementById("11_1").value;
//
//		if((parseFloat(fzjgftse).toFixed(2) - parseFloat(fzjgfpse).toFixed(2)) != 0)
//		{
...
<html:form action="/webapp/smsb/qysds/2014/zfjgfzjgNbAction2014.do">
	...
	<table width="96%" align="center" cellspacing="0" class="table-99"
      ...
      <table id="table_30" class="table-99" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td nowrap class="2-td2-left" align=left>
			<html:text property="ynsdse" styleId="3_1" style='text-align:right' size="19" onblur="checkInput(this)" onchange="isNumber('3_1')"/> 
		  </td>
          <td colspan="2" nowrap class="2-td2-left" align=left>
			<html:text property="zjgftse" styleId="4_1" style='text-align:right' size="19" onblur="checkInput(this)" onchange="isNumber('4_1')"/>  
          </td>
          <td nowrap class="2-td2-left" align=left>
			<html:text property="zjgfpse" style='text-align:right' styleId="5_1" size="19" onblur="checkInput(this)" onchange="isNumber('5_1')"/>   
		  </td>
          <td colspan="2"  align=left nowrap class="2-td2-center">
			<html:text property="fzjgftse" style='text-align:right' styleId="6_1" size="19" onblur="checkInput(this)" onchange="isNumber('5_1')"/>   
        </tr>
        <tr> 
        ...
        <tr> 
          <td nowrap class="2-td2-left" width="13%">营业收入</td>
          <td nowrap class="2-td2-left" width="12%">职工薪酬</td>
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left">
			<input type='text' name='fzjgfpbl' id='17.1_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.1_1')">
		  </td>
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.2_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.2_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.3_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)"  onchange="compute_Row_10('.3_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
			<input type='text' name='fzjgfpbl' id='17.4_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.4_1')">
		  </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.5_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.5_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.6_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.6_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.7_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.7_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.8_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.8_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.9_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.9_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.10_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.10_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.11_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.11_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.12_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.12_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.13_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.13_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.14_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.14_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
        ...
        <tr> 
          ...
          <td align=left nowrap class="2-td2-left"> 
		  	<input type='text' name='fzjgfpbl' id='17.15_1' style='text-align:right' value='0' size='5' onblur="checkPercent(this)" onchange="compute_Row_10('.15_1')"> 
          </td>
          <td align=left nowrap class="2-td2-center">
      ...
      <table  class="table-99" border="0" cellpadding="0" cellspacing="0">       
        <tr> 
          <td colspan="5" width="15%" nowrap class="2-td2-left" align=left>
			合计
		  </td>
          ...
          <td width="12%" nowrap class="2-td2-left" align=left>
          ...
          <td width="6%" align=left nowrap class="2-td2-left"> 
			<html:text property="fpblhj" styleId="10_1" style='text-align:right' size="5" readonly='true' styleClass="text-gray" /> 
          </td>
