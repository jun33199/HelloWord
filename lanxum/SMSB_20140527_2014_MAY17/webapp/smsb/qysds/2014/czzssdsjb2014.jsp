...
.select-maxwidth{
	width:expression(this.width>420?"420":width);
}
</style>
</head>
              ...
              <table id="mssrxmAutoTable" border="1" cellspacing="0"
				   ...
				   <tr> 
                    ...
                    <td width="180" nowrap class="2-td2-center">
						<input tabindex="10" type='text' name='lje' 
							...
							value='0.00' size='13'
							onblur="formate(this)" onchange="compute_Row_8()" readonly="readonly">
                  ...
                  <tr id='tr_Mssrxm'>
                    ...
                    <td width="180" nowrap class="2-td2-left"><div align="center" id='mssrxm_div' >
                    	...
                    	<html:select name="czzssdsjb2014Form" property="mssrxmdm" onchange="renameId('Mssrxm')" style="width:420px;">
                    ...
                    <td width="180" nowrap class="2-td2-center"><input type='text' name='cbMssrxmYz' id='1' size='13' maxlength='13' value="" onblur='' onchange="checkNum(this);cbsjHj('Mssrxm')"></td>
                  </tr>			
			  </table>
              <table id="jzmzxmAutoTable" border="1" cellspacing="0"
                  ...
                  <tr> 
                    ...
                    <td width="180" nowrap class="2-td2-center">
						<input tabindex="10" type='text' name='lje' 
							...
							value='0.00' size='13'
							onblur="formate(this)" onchange="compute_Row_9()" readonly="readonly">
                  ...
                  <tr id='tr_Jzmzxm'>
                    ...
                    <td width="180" nowrap class="2-td2-left"><div align="center" id='jzmzxm_div' >
                    	...
                    	<html:select name="czzssdsjb2014Form" property="jzmzxmdm" onchange="renameId('Jzmzxm')" style="width:420px;">
  						<logic:iterate id="data" indexId="index" length="length" name="czzssdsjb2014Form"
                    ...
                    <td width="180" nowrap class="2-td2-center"><input type='text' name='cbJzmzxmYz' id='1' size='13' maxlength='13' value="" onblur='' onchange="checkNum(this);cbsjHj('Jzmzxm')"></td>
                  </tr>			
			  </table>
              ...
              <table id="jmxmAutoTable" border="1" cellspacing="0"
                  ...
                  <tr> 
                    ...
                    <td width="180" nowrap class="2-td2-center">
						<input tabindex="15" type='text' name='lje' 
							...
							value='0.00' size='13'
							onblur="formate(this)" onchange="compute_Row_14()" readonly="readonly">
                  ...
                  <tr id='tr_Jmxm'>
                    ...
                    <td width="180" nowrap class="2-td2-left"><div align="center" id='jmxm_div'>
                    	...
                    	<html:select name="czzssdsjb2014Form" property="jmxmdm" onchange="renameId('Jmxm')" style="width:420px;">
  						<logic:iterate id="data" indexId="index" length="length" name="czzssdsjb2014Form"
                    ...
                    <td width="180" nowrap class="2-td2-center"><input type='text' name='cbJmxmYz' id='1' size='13' maxlength='13' value="" onblur='' onchange="checkNum(this);cbsjHj('Jmxm')"></td>
                  </tr>			
			  </table>
...
//					document.getElementById("28_1").value="";
	...
	function doJmxmAddRow(cbJmxmYzhc,cbJmxmYz)
	{
		...
		var NewTd4 = document.createElement("<td width=\"180\" nowrap class=\"2-td2-center\">");
			NewTd4.innerHTML="<input type='text' name='cbJmxmYz' id='' value='"+cbJmxmYz+"' size='13' maxlength='13' onblur='' onchange=\"checkNum(this);cbsjHj('Jmxm')\"><img onclick=\"doDeleteCbRow(this,'Jmxm')\" src=\"<%=static_contextpath%>images/zbotton-jian2.gif\" alt=\"移除\" name=\"remove\" id=\"remove\"  style=\"cursor:hand\">";
			//往新行里面填充单元格
	...
	function doMssrxmAddRow(cbMssrxmYzhc,cbMssrxmYz)
	{
		...
		var NewTd4 = document.createElement("<td width=\"180\" nowrap class=\"2-td2-center\">");
			NewTd4.innerHTML="<input type='text' name='cbMssrxmYz' id='' value='"+cbMssrxmYz+"' size='13' maxlength='13' onblur='' onchange=\"checkNum(this);cbsjHj('Mssrxm')\"><img onclick=\"doDeleteCbRow(this,'Mssrxm')\" src=\"<%=static_contextpath%>images/zbotton-jian2.gif\" alt=\"移除\" name=\"remove\" id=\"remove\"  style=\"cursor:hand\">";
			//往新行里面填充单元格
			NewTr.appendChild(NewTd1);
			NewTr.appendChild(NewTd2);
			NewTr.appendChild(NewTd3);
	...
	function doJzmzxmAddRow(cbJzmzxmYzhc,cbJzmzxmYz)
	{
		...
		var NewTd4 = document.createElement("<td width=\"180\" nowrap class=\"2-td2-center\">");
			NewTd4.innerHTML="<input type='text' name='cbJzmzxmYz' id='' value='"+cbJzmzxmYz+"' size='13' maxlength='13' onblur='' onchange=\"checkNum(this);cbsjHj('Jzmzxm')\"><img onclick=\"doDeleteCbRow(this,'Jzmzxm')\" src=\"<%=static_contextpath%>images/zbotton-jian2.gif\" alt=\"移除\" name=\"remove\" id=\"remove\"  style=\"cursor:hand\">";
			//往新行里面填充单元格
			NewTr.appendChild(NewTd1);
			NewTr.appendChild(NewTd2);
			NewTr.appendChild(NewTd3);
