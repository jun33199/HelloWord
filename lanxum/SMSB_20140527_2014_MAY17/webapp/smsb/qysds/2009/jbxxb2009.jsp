...
<%
			com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.jbxxb.web.JbxxbForm2009 form = (com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.jbxxb.web.JbxxbForm2009) request
			.getAttribute("jbxxbForm2009");
...
<html:form action="/webapp/smsb/qysds/2009/jbxxbAction2009.do" method="post">
		...
		<tr>
			...
			<TABLE class="table-99" align="center">
					...
					<table id="wrklistTable" border="1" cellspacing="0"
						...
						<tr>
							...
							<td class="2-td2-t-left" nowrap><input
								...
								value='<ttsoft:write name="jbxxbForm2009" property="sknd"  scope="request" />'
							...
							<div align="left">&nbsp;&nbsp;<ttsoft:write
								name="jbxxbForm2009" property="sybsmc" scope="request" />							
							</div>
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" nowrap><input type='text'
								name='jsjdm' id='jsjdm'
								value='<ttsoft:write name="jbxxbForm2009" property="jsjdm"  scope="request" />'
							...
							<div align="left">&nbsp;&nbsp;<ttsoft:write
								name="jbxxbForm2009" property="nsrmc" scope="request" />							
							</div>
							</td>
						</tr>
						<tr>
							...
							<div align="left">&nbsp;&nbsp;<ttsoft:write
								name="jbxxbForm2009" property="ssjjlxmc" scope="request" /></div>
							</td>
							<td class="2-td2-left" nowrap>联系电话</td>
							<td class="2-td2-center" nowrap><input type='text'
								name='lxdh' id='lxdh'
								value='<ttsoft:write name="jbxxbForm2009" property="lxdh"  scope="request" />'
						...
						<tr>
							...
							<td class="2-td2-left" nowrap >
							<div align="left">&nbsp;&nbsp;<ttsoft:write
								name="jbxxbForm2009" property="sshymc" scope="request" /></div>
							</td>
							<td class="2-td2-left" nowrap>企业所得税征收方式</td>
							<td class="2-td2-center" nowrap>
							<div align="left">&nbsp;&nbsp;<ttsoft:write
								name="jbxxbForm2009" property="zsfsmc" scope="request" /></div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="2-td2-left" nowrap >
								...
								value='<ttsoft:write name="jbxxbForm2009" property="zczbje"  scope="request" />'
								size='13' tabindex='1'>
							</td>
							<td class="2-td2-left" nowrap>资产总额（单位：万元）</td>
							<td class="2-td2-center" nowrap>
								<input type='text' name='zcze' id='zcze' onblur='checkZcze()'
								value='<ttsoft:write name="jbxxbForm2009" property="zcze"  scope="request" />'
								size='13' tabindex='2'>
							</td>
						</tr>
						<!--2009版 不要求此部分内容
				...
				<TR class="black9">
					<TD><br>
						<div align="left">
						 <a href="javascript:toSbzl('qysdsMainAction2009.do?actionType=Show')">查帐征收企业所得税年度申报表(2009版)</a>
	                     </div>
					</TD>
				</TR>
			</TABLE>
