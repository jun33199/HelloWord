...
<html:form action="/webapp/smsb/qysds/2009/hznszjgfpbAction.do">
	...
	<table width="96%" align="center" cellspacing="0" class="table-99"
		...
		<tr>			
			<td class="1-td1" colspan="7">企业所得税汇总纳税总机构分配表</td>
		</tr>
		<tr>
      ...
      <table id="table_17" class="table-99" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="4" width="15%"  nowrap class="2-td2-t-left">纳税人识别号</td>
        ...
        <tr> 
          ...
          <td width="5%" rowspan="2" colspan="2" align=left nowrap class="2-td2-left">选择</td>
