...
<%@ page import="com.ttsoft.bjtax.smsb.sbzl.qysdsnb2009.ssyhmx.web.SsyhmxForm"%>
...
<script language="JavaScript">
		...
		<%
		SsyhmxForm nbForm=(SsyhmxForm)request.getAttribute("ssyhmxForm2009");
		Map readOnlyMap=nbForm.getReadOnlyMap();
		String wlrdbs = nbForm.getWlrdbs();
			if (nbForm!=null && nbForm.getDataList().size()>0){
				for(int i=0;i<nbForm.getDataList().size();i++){
					...
					obj.value = '<%=je%>';
					<%					
					if(readOnlyMap.get(String.valueOf(hc))!=null&&((String)readOnlyMap.get(String.valueOf(hc))).equals("true")){
					%>
					obj.readOnly=true;
	...
	function  showInputMessage(hc){
		if(hc=='32')
		alert('填写时请注意：该输入值应该与"附表五（1） 税收优惠明细表附表"行次2至行次3的合计数相等！'); 
		if(hc=='38')
		alert('填写时请注意：该输入值应该与"附表五（1） 税收优惠明细表附表"行次5至行次12的合计数相等！');
	}	
	</script>
...
<html:form action="/webapp/smsb/qysds/2009/ssyhmxAction2009">
	...
	<table width="96%" align="center" cellspacing="0" class="table-99"
		...
		<tr>
			<td class="1-td2" colspan="7">&nbsp;&nbsp;申报日期:<bean:write
				name="ssyhmxForm2009" property="sbrq" scope="request" filter="true" />
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			<td class="1-td2" colspan="7">&nbsp;&nbsp;计算机代码:<bean:write
				name="ssyhmxForm2009" property="jsjdm" scope="request" filter="true" />&nbsp;&nbsp;&nbsp;&nbsp;纳税人名称：<bean:write
				name="ssyhmxForm2009" property="nsrmc" scope="request" filter="true" />&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<TR>
					...
					<table id="wrklistTable" border="1" cellspacing="0"
						...
						<tr>
							...
							<td class="2-td2-left-qysds1" nowrap>   （六）其他（附报资料 行2＋行3）
							</td>
							<td class="2-td2-center" nowrap><input type='text' name='je' 
						...
						<tr>
							...
							<td class="2-td2-left-qysds1" nowrap>   （五）其他（附报资料 行5＋行6＋行7＋行8＋行9＋行10＋行11＋行12）
							</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
						...
						<tr>
							...
							<td class="2-td2-center" colspan="3" nowrap><div align="left">&nbsp;&nbsp;附报资料</div></td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" nowrap>1 
							  <input type="hidden" name="hc"
								value="48" id="hc_48"></td>
							<td class="2-td2-left-qysds1" nowrap>一、减免所得额</td>
							<td class="2-td2-center" nowrap>
								<div  id="jmsde"  style="display: none">
									<input type='text' name='je' readonly="readonly" class="txtInput" id='48_1' value='' size='13' tabindex='1'>
								</div>
								--
							</td> 
						</tr>
						<tr>
							...
							<td class="2-td2-left" nowrap>2 
							  <input type="hidden" name="hc"
								value="49" id="hc_49"></td>
							<td class="2-td2-left-qysds1" nowrap>清洁发展机制的项目所得</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='49_1' value='' size='13' tabindex='2'></td> 
						</tr>
						<tr>
							...
							<td class="2-td2-left" nowrap>3 
							  <input type="hidden" name="hc"
								value="50" id="hc_50"></td>
							<td class="2-td2-left-qysds1" nowrap>其他</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='50_1' value='' size='13' tabindex='2'></td> 
						</tr>
						<tr>
							...
							<td class="2-td2-left" nowrap>4 
							  <input type="hidden" name="hc"
								value="51" id="hc_51"></td>
							<td class="2-td2-left-qysds1" nowrap>二、减免税额</td>
							<td class="2-td2-center" nowrap>
								<div  id="jmse"  style="display: none">
									<input type='text' name='je' readonly="readonly" class="txtInput" id='51_1' value='' size='13' tabindex='1'>
								</div>
								--
							</td> 
						</tr>
						<tr>
							...
							<td class="2-td2-left" nowrap>5 
							  <input type="hidden" name="hc"
								value="52" id="hc_52"></td>
							<td class="2-td2-left-qysds1" nowrap>新办软件生产企业、集成电路设计企业</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='52_1' value='' size='13' tabindex='2'></td> 
						</tr>
						<tr>
							...
							<td class="2-td2-left" nowrap>6 
							  <input type="hidden" name="hc"
								value="53" id="hc_53"></td>
							<td class="2-td2-left-qysds1" nowrap>国家规划布局内的重点软件生产企业</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='53_1' value='' size='13' tabindex='2'></td> 
						</tr>
						<tr>
							...
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='25_1' value='' size='13' tabindex='1'></td>
							<td class="2-td2-left" nowrap>7 
							  <input type="hidden" name="hc"
								value="54" id="hc_54"></td>
							<td class="2-td2-left-qysds1" nowrap>生产线宽小于0.8微米（含）集成电路产品的生产企业</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='54_1' value='' size='13' tabindex='2'></td> 
						</tr>
						<tr>
							...
							<td class="2-td2-center" nowrap><input type='text' name='je' 
								id='26_1' value='' size='13' tabindex='1'></td>
							<td class="2-td2-left" nowrap>8 
							  <input type="hidden" name="hc"
								value="55" id="hc_55"></td>
							<td class="2-td2-left-qysds1" nowrap>投资额超过80亿元人民币或集成电路线宽小于0.25μm的集成电路生产企业</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='55_1' value='' size='13' tabindex='2'></td> 
						</tr>
						<tr>
							...
							<td class="2-td2-center" nowrap><input type='text' name='je' 
								id='27_1' value='' size='13' tabindex='1'></td>
							<td class="2-td2-left" nowrap>9 
							  <input type="hidden" name="hc"
								value="56" id="hc_56"></td>
							<td class="2-td2-left-qysds1" nowrap>符合条件的技术先进型服务企业</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='56_1' value='' size='13' tabindex='2'></td> 
						</tr>
						<tr>
							...
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='28_1' value='' size='13' tabindex='1'></td>
							<td class="2-td2-left" nowrap>10 
							  <input type="hidden" name="hc"
								value="57" id="hc_57"></td>
							<td class="2-td2-left-qysds1" nowrap>符合条件的动漫企业</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='57_1' value='' size='13' tabindex='2'></td> 
						</tr>
						<tr>
							...
							<td class="2-td2-center" nowrap><input type='text' name='je' 
								id='29_1' value='' size='13' tabindex='1'></td>
							<td class="2-td2-left" nowrap>11 
							  <input type="hidden" name="hc"
								value="58" id="hc_58"></td>
							<td class="2-td2-left-qysds1" nowrap>经营性文化事业单位转制企业</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='58_1' value='' size='13' tabindex='2'></td> 
						</tr>
						<tr>
							...
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='30_1' value='' size='13' tabindex='1'></td> 
							<td class="2-td2-left" nowrap>12 
							  <input type="hidden" name="hc"
								value="59" id="hc_59"></td>
							<td class="2-td2-left-qysds1" nowrap>其他</td>
							<td class="2-td2-center" nowrap><input type='text' name='je'
								id='59_1' value='' size='13' tabindex='2'></td> 
						</tr>
