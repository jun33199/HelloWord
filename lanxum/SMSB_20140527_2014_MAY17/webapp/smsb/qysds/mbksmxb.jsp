...
<%@ page
	import="com.ttsoft.bjtax.smsb.sbzl.qysdsnbnew.mbksmxb.web.MbksmxbForm"%>
<%@ page import="java.util.HashMap"%>
<html>
<head>
<title>税前弥补亏损明细表</title>
...
function doInit()
{
  ...
  <%
	MbksmxbForm mbksmxbForm=(MbksmxbForm)request.getAttribute("mbksmxbForm");
...
<br>
<html:form action="/webapp/smsb/qysds/mbksmxbAction.do" method="post">
	...
	<table width="96%" align="center" cellspacing="0" class="table-99"
		...
		<tr>
			<td class="1-td1" colspan="7">税前弥补亏损明细表</td>
		</tr>
		<tr>
			<td class="1-td2" colspan="7">&nbsp;&nbsp;申报日期:<bean:write
				name="mbksmxbForm" property="sbrq" scope="request" filter="true" />
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			<td class="1-td2" colspan="7">&nbsp;&nbsp;计算机代码:<bean:write
				name="mbksmxbForm" property="jsjdm" scope="request" filter="true" />&nbsp;&nbsp;&nbsp;&nbsp;纳税人名称：<bean:write
				name="mbksmxbForm" property="nsrmc" scope="request" filter="true" />&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<TR>
					...
					<table id="wrklistTable" border="1" cellspacing="0"
						...
						<tr>
							...
							<td rowspan="2" class="2-td1-left">亏损或盈利额</td>
							<td rowspan="2" class="2-td1-left">合并分立企业转入可弥补亏损额</td>
							<td rowspan="2" class="2-td1-left">合计</td>
							<td colspan="5" class="2-td1-left">在亏损年度以后已弥补过的亏损额</td>
							<td rowspan="2" class="2-td1-left">本年度可弥补的亏损额</td>
							<td rowspan="2" class="2-td1-center">可结转下一年度弥补的亏损额</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="2-td2-left"><input type='text' name='nd' id='1_1'
								...
								style="text-align:center" onchange = 'isYear(this)'></td>
						...
						<tr>
							<td class="2-td2-left">7</td>
							<td colspan="11" class="2-td2-left">可结转下一年度弥补的亏损额合计</td>
							<td class="2-td2-center"><input type='text' name='xynmbkse'
