...
<%@ page import="com.ttsoft.bjtax.smsb.sbzl.qysdsnb2012.czzssdsnb.web.ZfjgqysdsNbForm"%>
...
%>
	...
	function doInit()
	{
		...
		<%
			/*分支机构数据回显*/
			ZfjgqysdsNbForm zfjgForm = (ZfjgqysdsNbForm)request.getAttribute("zfjgnb2012Form");
			if((zfjgForm!=null) && (zfjgForm.getQysdsNbList().size()==0) && (zfjgForm.getJglx().equals("2")))
			{
		%>	
...
<html:form action="/webapp/smsb/qysds/zfjgqysdsnb2012Action.do">
	...
	<table width="96%" align="center" cellspacing="0" class="table-99"
      ...
      <table id="table_30" class="table-99" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td colspan="2" width="15%"  nowrap class="2-td2-t-left">纳税人识别号</td>
        ...
        <tr> 
          <td nowrap class="2-td2-left" width="13%">收入额</td>
          <td nowrap class="2-td2-left" width="12%">工资额</td>
          <td nowrap class="2-td2-left">资产额</td>
        </tr>
        <tr> 
          <td nowrap class="2-td2-left" align=left>
