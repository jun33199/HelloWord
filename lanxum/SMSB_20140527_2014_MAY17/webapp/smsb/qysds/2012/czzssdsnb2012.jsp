...
<%@ page import="com.ttsoft.bjtax.smsb.sbzl.qysdsnb2012.czzssdsnb.web.CzzssdsNbForm"%>
...
<html:form method="POST" action="/webapp/smsb/qysds/czzssdsnb2012Action.do">
						...
						<TR>
							...
							<td colspan="3" width="70%" nowrap align="left">
								<div style="font-size: 9pt; line-height: 26px; color: #3E6071; background-color: #F3F5F8; text-align: left;">
									 <bean:write name="czzssdsnb2012Form" property="nsrsbh" scope="request" filter="true" />
								</div>
							</td>
						</tr>
						<TR>
							...
							<td colspan="3" nowrap align="left">
								<div style="font-size: 9pt; line-height: 26px; color: #3E6071; background-color: #F3F5F8; text-align: left;">
									<bean:write name="czzssdsnb2012Form" property="nsrmc" scope="request" filter="true" />
								</div>
							</td>
						</tr>
					</table>
...
<script language="JavaScript">
	...
	function doInit()	
	{
		//alert("初始化...");
		<%
		CzzssdsNbForm nbForm=(CzzssdsNbForm)request.getAttribute("czzssdsnb2012Form");
