...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="doInit()">
 ...
 <br>
	...
	<table width="96%" align="center" cellspacing="0" class="table-99" onkeydown="reponseEnterKey()">
		<tr>
			<td class="1-td1"  colspan="7">销售(营业)收入及其他收入明细表</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="1-td2" colspan="7">&nbsp;&nbsp;计算机代码:<bean:write
				name="srbybqyForm" property="jsjdm" scope="request" filter="true" />&nbsp;&nbsp;&nbsp;&nbsp;纳税人名称：<bean:write
				...
				<table id="srbybqy_list" border="1" cellspacing="0" class="table-99" align="center">
				  ...
				  <tr> 
                   <td class="2-td2-left" nowrap>1</td>
					<td class="2-td2-left-qysds1" nowrap>一、销售（营业）收入合计(2+7+12)</td>
                   ...
                   <input type="hidden" name="hc" value="1"/>
					...
					<td class="2-td2-left-qysds1" nowrap>二、其他收入合计（17+24）</td>
                   <td class="2-td2-center" nowrap>
                  ...
                  <tr> 
					...
					<td class="2-td2-left-qysds3" nowrap>（2）处置固定资产净收益</td>
                   <td class="2-td2-center" nowrap>
                   ...
                   <input type="hidden" name="hc" value="5"/>
					...
					<td class="2-td2-left-qysds3" nowrap>（3）非货币性资产交易收益</td>
                   <td class="2-td2-center" nowrap>
                  ...
                  <tr> 
				   ...
				   <td class="2-td2-left" nowrap>21</td>
					<td class="2-td2-left-qysds3" nowrap>（4）出售无形资产收益</td>
                   <td class="2-td2-center" nowrap>
				  ...
				  <tr> 
                   ...
                   <input type="hidden" name="hc" value="8"/>
					...
					<td class="2-td2-left-qysds3" nowrap>（6）其他</td>
                   <td class="2-td2-center" nowrap>
                  ...
                  <tr> 
					...
					<td class="2-td2-left-qysds2" nowrap>2、税收上应确认的其他收入(25+26+27+28+29)</td>
                   <td class="2-td2-center" nowrap>
                  ...
                  <tr> 
					...
					<td class="2-td2-left-qysds3" nowrap>（1）因债权人原因确实无法支付的应付款项</td>
                   <td class="2-td2-center" nowrap>
				   ...
				   <tr> 
					...
					<td class="2-td2-left-qysds3" nowrap>（2）债务重组收益</td>
                   <td class="2-td2-center" nowrap>
				   ...
				   <tr> 
					...
					<td class="2-td2-left-qysds2" nowrap>3、视同销售收入(13+14+15)</td>
                   <td class="2-td2-center" nowrap>
                   ...
                   <input type="hidden" name="hc" value="12"/>
					...
					<td class="2-td2-left-qysds3" nowrap>（3）接受捐赠的资产</td>
                   <td class="2-td2-center" nowrap>
				   ...
				   <tr> 
					...
					<td class="2-td2-left-qysds3" nowrap>（1）自产、委托加工产品视同销售的收入</td>
                   <td class="2-td2-center" nowrap>
                   ...
                   <input type="hidden" name="hc" value="13"/>
					...
					<td class="2-td2-left-qysds3" nowrap>（4）资产评估增值</td>
                   <td class="2-td2-center" nowrap>
				   ...
				   <tr> 
					...
					<td class="2-td2-left-qysds3" nowrap>（2）处置非货币性资产视同销售的收入</td>
                    <td class="2-td2-center" nowrap>
                   ...
                   <input type="hidden" name="hc" value="29"/>
					...
					<td class="2-td2-left-qysds3" nowrap>（3）其他视同销售的收入</td>
                   <td class="2-td2-center" nowrap>
