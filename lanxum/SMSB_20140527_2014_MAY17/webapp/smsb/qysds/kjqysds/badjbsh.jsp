...
function doNext()
{
	...
	if(isSelected(document.forms[0].dshRadio))
	{
		...
		document.forms[0].actionType.value = "ViewMX";
		document.forms[0].submit();
	}
	else{
...
<table width="1000" align="center" cellspacing="0">
    <tr>
        <td class="1-td1"  colspan="9">审核扣缴企业所得税合同备案登记表</td>
    </tr>
    <tr>
        <td class="1-td2">
				...
				<tr>
					<td>
						<table border="1" cellspacing="0" class="table-99" align="center" >
							<tr> 
								<td width="10%" align="center" class="2-td2-t-left">&nbsp;</td>
								<td width="30%" align="center" class="2-td2-t-left"><strong>合同编号</strong></td>
								<td width="30%" align="center" class="2-td2-t-left"><strong>合同名称</strong></td>
								<td width="30%" align="center" class="2-td2-t-center"><strong>填报日期</strong></td>
							</tr>
					<%
						// 显示查询结果
					...
					%>
							<tr>
								...
								<td class="2-td2-center"><%=(String) map.get("tbrq")%></td>
							</tr>
					<%
							}
						}
