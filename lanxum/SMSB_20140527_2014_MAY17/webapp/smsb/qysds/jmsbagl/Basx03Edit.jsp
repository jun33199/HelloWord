...
<%@ page import="com.ttsoft.bjtax.smsb.qysdsjmsbagl.basx03.web.Basx03Form" %>
...
<html>  
  ...
  <%
  		Basx03Form basx = (Basx03Form)request.getAttribute("basx03Form");
	...
	function change1(){
		...
		if(zfgz == ""){
			...
			if(!(checkvalue(document.all("zfgz"),0)&&formatCurrency(document.all("zfgz"),0))){
				return false;
			}
		}
	}
	<%/*鼠标移动*/%>
	function change2(){
		var jjkce = document.all("jjkce").value;
		if(jjkce == ""){
			alert("加计扣除额不能为空！");
			document.forms[0].jjkce.focus();
			return false;
		}else{
			if(!(checkvalue(document.all("jjkce"),0)&&formatCurrency(document.all("jjkce"),0))){
				return false;
			}
		}
	}
	...
	function checkYm(){
		var zfgz = document.all("zfgz").value;
		var jjcce = document.all("jjkce").value;
		if(zfgz == ""){
			alert("支付给残疾职工工资不能为空！");
			document.forms[0].zfgz.focus();
			return false;
  ...
  <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onload="doInit()">
    <%@ include file="../../include/header.jsp" %> 
      ...
      <html:form action="/webapp/smsb/qysds/jmsbagl/Basx03Action.do" method="post">
            	...
            	<table cellspacing=0 border=0 class="table-99" style="TABLE-LAYOUT:fixed">
                    <tr>
                      ...
                      <td  width="22%"class="2-td2-t-left">
                      	&nbsp;<bean:write name="basx03Form" property="basqbh"/>
                      </td>
                      <td  class="2-td2-t-left">
                          <strong>计算机代码</strong>               
                      </td>
                      <td  class="2-td2-t-left">
                      	&nbsp;<bean:write name="basx03Form" property="jsjdm"/>
                      </td>                  
                      <td  class="2-td2-t-left">                       
                          <strong>纳税人名称</strong>
                      </td>
                      <td width="22%"  class="2-td2-t-center">
                      &nbsp;<bean:write name="basx03Form" property="nsrmc"/>
                      </td>
                    </tr>
                    <tr>
                      <td  class="2-td2-left">                        
                      ...
                      <td  width="22%"class="2-td2-left">
                      	&nbsp;<bean:write name="basx03Form" property="zgsws"/>
                      </td>
                      <td  class="2-td2-left">
                          <strong>经济类型</strong>               
                      </td>
                      <td  class="2-td2-left">
                      	&nbsp;<bean:write name="basx03Form" property="jjlx"/>
                      </td>                  
                      <td  class="2-td2-left">                       
                          <strong>所属行业</strong>
                      </td>
                      <td width="22%"  class="2-td2-center">
                      	&nbsp;<bean:write name="basx03Form" property="sshy"/>
                      </td>
                    </tr>
                   <tr>
                      <td  class="2-td2-left">
                      ...
                      <td  class="2-td2-left">
                      	&nbsp;<bean:write name="basx03Form" property="lxr"/>
                      </td>                  
                      <td  class="2-td2-left">                       
                          <strong>联系电话</strong>
                      </td>
                      <td width="22%"  class="2-td2-center" colspan="3">
                       &nbsp;<bean:write name="basx03Form" property="lxdh"/>
                      </td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      ...
                      <td colspan="3" class="2-td2-t-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                         <html:text property="zfgz" maxlength="18" onchange="change1()"></html:text>&nbsp;元
						 </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="3" class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                         <html:text property="jjkce" maxlength="18"  onchange="change2()"></html:text>&nbsp;元
						 </div>
                      </td>
                    </tr>
