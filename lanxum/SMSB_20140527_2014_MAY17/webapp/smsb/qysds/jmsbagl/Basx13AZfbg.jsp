          ...
          <tr>
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx13AForm" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                 ...
                 <table class="table-99" cellspacing="0">
                  ...
                  <table class="table-99" cellspacing="0">
                  	<tr>
                  		...
                  		<td class="2-td2-t-center">
                  			<div align="left">
                  			<html:select name="basx13AForm" styleId="zfyySelect"  onchange="qtzfyyControl()" property="zfyy"/>
                  		</div>
                  		</td>
                  	</tr>
                  </table>
