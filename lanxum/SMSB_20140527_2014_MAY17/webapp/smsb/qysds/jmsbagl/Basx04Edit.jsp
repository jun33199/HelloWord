  ...
  <%
	...
	function checkYm(){
		...
		if(document.all("wjmc").value == "") {
			alert("国务院行业主管部门或政府投资主管部门的核准文件:文件名称不能为空！");
            document.forms[0].wjmc.focus();			
			return false;
		}
		if(document.all("wh").value == "") {
			alert("国务院行业主管部门或政府投资主管部门的核准文件:文号不能为空！");
          ...
          <tr>
			...
			<table class="table-99" cellspacing="0">
				...
				<tr>
					...
					<div align="left">国务院行业主管部门或政府投资主管部门的核准文件</div>
					</td>
					<td class="2-td2-left"><div align="left">文件名称<font color="red">
					* </font></div></td>
				...
				<tr>
					<td class="2-td2-left"><div align="left">文号<font color="red">
					* </font></div></td>
					<td class="2-td2-center">
				...
				<tr>
					...
					* </font></div>
					...
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><html:text
						property="dybrq" maxlength="4" size="30" ></html:text>年
					</td>
				</tr>
				<tr>
					<td width="20%" class="2-td2-left" colspan="2">
					...
					年至 <html:text property="mzzznd" maxlength="4" size="30"  size="5"></html:text> 年</div>
					</td>
				</tr>
				<tr>
					<td width="20%" class="2-td2-left" colspan="2">
					<div align="left">减征年度</div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">从 <html:text
						property="jzqsnd" maxlength="4" size="5"></html:text>
					年至 <html:text property="jzzznd" maxlength="4" size="5"></html:text> 年</div>
					</td>
				</tr>
			</table>
                 <br/>
