...
<html:form action="/webapp/smsb/qysds/jmsbagl/Basx18Action.do"
	method="post">
		...
		<tr>
			...
			<table cellspacing=0 border=0 class="table-99"
				...
				<tr>
					...
					<td width="22%" class="2-td2-center" colspan="3">&nbsp;<bean:write
						name="basx18Form" property="lxdh" /></td>
				</tr>
			</table>
			...
			<table cellspacing=0 border=0 class="table-99"
				...
				<tr>
					...
					<td class="2-td2-t-left" width="15%">&nbsp;<bean:write
						name="basx18Form" property="qsrq" /></td>
					<td class="2-td2-t-left" width="10%">截止时间</td>
					<td class="2-td2-t-left" width="15%">&nbsp;<bean:write
						name="basx18Form" property="jzrq" /></td>

					<td class="2-td2-t-left" width="10%">减免税额</td>
					<td class="2-td2-t-left" width="15%">&nbsp;<bean:write
						name="basx18Form" property="bajmse" /></td>
					<td class="2-td2-t-left" width="10%">减免比例</td>
					<td class="2-td2-t-center" width="15%">&nbsp;<bean:write
						name="basx18Form" property="bajmbl" /></td>
				...
				<tr>
					...
					<div align="left">&nbsp;&nbsp;&nbsp; <bean:write
						name="basx18Form" property="jmszczxqk" /></div>
					<td>
				</tr>
				<tr>
			...
			<table class="table-99" cellspacing="0">
				<tr>
					...
					<div align="left">技术先进型服务业务范围</div>
					</td>
					<td class="2-td2-t-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx18Form" property="fwywfwmc" /></div>
					</td>
				</tr>
				<tr>
					...
					<div align="left">证书编号 <font color="#FF0000"> * </font></div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx18Form" property="zsbh" /></div>
					</td>
				</tr>
				<tr>
					<td width="20%" class="2-td2-left">
					<div align="left">证书有效期起 <font color="#FF0000"> * </font></div>
					</td>
					<td class="2-td2-center">
					<div align="left"><bean:write name="basx18Form"
						property="zsqsrq" /></div>
					</td>
				</tr>
				<tr>
					<td width="20%" class="2-td2-left">
					<div align="left">证书有效期止 <font color="#FF0000"> * </font></div>
					</td>
					<td class="2-td2-center">
					<div align="left"><bean:write name="basx18Form"
						property="zszzrq" /></div>
				...
				<tr>
					...
					<div align="left">本年预计的减免税额 <font color="#FF0000"> * </font>
					</div>
					</td>
					<td colspan="1" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx18Form" property="bnyjjmse" /> 元</div>
					</td>
				</tr>
			</table>
			<br />
			...
			<table width="100%" border="0" align="center">
				<tr align="center">
					<td><a style="cursor: hand" onClick="check('4')"
					...
					<img src="<%=static_contextpath%>images//b_jssq1.jpg"
						...
						id="jishoushenqing"> </a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
						style="cursor: hand" onClick="check('5')"
						onMouseOut="MM_swapImgRestore()"
						onMouseOver="MM_swapImage('jujueshenqing','','<%=static_contextpath%>images//b_jjsq2.jpg',1)">
					<img src="<%=static_contextpath%>images//b_jjsq1.jpg"
						name="jujueshenqing" width="79" height="22" border="0"
						id="jujueshenqing"> </a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
						style="cursor: hand" onClick="back()"
						onMouseOut="MM_swapImgRestore()"
