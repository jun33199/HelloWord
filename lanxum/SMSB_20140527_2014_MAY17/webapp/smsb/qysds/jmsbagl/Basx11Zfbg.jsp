...
<html>  
  ...
  <%
  		Basx11Form basx = (Basx11Form)request.getAttribute("basx11Form");
        ...
        <table width="75%" align="center" cellspacing="0" height="480">
          <tr>
            <td class="1-td1" colspan="7" height="30">
              作废及变更生产线宽小于0.8微米（含）集成电路产品的生产企业减免税备案事项
            </td>
          </tr>
          <br>
          <tr>
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                	&nbsp;<bean:write name="basx11Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx11Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx11Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
                	&nbsp;<bean:write name="basx11Form" property="bajmbl"/>&nbsp;%
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx11Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
			...
			<table class="table-99" cellspacing="0">
				<tr>
					...
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx11Form" property="hlnd" />&nbsp;年</div>
					</td>
				</tr>
				<tr>
					<td class="2-td2-left">
					...
					<div id="mx_zsfsdm_epx_visible_1" align="left">从 <bean:write
						name="basx11Form" property="mzqsnd" /> 年至 <bean:write
						name="basx11Form" property="mzzznd" />年止</div>
					</td>
				</tr>
				<tr>
					<td class="2-td2-left">
					...
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">从 <bean:write
						name="basx11Form" property="jzqsnd" /> 年至 <bean:write
						name="basx11Form" property="jzzznd" /> 年止</div>
					</td>
				</tr>
				<tr>
					<td class="2-td2-left">
					...
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx11Form" property="yjjmse" />元</div>
					</td>
				</tr>
			</table>
                 <br/>
                  ...
                  <br/>
                   <table class="table-99" cellspacing="0">
                  	<tr>
                  		...
                  		<td class="2-td2-t-center">
                  			<div align="left">
                  			<html:select name="basx11Form" styleId="zfyySelect"  onchange="qtzfyyControl()" property="zfyy"/>
                  		</div>
                  		</td>
                  	</tr>
                  </table>
