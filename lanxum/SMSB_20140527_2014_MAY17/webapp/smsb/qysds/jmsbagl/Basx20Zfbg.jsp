        ...
        <table width="75%" align="center" cellspacing="0" height="480">
          ...
          <tr>
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                	&nbsp;<bean:write name="basx20Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx20Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx20Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
                	&nbsp;<bean:write name="basx20Form" property="bajmbl"/>&nbsp;%
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx20Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
                <td class="2-td2-center" colspan="8">
                  ...
                  <td>
            		...
            		<table class="table-99" cellspacing="0">                       <tr>
                      <td class="2-td2-t-left" >
                        <div align="left">
                          动漫企业类型
                        </div>
                      ...
                      <td class="2-td2-t-center" colspan="2" >
			            ...
			            &nbsp;<bean:write name="basx20Form" property="dmlxmc" />
                        </div>
                      </td>
                    </tr>
					...
					<tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                     &nbsp;<bean:write name="basx20Form" property="zsbh" />
                        </div>
                      </td>
                    </tr>
                      <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">
                       &nbsp;<bean:write name="basx20Form" property="zsqsrq" />
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">
                      &nbsp;<bean:write name="basx20Form" property="zszzrq" />
            ...
            <td class="2-td2-center" colspan="3">
              <div id="mx_zsfsdm_epx_visible_1" align="left">
               &nbsp;<bean:write name="basx20Form" property="hlnd" />&nbsp;年
            </td>
          </tr>
          <tr>
            <td colspan="1" class="2-td2-left">
            ...
            <td class="2-td2-center" colspan="3">
              <div id="mx_zsfsdm_epx_visible_1" align="left">
                	    从（
                           &nbsp;<bean:write name="basx20Form" property="mzqsnd" />&nbsp;)年至（
                 &nbsp;<bean:write name="basx20Form" property="mzzznd" />&nbsp;
                          ）年止
              </div>
            </td>
          </tr>
          <tr>
            <td class="2-td2-left" colspan="1">
              <div align="left">
                减半征收年度
              </div>
            </td>
            <td class="2-td2-center" colspan="3">
              <div id="mx_zsfsdm_epx_visible_1" align="left">
               	        从（
                           &nbsp;<bean:write name="basx20Form" property="jzqsnd" />&nbsp;)年至（
                &nbsp;<bean:write name="basx20Form" property="jzzznd" />&nbsp;
                          ）年止
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td class="2-td2-center" colspan="3">
              <div id="mx_zsfsdm_epx_visible_1" align="left">
		          ...
		          &nbsp; <bean:write name="basx20Form" property="jmse" />
		          &nbsp;元
            </td>
          </tr>
          </table>	
                  ...
                  <table class="table-99" cellspacing="0">
                  	<tr>
                  		...
                  		<td class="2-td2-t-center">
                  			<div align="left">
                  			<html:select name="basx20Form" styleId="zfyySelect"  onchange="qtzfyyControl()" property="zfyy"/>
                  		</div>
                  		</td>
                  	</tr>
                  </table>
