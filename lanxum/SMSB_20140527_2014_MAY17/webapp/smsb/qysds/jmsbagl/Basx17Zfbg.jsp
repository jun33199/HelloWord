            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                	&nbsp;<bean:write name="basx17Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx17Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx17Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
                	&nbsp;<bean:write name="basx17Form" property="bajmbl"/>&nbsp;%
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx17Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
                  ...
                  <td>
            		...
            		<table class="table-99" cellspacing="0">
                      ...
                      <td   class="2-td2-t-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          <bean:write name="basx17Form" property="zrsrje" />&nbsp;元
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                           <bean:write name="basx17Form" property="sjje1" />&nbsp;元
                        </div>
                      </td>	
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          <bean:write name="basx17Form" property="sjje2" />&nbsp;元
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td  class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          <bean:write name="basx17Form" property="hlnd" />&nbsp;年
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td  class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          从（
                          <bean:write name="basx17Form" property="mzqsnd"  />
                          ）年至（
                           <bean:write name="basx17Form" property="mzzznd" />
                          ）年止
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          从（
                          <bean:write name="basx17Form" property="jzqsnd" />
                          ）年至（
                           <bean:write name="basx17Form" property="jzzznd" />
                          ）年止
                        </div>
                      </td>
                    </tr>
                 ...
                 <table class="table-99" cellspacing="0">
                  ...
                  <table class="table-99" cellspacing="0">
                  	<tr>
                  		...
                  		<td class="2-td2-t-center">
                  			<div align="left">
                  			<html:select name="basx17Form" styleId="zfyySelect"  onchange="qtzfyyControl()" property="zfyy"/>
                  		</div>
                  		</td>
                  	</tr>
                  </table>
