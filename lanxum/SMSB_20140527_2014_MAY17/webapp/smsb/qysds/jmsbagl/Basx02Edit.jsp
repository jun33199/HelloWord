          ...
          <tr>
			...
			<table class="table-99" cellspacing="0">
				...
				<tr>
					...
					<div align="left">研发费用金额</div>
					</td>
					<td class="2-td2-left">
					<div align="left">当期扣除金额</div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><html:text
						property="dqkcje" maxlength="17" size="30" tabindex="-1" onchange="changedqkcje()"></html:text>元
				</tr>
				<tr>
					<td class="2-td2-left">
					<div align="left">形成无形资产金额</div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><html:text
						property="wxzcje" maxlength="17" size="30" tabindex="-1" onchange="changewxzcje()"></html:text>元
				</tr>
				<tr>
					<td class="2-td2-left" colspan="2">
					...
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><html:text
						property="jjkcje" maxlength="17" size="30" tabindex="-1" onchange="changejjkcje()"></html:text>元
					</td>
				</tr>
			</table>
