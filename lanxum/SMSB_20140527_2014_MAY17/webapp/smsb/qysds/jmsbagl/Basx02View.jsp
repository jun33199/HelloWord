...
<html>  
  ...
  <script type="text/javascript" language="JavaScript">
	...
	function doInit(){
		...
		var zfsm="<bean:write name="basx02Form" property="zfsm"/>";
        ...
        <table width="75%" align="center" cellspacing="0" height="480">
          ...
          <tr>
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                	&nbsp;<bean:write name="basx02Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx02Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx02Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
                	&nbsp;<bean:write name="basx02Form" property="bajmbl"/>&nbsp;%
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx02Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
			...
			<table class="table-99" cellspacing="0">
				<tr>
					<td width="70%" class="2-td2-t-left" colspan="2">
					<div align="left">研发费用领域<font color="#FF0000"> *
					</font></div>
					</td>
					<td class="2-td2-t-center" width="30%">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx02Form" property="yffylymc" /></div>
					</td>
				</tr>
				<tr>
					<td class="2-td2-left" colspan="2">
					<div align="left">项目名称<font color="#FF0000"> *
					</font></div>
					</td>
					<td class="2-td2-center">
					<div align="left"><bean:write name="basx02Form"
						property="xmmc" /></div>
					</td>
				</tr>
				<tr>
					<td rowspan="2" class="2-td2-left">
					<div align="left">研发费用金额<font color="#FF0000"> *
					</font></div>
					</td>
					<td width="20%" class="2-td2-left">
					<div align="left">当期扣除金额<font color="#FF0000"> *
					</font></div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx02Form" property="dqkcje" />&nbsp;元
					</td>
				</tr>
				<tr>
					<td class="2-td2-left">
					<div align="left">形成无形资产金额<font color="#FF0000"> *
					</font></div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx02Form" property="wxzcje" />&nbsp;元
					</td>
				</tr>
				<tr>
					<td class="2-td2-left" colspan="2">
					<div align="left">加计扣除额<font color="#FF0000"> *
					</font></div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx02Form" property="jjkcje" />&nbsp;元</div>
					</td>
				</tr>
			</table>
                 <br/>
                 ...
                 <table class="table-99" cellspacing="0">
                    <tr>
                      ...
                      <td width="80%" class="2-td2-t-center">
                        <div align="left">
                        	<bean:write name="basx02Form" property="zfsm"/>
                        </div>
                      </td>
                    </tr>
                  </table>
