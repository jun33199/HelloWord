...
<%@ page import="com.ttsoft.bjtax.smsb.qysdsjmsbagl.basx11.web.Basx11Form" %>
...
*/
  ...
  <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onload="doInit()">
    <%@ include file="../../include/header.jsp" %> 
      ...
      <html:form action="/webapp/smsb/qysds/jmsbagl/Basx11Action.do" method="post">
        ...
        <table width="75%" align="center" cellspacing="0" height="480">
          <tr>
            <td class="1-td1" colspan="7" height="30">
              录入生产线宽小于0.8微米（含）集成电路产品的生产企业减免税备案事项
            </td>
          </tr>
          <br>
          <tr>
            	...
            	<table cellspacing=0 border=0 class="table-99" style="TABLE-LAYOUT:fixed">
                    <tr>
                      ...
                      <td  width="22%"class="2-td2-t-left">
                      	&nbsp;<bean:write name="basx11Form" property="basqbh"/>
                      </td>
                      <td  class="2-td2-t-left">
                          <strong>计算机代码</strong>               
                      </td>
                      <td  class="2-td2-t-left">
                      	&nbsp;<bean:write name="basx11Form" property="jsjdm"/>
                      </td>                  
                      <td  class="2-td2-t-left">                       
                          <strong>纳税人名称</strong>
                      </td>
                      <td width="22%"  class="2-td2-t-center">
                      &nbsp;<bean:write name="basx11Form" property="nsrmc"/>
                      </td>
                    </tr>
                    <tr>
                      <td  class="2-td2-left">                        
                      ...
                      <td  width="22%"class="2-td2-left">
                      	&nbsp;<bean:write name="basx11Form" property="zgsws"/>
                      </td>
                      <td  class="2-td2-left">
                          <strong>经济类型</strong>               
                      </td>
                      <td  class="2-td2-left">
                      	&nbsp;<bean:write name="basx11Form" property="jjlx"/>
                      </td>                  
                      <td  class="2-td2-left">                       
                          <strong>所属行业</strong>
                      </td>
                      <td width="22%"  class="2-td2-center">
                      	&nbsp;<bean:write name="basx11Form" property="sshy"/>
                      </td>
                    </tr>
                   <tr>
                      <td  class="2-td2-left">
                      ...
                      <td  class="2-td2-left">
                      	&nbsp;<bean:write name="basx11Form" property="lxr"/>
                      </td>                  
                      <td  class="2-td2-left">                       
                          <strong>联系电话</strong>
                      </td>
                      <td width="22%"  class="2-td2-center" colspan="3">
                       &nbsp;<bean:write name="basx11Form" property="lxdh"/>
                      </td>
                    </tr>
                  </table>
			...
			<table class="table-99" cellspacing="0">
				...
				<tr>
					<td class="2-td2-left">
					<div align="left">本年预计的减免税额<font color="red">
					* </font></div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><html:text
						property="yjjmse" size="15" onchange="changeyjjmse()" maxlength="17"></html:text> 元</div>
					</td>
				</tr>
			</table>
                 <br/>
