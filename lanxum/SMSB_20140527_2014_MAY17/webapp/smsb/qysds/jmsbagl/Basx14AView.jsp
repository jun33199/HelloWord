...
<html>  
  ...
  <script type="text/javascript" language="JavaScript"> 
	...
	function doInit(){
		...
		var zfsm="<bean:write name="basx14AForm" property="zfsm"/>";
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                  	&nbsp;<bean:write name="basx14AForm" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx14AForm" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                  	&nbsp;<bean:write name="basx14AForm" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
	                &nbsp;<bean:write name="basx14AForm" property="bajmbl"/>&nbsp;%
                </td>
              ...
              <tr>
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx14AForm" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
                <td class="2-td2-center" colspan="8">
                  ...
                  <td>
                   ...
                   <tr>
					...
					<div align="left">
					<bean:write name="basx14AForm" property="zysblxmc" />
					</div>
					</td>
				</tr>
				<tr>
					...
					* </font></div>
					...
					<div align="left">
						<bean:write name="basx14AForm" property="zysbmc" />
					</div>
					</td>
				</tr>
				<tr>
					...
					<div id="mx_zsfsdm_epx_visible_1" align="left">
						<bean:write name="basx14AForm" property="gznd" />&nbsp;年
					</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="2-td2-center">
					<div align="left">
						<bean:write name="basx14AForm" property="tze" />&nbsp;元
					</div>
					</td>
				</tr>
				<tr>
					...
					* </font></div>
					...
					<td class="2-td2-center">
					<div align="left">
						<bean:write name="basx14AForm" property="dmynse"  />&nbsp;元
					</div>
					</td>
				</tr>
                 ...
                 <table class="table-99" cellspacing="0">
                    <tr>
                      ...
                      <td width="80%" class="2-td2-t-center">
                        <div align="left">
                        	<bean:write name="basx14AForm" property="zfsm"/>
                        </div>
                      </td>
                    </tr>
                  </table>
