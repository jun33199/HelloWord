...
<html>  
  ...
  %>  
	...
	function doInit(){
		...
		for(row_indexo=0;row_indexo<zl.length;row_index++){
			var new_row=Table2.insertRow(Table2.rows.length);
			zlnr = zl[row_indexo].substring(0,zlo[row_indexo].indexOf("|"));
			xh = zlo[row_indexo].substring(zlo[row_indexo].indexOf("|")+1,zlo[row_indexo].length);
		    addzlmc(row_indexo,zlnr,new_rowo);
		    addzlan(xh,row_indexo,new_rowo);
		}		
		jszylxzl1();
	}
          ...
          <tr>
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                  	&nbsp;<bean:write name="basx07Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx07Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                  	&nbsp;<bean:write name="basx07Form" property="bajmse"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
	                &nbsp;<bean:write name="basx07Form" property="bajmbl"/>
                </td>
              ...
              <tr>
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx07Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
			...
			<table class="table-99" cellspacing="0">
				<tr>
					...
					<div align="left">技术转让类型<font color="#FF0000"> * </font></div>
					</td>
					<td colspan="3" class="2-td2-t-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx07Form" property="jszrlxmc" /></div>
					</td>
				</tr>
				...
				<tr>
					...
					<%
					if ("0".equals(basx.getJnjwbs())) {
					%>
					<html:radio property="jnjwbs" value="0">境内技术转让</html:radio> 
					<html:radio property="jnjwbs" value="1" disabled="true">境外技术转让</html:radio></div>
					<%
					} else {
					%>
					<html:radio property="jnjwbs" value="0" disabled="true">境内技术转让</html:radio> 
					<html:radio property="jnjwbs" value="1">境外技术转让</html:radio></div>					
					</td>
					<%
					}
					%>
				...
				<tr>
					...
					<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx07Form" property="jszrsd" /> 元
					</td>
					</div>
				</tr>
				<tr>
					...
					<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx07Form" property="jszrhtmc" /> 
					</td>
					</div>
				</tr>				
			</table>
