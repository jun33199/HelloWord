...
<%@ page import="com.ttsoft.bjtax.smsb.qysdsjmsbagl.basx09.web.Basx09Form" %>
...
<html>  
  ...
  <%
  		Basx09Form basx = (Basx09Form)request.getAttribute("basx09Form");
  	// 构造减免税备案事项代码
	    String zslx = basx.getZslx();
	%>   
	var arySelect_zslx = new Array(["",""],["0","北京市软件企业证书"],["1","北京市集成电路设计企业证书"]);
	<%/*初始化*/%> 
	function doInit(){
	    //初始化资料
		...
		for(row_index=0;row_index<zl.length;row_index++){
		 ...
		 _addOptionsToSelect(document.forms[0].oSelect, arySelect_zslx);
	    <%
		if(null != zslx && !"".equals(zslx))
		{
		%>
				_selectOptionByValue(document.forms[0].oSelect, "<%=zslx%>");
		<%
		}
	    %>
	...
	function checkYm(){
		...
		var zslx = document.getElementById("zslx").value;
		if(zslx == ""){
			alert("证书类型不能为空！");
			return false;
		}
		...
		var zsyxqq = document.getElementById("zsyxqq").value;
		if(zsyxqq ==""){
			alert("证书有效期起不能为空！");
			document.forms[0].zsyxqq.focus();
			return false;
		}
		var zsyxqz = document.getElementById("zsyxqz").value;
		if(zsyxqz == ""){
			alert("证书有效期止不能为空！");
  ...
  <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onload="doInit()">
    <%@ include file="../../include/header.jsp" %> 
      ...
      <html:form action="/webapp/smsb/qysds/jmsbagl/Basx09Action.do" method="post">
            	...
            	<table cellspacing=0 border=0 class="table-99" style="TABLE-LAYOUT:fixed">
                    <tr>
                      ...
                      <td  width="22%"class="2-td2-t-left">
                      	&nbsp;<bean:write name="basx09Form" property="basqbh"/>
                      </td>
                      <td  class="2-td2-t-left">
                          <strong>计算机代码</strong>               
                      </td>
                      <td  class="2-td2-t-left">
                      	&nbsp;<bean:write name="basx09Form" property="jsjdm"/>
                      </td>                  
                      <td  class="2-td2-t-left">                       
                          <strong>纳税人名称</strong>
                      </td>
                      <td width="22%"  class="2-td2-t-center">
                      &nbsp;<bean:write name="basx09Form" property="nsrmc"/>
                      </td>
                    </tr>
                    <tr>
                      <td  class="2-td2-left">                        
                      ...
                      <td  width="22%"class="2-td2-left">
                      	&nbsp;<bean:write name="basx09Form" property="zgsws"/>
                      </td>
                      <td  class="2-td2-left">
                          <strong>经济类型</strong>               
                      </td>
                      <td  class="2-td2-left">
                      	&nbsp;<bean:write name="basx09Form" property="jjlx"/>
                      </td>                  
                      <td  class="2-td2-left">                       
                          <strong>所属行业</strong>
                      </td>
                      <td width="22%"  class="2-td2-center">
                      	&nbsp;<bean:write name="basx09Form" property="sshy"/>
                      </td>
                    </tr>
                   <tr>
                      <td  class="2-td2-left">
                      ...
                      <td  class="2-td2-left">
                      	&nbsp;<bean:write name="basx09Form" property="lxr"/>
                      </td>                  
                      <td  class="2-td2-left">                       
                          <strong>联系电话</strong>
                      </td>
                      <td width="22%"  class="2-td2-center" colspan="3">
                       &nbsp;<bean:write name="basx09Form" property="lxdh"/>
                      </td>
                    </tr>
                  </table>
                ...
                <td class="2-td2-center" colspan="8">
                  ...
                  <table width="95%" cellspacing=0 border=0>  
                  	<tr>
                  		...
                  		<td class="2-td2-t-left" width="50%">
                  ...
                  <td>
                    ...
                    <tr>
                      ...
                      <td  width="23%" class="2-td2-t-left">
                        <div align="left">
                         <html:select styleId="oSelect" style="width:150px" property="zslx">
                       </html:select>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td colspan="4" class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                           <html:text property="hlnd" size="20"  maxlength="4"></html:text>&nbsp;年
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="4" class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          从
                           <html:text property="mzqsnd"   size="5" maxlength="4"></html:text> 年至
                          <html:text property="mzzznd"  size="5"  maxlength="4"></html:text> 年
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="4" class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          从
                           <html:text property="jzqsnd"  size="5" maxlength="4">  </html:text> 年至
