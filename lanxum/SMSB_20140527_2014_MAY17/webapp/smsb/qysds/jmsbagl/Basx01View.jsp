...
<html>  
  ...
  <script type="text/javascript" language="JavaScript">
	...
	function doInit(){
		...
		var zfsm="<bean:write name="basx01Form" property="zfsm"/>";
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                	&nbsp;<bean:write name="basx01Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx01Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx01Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
                	&nbsp;<bean:write name="basx01Form" property="bajmbl"/>&nbsp;%
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx01Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
                  ...
                  <td>
                    ...
                    <tr>
                      ...
                      <td class="2-td2-t-center" width="50%">
                        <div align="left">&nbsp;&nbsp;
                        	<bean:write name="basx01Form" property="wjmc"/>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">&nbsp;&nbsp;
                        	<bean:write name="basx01Form" property="wh"/>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">&nbsp;&nbsp;
                        	<bean:write name="basx01Form" property="zyzhlyzlmc"/>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center" height="21">
                        <div align="left">&nbsp;&nbsp;
                        	<bean:write name="basx01Form" property="zsbh"/>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center" height="22">
                        <div align="left">&nbsp;&nbsp;
                        	<bean:write name="basx01Form" property="zsyxksrq"/>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center" height="20">
                        <div align="left">&nbsp;&nbsp;
                        	<bean:write name="basx01Form" property="zsyxjzrq"/>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">&nbsp;&nbsp;
                        	<bean:write name="basx01Form" property="qdsr"/>&nbsp;元
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">&nbsp;&nbsp;
                        	<bean:write name="basx01Form" property="jjsr"/>&nbsp;元
                        </div>
                      </td>
                    </tr>
                  </table>
                 ...
                 <table class="table-99" cellspacing="0">
                    <tr>
                      ...
                      <td width="80%" class="2-td2-t-center">
                        <div align="left">
                        	<bean:write name="basx01Form" property="zfsm"/>
                        </div>
                      </td>
                    </tr>
                  </table>
