...
<html>  
  ...
  <%
	...
	function jssq()
	{
		if(checkZbxx() && checkYm()&& checkZlRadio() && checkTzxx()){
			zlqd();
                ...
                <td class="2-td2-center" colspan="8">
                  ...
                  <td>
                    ...
                    <tr>
                      ...
                      <td class="2-td2-t-center">
                        <div align="left">
                        	<input type="radio" value="0" name="bm" onclick="changeEdit()" checked="true">本市</input>&nbsp;         
							<input type="radio" value="1" name="bm" onclick="changeEdit()">外地</input>
                        </div>
                      </td>
                    </tr>
                    <tr>
                  ...
                  <tr>
					...
					for(int i = 2006;i<=band;i++){
						String tze = "<input type=\"text\" name=\"tze"+i+"\" size=\"15\"  value=\"\" onblur=\"calc()\" onchange=\"change('1',"+i+")\">";
						String kdke = "<input type=\"text\" name=\"kdke"+i+"\" size=\"15\"  style=\"background-color:#efefef\"  readonly=\"readonly\" value=\"\">";
						String sjdke = "<input type=\"text\" name=\"sjdke"+i+"\" size=\"15\"  value=\"\" onblur=\"calc()\" onchange=\"change('2',"+i+")\">";
						String jzdke = "<input type=\"text\" name=\"jzdke"+i+"\" size=\"15\"  style=\"background-color:#efefef\"  readonly=\"readonly\" value=\"\">";
