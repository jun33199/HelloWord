...
<html>  
  ...
  %>   
	...
	function doInit(){
		...
		var zfsm="<bean:write name="basx07Form" property="zfsm"/>";
          ...
          <tr>
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx07Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                 ...
                 <table class="table-99" cellspacing="0">
                    <tr>
                      ...
                      <td width="80%" class="2-td2-t-center">
                        <div align="left">
                        	<bean:write name="basx07Form" property="zfsm"/>
                        </div>
                      </td>
                    </tr>
                  </table>
