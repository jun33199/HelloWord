...
<html>  
  ...
  %>
	...
	function doInit(){
		...
		var zfsm="<bean:write name="basx09Form" property="zfsm"/>";
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                	&nbsp;<bean:write name="basx09Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx09Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx09Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
                	&nbsp;<bean:write name="basx09Form" property="bajmbl"/>&nbsp;%
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx09Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
                  ...
                  <td>
                    ...
                    <tr>
                      ...
                      <td colspan="2" class="2-td2-t-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                         &nbsp;<bean:write name="basx09Form" property="zsbh" />&nbsp;
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-left" width="25%">
                        <div align="left">
                            &nbsp;<bean:write name="basx09Form" property="zsyxqq" />&nbsp;
                        </div>
                      </td>
                      ...
                      <td class="2-td2-center" width="20%">
                        <div align="left">
                           &nbsp;<bean:write name="basx09Form" property="zsyxqz" />&nbsp;
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="4" class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                            &nbsp;<bean:write name="basx09Form" property="hlnd" />&nbsp;年
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="4" class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                                从（
                           &nbsp;<bean:write name="basx09Form" property="mzqsnd" />&nbsp;)年至（
                 &nbsp;<bean:write name="basx09Form" property="mzzznd" />&nbsp;
                          ）年止
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="4" class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                       从（
                           &nbsp;<bean:write name="basx09Form" property="jzqsnd" />&nbsp;)年至（
                &nbsp;<bean:write name="basx09Form" property="jzzznd" />&nbsp;
                          ）年止
                        </div>
                      </td>
                    </tr>
                 ...
                 <table class="table-99" cellspacing="0">
                    <tr>
                      ...
                      <td width="80%" class="2-td2-t-center">
                        <div align="left">
                        	<bean:write name="basx09Form" property="zfsm"/>
                        </div>
                      </td>
                    </tr>
                  </table>
