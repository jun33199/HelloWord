...
<html>  
  ...
  <%
  		Basx12Form basx = (Basx12Form)request.getAttribute("basx12Form");
        ...
        <table width="75%" align="center" cellspacing="0" height="480">
          <tr>
            <td class="1-td1" colspan="7" height="30">
              作废及变更投资额超过80亿元人民币或集成电路线宽小于0.25μm的集成电路生产企业减免税备案事项
            </td>
          </tr>
          <br>
          <tr>
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                	&nbsp;<bean:write name="basx12Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx12Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx12Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
                	&nbsp;<bean:write name="basx12Form" property="bajmbl"/>&nbsp;%
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx12Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
			...
			<table class="table-99" cellspacing="0">
				<tr>
					...
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx12Form" property="hlnd" />&nbsp;年</div>
					</td>
				</tr>
				<tr>
					<td class="2-td2-left">
					<div align="left">免征年度<font color="#FF0000"> *
					</font></div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">从 <bean:write
						name="basx12Form" property="mzzznd" /> 年至 <bean:write
						name="basx12Form" property="mzqsnd" />年止</div>
					</td>
				</tr>
				<tr>
					<td class="2-td2-left">
					<div align="left">减半征收年度<font color="#FF0000"> *
					</font></div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">从 <bean:write
						name="basx12Form" property="jzqsnd" /> 年至 <bean:write
						name="basx12Form" property="jzzznd" /> 年止</div>
					</td>
				</tr>
				<tr>
					<td class="2-td2-left">
					...
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx12Form" property="yjjmse" />元</div>
					</td>
				</tr>
			</table>
                 <br/>
                 <table class="table-99" cellspacing="0">
                  ...
                  <table class="table-99" cellspacing="0">
                  	<tr>
                  		...
                  		<td class="2-td2-t-center">
                  			<div align="left">
                  			<html:select name="basx12Form" styleId="zfyySelect"  onchange="qtzfyyControl()" property="zfyy"/>
                  		</div>
                  		</td>
                  	</tr>
                  </table>
