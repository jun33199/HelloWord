...
/*-------------------------------------------------------------------------------------------------*/
 function doOnQsmzndBlur()
 {
	var qsmznd = document.getElementById("mzqsnd");
	if(qsmznd.value.length != 4 || isNaN(qsmznd.value))
		{
			alert("起始免征年度必须为4位数字");
			qsmznd.focus();
		}
	if(qsmznd.value>2015)
		{
          ...
          <tr>
            ...
            <table class="table-99" cellspacing="0">
                    <tr>
                      ...
                      <td class="2-td2-t-center">
                        <html:text property="mzqsnd" size="6" readonly="true" style="background-color:#efefef" onblur="javascript: doOnQsmzndBlur()"></html:text>年
                        <html:text property="mzzznd" size="6" readonly="true" style="background-color:#efefef;display:none;"></html:text>
                      </td> 
                    </tr>
             </table>
             <br/>
