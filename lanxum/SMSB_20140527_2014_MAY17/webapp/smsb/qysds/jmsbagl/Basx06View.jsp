...
<html>  
  ...
  <script type="text/javascript" language="JavaScript">
	...
	function doInit(){
		...
		var zfsm="<bean:write name="basx06Form" property="zfsm"/>";
        ...
        <table width="75%" align="center" cellspacing="0" height="480">
          <tr>
            <td class="1-td1" colspan="7" height="30">
              查看从事符合条件的环境保护、节能节水项目的所得税减免税备案事项
            </td>
          </tr>
          <br>
          <tr>
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                	&nbsp;<bean:write name="basx06Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx06Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx06Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
                	&nbsp;<bean:write name="basx06Form" property="bajmbl"/>&nbsp;%
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx06Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
			...
			<table class="table-99" cellspacing="0">
				<tr>
					...
					* </font></div>
					...
					<td class="2-td2-t-center" width="60%">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx06Form" property="jnjsxmlxmc" /></div>
					</td>
				</tr>
				<tr>
					...
					* </font></div>
					...
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx06Form" property="zlmcdm" /></div>
					</td>
				</tr>
				<tr>
					...
					* </font></div>
					...
					<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><bean:write
						name="basx06Form" property="dybsrnd" />年</div>
				...
				<tr>
					...
					* </font></div>
					...
					<div id="mx_zsfsdm_epx_visible_1" align="left">从（ <bean:write
						name="basx06Form" property="mzqsnd" /> ）年至（ <bean:write
						name="basx06Form" property="mzzznd" /> ）年止</div>
					</td>
				</tr>
				<tr>
					<td width="20%" class="2-td2-left">
					...
					* </font></div>
					...
					<td colspan="3" class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">从（ <bean:write
						name="basx06Form" property="jzqsnd" /> ）年至（ <bean:write
						name="basx06Form" property="jzzznd" /> ）年止</div>
					</td>
				</tr>
			</table>
                 <br/>
                 ...
                 <table class="table-99" cellspacing="0">
                    <tr>
                      ...
                      <td width="80%" class="2-td2-t-center">
                        <div align="left">
                        	<bean:write name="basx06Form" property="zfsm"/>
                        </div>
                      </td>
                    </tr>
                  </table>
