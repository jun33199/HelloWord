...
<html>  
  ...
  <script type="text/javascript" language="JavaScript">
	...
	function doInit(){
		...
		var zfsm="<bean:write name="basx10Form" property="zfsm"/>";
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                	&nbsp;<bean:write name="basx10Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx10Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx10Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
                	&nbsp;<bean:write name="basx10Form" property="bajmbl"/>&nbsp;%
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx10Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
                    ...
                    <tr>
                      ...
                      <td  class="2-td2-t-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          &nbsp;&nbsp;<bean:write name="basx10Form" property="yjjse" ></bean:write>&nbsp;元
                        </div>
                      </td>
                    </tr>
                  </table>
                 ...
                 <table class="table-99" cellspacing="0">
                    <tr>
                      ...
                      <td width="80%" class="2-td2-t-center">
                        <div align="left">
                        	<bean:write name="basx10Form" property="zfsm"/>
                        </div>
                      </td>
                    </tr>
                  </table>
