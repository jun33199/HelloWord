...
<%@ page import="com.ttsoft.bjtax.smsb.qysdsjmsbagl.basx20.web.Basx20Form" %>
...
<html>  
  ...
  <%
  		Basx20Form basx = (Basx20Form)request.getAttribute("basx20Form");
  	// 构造减免税备案事项代码
	   if(session.getAttribute(CodeConstant.PAGE_SELECT_ITEMS_SESSION_KEY_DMLXDM) != null)
	    {
	        out.print("var arySelect_dmlx = new Array(");
	        out.print("[\"\",\"\"]");
	        String[][] lyzldm = (String[][])session.getAttribute(CodeConstant.PAGE_SELECT_ITEMS_SESSION_KEY_DMLXDM);
	...
	function doInit(){
		...
		_addOptionsToSelect(document.forms[0].dmlxSelect, arySelect_dmlx);
		document.forms[0].dmlxSelect.value = document.all("dmlxdm").value;
	...
	var arr = document.all(name).value;
	
	flg=0;
	cmp="0123456789";
	for (var i=0;i<arr.length;i++){  
			tst=arr.substring(i,i+1);
			if (cmp.indexOf(tst)<0){
					flg++; 
				}
			} 
	if (flg!=0 ||arr.length!=4){ 
			alert("年份格式不正确，请输入正确的年份如 '2005'！");
			return false; 
			}
		return true;
	  }
	...
	<%/*效验子表信息*/%>
	function checkYm(){
		var dmlx = document.all("dmlx").value;
		if(dmlx == ""){
			alert("动漫类型不能为空！");
			document.forms[0].dmlx.focus();
			return false;
		}
	...
	function jssq()
	{
		if(checkZbxx() && checkYm()&& checkZlRadio()){
			...
			if(window.confirm("是否接受该纳税人的减免税备案申请？")){
				//用来处理下拉框保存后页面回显
				document.forms[0].dmlxdm.value = document.forms[0].dmlx.value;
  ...
  <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onload="doInit()">
    <%@ include file="../../include/header.jsp" %> 
      ...
      <html:form action="/webapp/smsb/qysds/jmsbagl/Basx20Action.do" method="post">
        ...
        <table width="75%" align="center" cellspacing="0" height="480">
          ...
          <tr>
            ...
            <br>
            	<table cellspacing=0 border=0 class="table-99" style="TABLE-LAYOUT:fixed">
                    <tr>
                      ...
                      <td  width="22%"class="2-td2-t-left">
                      	&nbsp;<bean:write name="basx20Form" property="basqbh"/>
                      </td>
                      <td  class="2-td2-t-left">
                          <strong>计算机代码</strong>               
                      </td>
                      <td  class="2-td2-t-left">
                      	&nbsp;<bean:write name="basx20Form" property="jsjdm"/>
                      </td>                  
                      <td  class="2-td2-t-left">                       
                          <strong>纳税人名称</strong>
                      </td>
                      <td width="22%"  class="2-td2-t-center">
                      &nbsp;<bean:write name="basx20Form" property="nsrmc"/>
                      </td>
                    </tr>
                    <tr>
                      <td  class="2-td2-left">                        
                      ...
                      <td  width="22%"class="2-td2-left">
                      	&nbsp;<bean:write name="basx20Form" property="zgsws"/>
                      </td>
                      <td  class="2-td2-left">
                          <strong>经济类型</strong>               
                      </td>
                      <td  class="2-td2-left">
                      	&nbsp;<bean:write name="basx20Form" property="jjlx"/>
                      </td>                  
                      <td  class="2-td2-left">                       
                          <strong>所属行业</strong>
                      </td>
                      <td width="22%"  class="2-td2-center">
                      	&nbsp;<bean:write name="basx20Form" property="sshy"/>
                      </td>
                    </tr>
                   <tr>
                      <td  class="2-td2-left">
                      ...
                      <td  class="2-td2-left">
                      	&nbsp;<bean:write name="basx20Form" property="lxr"/>
                      </td>                  
                      <td  class="2-td2-left">                       
                          <strong>联系电话</strong>
                      </td>
                      <td width="22%"  class="2-td2-center" colspan="3">
                       &nbsp;<bean:write name="basx20Form" property="lxdh"/>
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%">
                  	<html:text property="bajmse"  size="11"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                  ...
                  <td>
                      ...
                      <td class="2-td2-t-center" >
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                         <html:select name="basx20Form" property="dmlx" styleId="dmlxSelect" >
			           </html:select>
                        </div>
                      </td>
                    </tr>
					...
					<tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          <html:text property="zsbh" size="20" maxlength="50"></html:text>
                        </div>
                      </td>
                    </tr>
                      <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">
                          <html:text property="zsqsrq" size="20" onClick="WdatePicker()">
			             </html:text>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">
                          <html:text property="zszzrq" size="20" onClick="WdatePicker()">
			          </html:text>
                        </div>
                      </td>
                    </tr>
            ...
            <td class="2-td2-center" >
              <div id="mx_zsfsdm_epx_visible_1" align="left">
                <html:text property="hlnd" size="20" maxlength="4">
		          </html:text>&nbsp;年
            </td>
          </tr>
          <tr>
            ...
            <td class="2-td2-center" >
              <div id="mx_zsfsdm_epx_visible_1" align="left">
                   从
		          <html:text property="mzqsnd" size="5" maxlength="4">
		          </html:text>
		          年至
		          <html:text property="mzzznd" size="5" maxlength="4" >
		          </html:text>
		          年
              </div>
            </td>
          ...
          <tr>
            ...
            <td class="2-td2-center" >
              <div id="mx_zsfsdm_epx_visible_1" align="left">
               	 从
		          <html:text property="jzqsnd" size="5" maxlength="4">
		          </html:text>
		          年至
		          <html:text property="jzzznd" size="5" maxlength="4">
		          </html:text>
		          年
              </div>
            </td>
          ...
          <tr>
            ...
            <td class="2-td2-center" >
              <div id="mx_zsfsdm_epx_visible_1" align="left">
                <html:text property="jmse" size="20" maxlength="15"></html:text>
                元
            </td>
          </tr>
          </table>
