            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%"> 
                	&nbsp;<bean:write name="basx18Form" property="qsrq"/>
                </td>
                <td class="2-td2-t-left" width="10%">
                  截止时间
                </td>
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx18Form" property="jzrq"/>
                </td>                
                ...
                <td class="2-td2-t-left" width="15%">
                	&nbsp;<bean:write name="basx18Form" property="bajmse"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                <td class="2-td2-t-center" width="15%">
                	&nbsp;<bean:write name="basx18Form" property="bajmbl"/>&nbsp;%
                </td>
              </tr>
              <tr>
                <td class="2-td2-left">
                ...
                <td class="2-td2-center" colspan="7">
                	<div align="left">
                		&nbsp;&nbsp;&nbsp;
                		<bean:write name="basx18Form" property="jmszczxqk"/>
                	</div>
                  <td>
              </tr>
              <tr>
                <td class="2-td2-center" colspan="8">
            	  ...
            	  <br>
            		<table class="table-99" cellspacing="0">
                      ...
                      <bean:write  name="basx18Form"  property="fwywfwmc" />
                        </div>
                      </td>
                		</tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div id="mx_zsfsdm_epx_visible_1" align="left">
                          <bean:write name="basx18Form" property="zsbh" />
                        </div>
                      </td>
                    </tr>
                      <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">
                         <bean:write name="basx18Form" property="zsqsrq"  />
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="2-td2-center">
                        <div align="left">
                          <bean:write name="basx18Form" property="zszzrq"  />
                        </div>
                      </td>
                    </tr>
          <tr>
            ...
            <td colspan="1" class="2-td2-center">
              <div id="mx_zsfsdm_epx_visible_1" align="left">
                    <bean:write name="basx18Form" property="bnyjjmse"  />
                      元
              </div>
            </td>
          </tr>
                 ...
                 <table class="table-99" cellspacing="0">
                  ...
                  <table class="table-99" cellspacing="0">
                  	<tr>
                  		...
                  		<td class="2-td2-t-center">
                  			<div align="left">
                  			<html:select name="basx18Form" styleId="zfyySelect"  onchange="qtzfyyControl()" property="zfyy"/>
                  		</div>
                  		</td>
                  	</tr>
                  </table>
