...
<%@ page import="com.ttsoft.bjtax.smsb.qysdsjmsbagl.basx12.web.Basx12Form" %>
  ...
  <script type="text/javascript" language="JavaScript">  
	...
	function changeyjjmse(){
		...
		if(yjjmse == ""){
			...
			zfgs = 0;
			cmp="0123456789.";
			for (var i=0;i<yjjmse.length;i++){  
				tst=yjjmse.substring(i,i+1);
			...
			if (flg!=0 || zfgs > 1){ 
				...
				document.all.yjjmse.value=""; 
				document.forms[0].yjjmse.focus();
				return false; 
			}
		}
		formate(document.forms[0].yjjmse);
		var yjjmse1 = yjjmse;
		yjjmse = round2(yjjmse1);
		document.all("yjjmse").value = yjjmse;
	}
	...
	function back()
	{
	 ...
	 function addYear() {
	    var t = document.all("hlnd").value;
	    if( validateHlnd()) {
	    	document.all("mzqsnd").value = t;
		    document.all("mzzznd").value = parseInt(t) + parseInt("1");
...
*/
	...
	function validateHlnd() {
  	var hlnd = document.all("hlnd").value;
  	var band = document.all("band").value;
  	if(!isInt(hlnd)) {
  	   alert("获利年度必须是4位数字 如：2005");
  	   document.all.hlnd.value="";
  	   document.forms[0].hlnd.focus();
       return false;
  	}
  	...
  	/*
  	if(hlnd>=band || hlnd<band-5){
	   alert("获利年度不能大于等于备案年度并且不能大于备案年度减五！");
	   document.all.hlnd.value="";
	   document.forms[0].hlnd.focus();
	   return false;
	}
  ...
  <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onload="doInit()">
    <%@ include file="../../include/header.jsp" %> 
      ...
      <html:form action="/webapp/smsb/qysds/jmsbagl/Basx12Action.do" method="post">
        ...
        <table width="75%" align="center" cellspacing="0" height="480">
          <tr>
            <td class="1-td1" colspan="7" height="30">
              录入投资额超过80亿元人民币或集成电路线宽小于0.25μm的集成电路生产企业减免税备案事项
            </td>
          </tr>
          <br>
          <tr>
            	...
            	<table cellspacing=0 border=0 class="table-99" style="TABLE-LAYOUT:fixed">
                    <tr>
                      ...
                      <td  width="22%"class="2-td2-t-left">
                      	&nbsp;<bean:write name="basx12Form" property="basqbh"/>
                      </td>
                      <td  class="2-td2-t-left">
                          <strong>计算机代码</strong>               
                      </td>
                      <td  class="2-td2-t-left">
                      	&nbsp;<bean:write name="basx12Form" property="jsjdm"/>
                      </td>                  
                      <td  class="2-td2-t-left">                       
                          <strong>纳税人名称</strong>
                      </td>
                      <td width="22%"  class="2-td2-t-center">
                      &nbsp;<bean:write name="basx12Form" property="nsrmc"/>
                      </td>
                    </tr>
                    <tr>
                      <td  class="2-td2-left">                        
                      ...
                      <td  width="22%"class="2-td2-left">
                      	&nbsp;<bean:write name="basx12Form" property="zgsws"/>
                      </td>
                      <td  class="2-td2-left">
                          <strong>经济类型</strong>               
                      </td>
                      <td  class="2-td2-left">
                      	&nbsp;<bean:write name="basx12Form" property="jjlx"/>
                      </td>                  
                      <td  class="2-td2-left">                       
                          <strong>所属行业</strong>
                      </td>
                      <td width="22%"  class="2-td2-center">
                      	&nbsp;<bean:write name="basx12Form" property="sshy"/>
                      </td>
                    </tr>
                   <tr>
                      <td  class="2-td2-left">
                      ...
                      <td  class="2-td2-left">
                      	&nbsp;<bean:write name="basx12Form" property="lxr"/>
                      </td>                  
                      <td  class="2-td2-left">                       
                          <strong>联系电话</strong>
                      </td>
                      <td width="22%"  class="2-td2-center" colspan="3">
                       &nbsp;<bean:write name="basx12Form" property="lxdh"/>
                      </td>
                    </tr>
                  </table>
			...
			<div id="qt" style="display: inline;">
			<table class="table-99" cellspacing="0">
				<tr>
					<td class="2-td2-t-left">
					<div align="left">获利年度声明：获利年度 <font color="#FF0000"> *
					</font></div>
					</td>
					<td class="2-td2-t-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><html:text
						property="hlnd" size="15" maxlength="4"></html:text>&nbsp;年</div>
					</td>
				</tr>
				<tr>
					<td class="2-td2-left">
					...
					<div id="mx_zsfsdm_epx_visible_1" align="left">从 <html:text
						property="mzqsnd" size="5" maxlength="4"></html:text> 年至 <html:text
						property="mzzznd" size="5" maxlength="4"></html:text> 年</div>
					</td>
				</tr>
				<tr>
					<td class="2-td2-left">
					<div align="left">减半征收年度
					</div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left">从 <html:text
						property="jzqsnd" size="5" maxlength="4"></html:text> 年至 <html:text
						property="jzzznd" size="5" maxlength="4"></html:text> 年</div>
					</td>
				</tr>
				<tr>
					<td class="2-td2-left">
					<div align="left">本年预计的减免税额<font color="#FF0000"> *
					</font></div>
					</td>
					<td class="2-td2-center">
					<div id="mx_zsfsdm_epx_visible_1" align="left"><html:text
						property="yjjmse" size="15" maxlength="17" onchange="changeyjjmse()"></html:text> 元</div>
					</td>
				</tr>
			</table>
                 <br/>
