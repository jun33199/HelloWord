  ...
  <%
	...
	function addzlan(lx,row_index,new_row){
	    ...
	    if(lx == "1"){
	    	...
	    	new_col.innerHTML="<a href=\"#\" onclick=\"delete_row('row"+row_index+ "')\">删除</a>";  
	    }
          ...
          <tr>
            ...
            <br>
              ...
              <tr>
                ...
                <td class="2-td2-t-left" width="15%">
                  	<html:text property="bajmse" onfocus="sehblkz('1')" size="10" styleClass="txtInput"/>&nbsp;元
                </td>
                <td class="2-td2-t-left" width="10%">
                  减免比例
                </td>
                  ...
                  <table width="95%" cellspacing=0 border=0>  
                  	<tr>
                  		...
                  		<td class="2-td2-t-center">
                  			<a href="#" onclick="addzl()">添加到资料清单</a>
                  		</td>
                  	</tr>
                  </table>	 
                  </br>
