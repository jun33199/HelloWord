...
<%@ page import="com.ttsoft.bjtax.smsb.sbzl.qysdsjb2012.web.ZfjgqysdsjbForm"%>
...
%>
	...
	function doInit()
	{
		...
		<%
			/*分支机构数据回显*/
			ZfjgqysdsjbForm zfjgForm = (ZfjgqysdsjbForm)request.getAttribute("zfjg2012Form");
...
<html:form action="/webapp/smsb/qysds/zfjgqysdsjb2012Action.do">
	...
	<table width="96%" align="center" cellspacing="0" class="table-99"
		...
		<tr>			
			<td class="1-td1" colspan="7">中华人民共和国企业所得税汇总纳税分支机构分配表2012</td>
		</tr>
		<tr>
      ...
      <table id="table_30" class="table-99" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td nowrap class="2-td2-left">收入额</td>
          <td nowrap class="2-td2-left">工资额</td>
      ...
      <table  class="table-99" border="0" cellpadding="0" cellspacing="0">       
        <tr> 
          <td width="16%" nowrap class="2-td2-left" align=left>
			合计
		  </td>
