...
<script language="JavaScript">
	...
	initNumText("je",13);
	<%
	GkfzcmxbForm gkfzcmxbForm=(GkfzcmxbForm)request.getAttribute("gkfzcmxbForm");
	if (gkfzcmxbForm!=null && gkfzcmxbForm.getDataList().size()>0){
		for(int i=0;i<gkfzcmxbForm.getDataList().size();i++){
			HashMap map=(HashMap)gkfzcmxbForm.getDataList().get(i);
...
<html:form action="/webapp/smsb/qysds/gkfzcmxbAction.do">
	...
	<table width="96%" align="center" cellspacing="0" class="table-99" onkeydown="reponseEnterKey()">
		<tr>
			<td class="1-td1" colspan="7">广告费支出明细表</td>
		</tr>
		<tr>
			<td class="1-td2" colspan="7">&nbsp;&nbsp;申报日期:<bean:write
				name="gkfzcmxbForm" property="sbrq" scope="request" filter="true" />
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			<td class="1-td2" colspan="7">&nbsp;&nbsp;计算机代码:<bean:write
				name="gkfzcmxbForm" property="jsjdm" scope="request" filter="true" />&nbsp;&nbsp;&nbsp;&nbsp;纳税人名称：<bean:write
				name="gkfzcmxbForm" property="nsrmc" scope="request" filter="true" />&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<TR>
				   ...
				   <td class="2-td1-left" nowrap>项目</td><!-->
						...
						<tr>
							...
							<td class="2-td2-left-qysds1" nowrap>广播电视广告</td>
							...
							<td class="2-td2-left-qysds1" nowrap>本年广告费扣除限额 (6×7)</td>
							<td class="2-td2-center" nowrap><input type='hidden' name='hc'
						...
						<tr>
							...
							<td class="2-td2-left-qysds1" nowrap>其他媒体广告</td>
							<td class="2-td2-center" nowrap><input type='hidden' name='hc'
								id='hc_3' value='3'> <input type='text' name='je' id='3_1'
								value='' size='13' tabindex='1'></td>
							<td class="2-td2-left" nowrap>10</td>
							<td class="2-td2-left-qysds1" nowrap>本年结转以后年度扣除额［(4-5)＞8，本行
							=(4-5)-8，(4-5)≤8，本行=0］</td>
							<td class="2-td2-center" nowrap><input type='hidden' name='hc'
						...
						<tr>
							...
							<td class="2-td2-left-qysds1" nowrap>合计 (1+2+3)</td>
							<td class="2-td2-center" nowrap><input type='hidden' name='hc'
						...
						<tr>
							...
							<td class="2-td2-left-qysds1" nowrap>其中：不符合条件的广告费支出</td>
							<td class="2-td2-center" nowrap><input type='hidden' name='hc'
						...
						<tr>
							...
							<td class="2-td2-left-qysds1" nowrap>本年计算广告费扣除限额的销售 ( 营业 ) 收入</td>
							<td class="2-td2-center" nowrap><input type='hidden' name='hc'
								id='hc_6' value='6'> <input type='text' name='je' id='6_1'
								value='' size='13' tabindex='1'></td>
							<td class="2-td2-left" nowrap>13</td>
							<td class="2-td2-left-qysds1" nowrap>累计结转以后年度扣除额 (10+11-12)</td>
							<td class="2-td2-center" nowrap><input type='hidden' name='hc'
