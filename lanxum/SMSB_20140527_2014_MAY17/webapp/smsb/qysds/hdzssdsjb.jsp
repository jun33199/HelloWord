...
<html:form action="/webapp/smsb/qysds/hdzssdsjbAction.do">
	...
	<table width="96%" align="center" cellspacing="0" class="table-99"
		...
		<tr>
			<td class="1-td1" colspan="7">核定征收企业所得税季度纳税申报表</td>
		</tr>
		<tr>
			...
			<table cellspacing="0" class="table-99">
				...
				<tr class="black9">
					...
					<div align="left">纳税人识别号：&nbsp; <bean:write name="hdzssdsjbForm"
					...
					<table id="wrklistTable" border="1" cellspacing="0"
						...
						<tr>
							...
							<td class="2-td2-center" nowrap><input type='text' name='ljs'
								id='1_2' style='text-align:right' value='0.00' size='13'
						...
						<tr>
							...
							<td class="2-td2-left" nowrap><input style="text-align:center"
								type='text' name='bqs' id='2_1' value='*' size='1'
								class='text-noborder' readonly='true'></td>
							<td class="2-td2-center" nowrap><input style="text-align:center"
								type='text' name='ljs' id='2_2' value='*' size='1'
								class='text-noborder' readonly='true'></td>
						</tr>
						<tr>
...
<script language="JavaScript">
	...
	function doInit()	
	{
		...
		//initNumText("ljs",8);
	<%
	HdzssdsjbForm jbForm=(HdzssdsjbForm)request.getAttribute("hdzssdsjbForm");
