...
<html:form action="/webapp/smsb/lszsCxwszAction.do" method="POST">
      ...
      <table align="center" cellspacing="0" class="table-99">
        ...
        <tr>
          <td class="1-td2"  colspan="2"> <br>
            ...
            <br>    
              <table id="SzzqwhTable" width="89%"  class="table-99" cellspacing="0">
                <tr>
                  ...
                  <td width="15%" class="2-td1-left">纳税人</td>
            ...
            <bean:define id="items" name="lszsCxwszForm" property="dataList"/>
			<%
				double jehj = 0;
				int total = 0;
			%>
			...
			%>
              <tr> 
                  ...
                  <td width="15%" class="2-td2-left"><ttsoft:write name="item" property="nsrmc"/></td>
                ...
                <td width="5%" class="2-td2-left"><div align="center" ><a href="javascript:befDelete('<ttsoft:write name="item" property="jsjdm"/>','<ttsoft:write name="item" property="wszxh"/>','<ttsoft:write name="item" property="wszh"/>','<ttsoft:write name="item" property="ndzb"/>','<ttsoft:write name="item" property="pzzldm"/>')">撤销</a></div></td>
                <td width="15%" class="2-td2-center"><div align="center" ><a href="javascript:befUpdate('<ttsoft:write name="item" property="jsjdm"/>','<ttsoft:write name="item" property="wszxh"/>','<ttsoft:write name="item" property="wszh"/>','<ttsoft:write name="item" property="ndzb"/>','<ttsoft:write name="item" property="clbjdm"/>','<ttsoft:write name="item" property="pzzldm"/>');">设置打印标记</a></div></td>
              </tr>
...
function befDelete(jsjdm,xh,wsz,nd,pzzldm){
	document.forms[0].headJsjdm.value=jsjdm;
