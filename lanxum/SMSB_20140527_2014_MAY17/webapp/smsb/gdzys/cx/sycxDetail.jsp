...
<tr><td class = "1-td2">		
	...
	Symodel symodel = (Symodel)(sycxForm.getInfList().get(0));
	%>
  		...
  		<table align="center" width="99%" border="1" cellpadding="1" cellspacing="0" bordercolor="#FFFFFF">
  			...
  			<tr>
  				...
  				<td class="2-td2-t-center" width="30%" noWrap>
  					<bean:write name="gdinf" property="sbbxlh"/>&nbsp;
  				</td>
  			...
  			<tr>
				...
				<td class="2-td2-right"  noWrap>
					<%
					int sfzzlx_dm = Integer.parseInt(symodel.getSfzzlx());
					switch(sfzzlx_dm)
					{
						case 02:	%>身份证 		<%; break;						
					 	case 03:  %>军人证件		<%; break;
		...
		<table align="center" width="99%" border="1" cellpadding="1" cellspacing="0" bordercolor="#FFFFFF">
			...
			<tr>
				...
				<td class =2-td2-t-center noWrap colspan=2>
						<%if(symodel.getSfsjsp().equals("0")) {%>
		  					否
		  				<% }%>
		  				<%if(symodel.getSfsjsp().equals("1")) {%>
		  					是
		  				<% }%>
				</td>
			</tr>
			<tr>
	            ...
	            <td class=2-td2-center noWrap colspan=2>
	                  <%
	                if(symodel.getSbzt().equals("10")){
	                	%>
	                	未审核
	                	<%
	                	}else if(symodel.getSbzt().equals("30")){
	                	%>
	                	区县已审核
	                	<%
	                	}else{
