...
<html:form action="/webapp/smsb/sbzl/cx/qyjbcwzbcxAction.do" method="POST" >
	...
	<html:hidden property="showFjQueryButton"/>
	<html:hidden property="showSjQueryButton"/>
	<table width="96%" align="center" cellspacing="0" class="table-99">
		<tr>
			<td class="1-td1"  colspan="7">企业基本财务指标表申报查询 </td>
		</tr>
		<tr>
			<td class="1-td2"  colspan="7">
				...
				<table cellspacing="0" class="table-99">
					<tr class="black9">
						<td align="left" nowrap>
							<div align="left">当前日期：<bean:write name="qyjbcwzbcxActionForm" property="headDqrq"/></div>
						</td>
						<td align="right" nowrap>
							<div align="right"><bean:write name="qyjbcwzbcxActionForm" property="headSwjgzzjgmc"/></div>
						</td>
					</tr>
				</table>
				<br>
				<table  cellspacing="0" class="table-99">
					<tr> 
					  <td width="30%" class="2-td2-t-left">年度</td>
					  <td width="70%" class="2-td2-t-center"> <html:text property="nd" size="10" maxlength="8"/></td>
					</tr>
					<tr> 
					  <td width="30%" class="2-td2-left">分局</td>
					  <td width="70%" class="2-td2-center">
						<html:select property="queryFj"><html:options property="fjList"/></html:select>
					  </td>
					</tr>
					<tr> 
					  <td width="30%" class="2-td2-left">税务所</td>
					  <td width="70%" class="2-td2-center">
						<html:select property="querySwjgzzjg"><html:options property="swsList"/></html:select>
					  </td>
					</tr>
					<logic:equal name="qyjbcwzbcxActionForm" property="showSjQueryButton"	value="0">
					<tr> 
					  <td width="30%" class="2-td2-left">按全市查询</td>
					  <td width="70%" class="2-td2-center"><input type="image"  onClick="doit('QueryC'); return false;"  onMouseOver="MM_swapImage('QueryC','','<%=static_contextpath%>images/cx-q2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="申报查询" alt="申报查询" id="QueryC" src="<%=static_contextpath%>images/cx-q1.jpg" width="79" height="21">&nbsp;</td>
					</tr>
					</logic:equal>
					<logic:equal name="qyjbcwzbcxActionForm" property="showFjQueryButton"	value="0">
					<tr> 
					  <td width="30%" class="2-td2-left">按区县局查询</td>
					  <td width="70%" class="2-td2-center"><input type="image"  onClick="doit('QueryD'); return false;"  onMouseOver="MM_swapImage('QueryD','','<%=static_contextpath%>images/cx-q2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="申报查询" alt="申报查询" id="QueryD" src="<%=static_contextpath%>images/cx-q1.jpg" width="79" height="21">&nbsp;</td>
					</tr>
					</logic:equal>
					<tr> 
					  <td width="30%" class="2-td2-left">按税务所查询</td>
					  <td width="70%" class="2-td2-center"><input type="image"  onClick="doit('QueryE'); return false;"  onMouseOver="MM_swapImage('QueryE','','<%=static_contextpath%>images/cx-q2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="申报查询" alt="申报查询" id="QueryE" src="<%=static_contextpath%>images/cx-q1.jpg" width="79" height="21">&nbsp;</td>
					</tr>
					<tr> 
					...
					<tr> 
					  <td width="30%" class="2-td2-left">查询已申报纳税人</td>
					  <td width="70%" class="2-td2-center"><input type="image" accesskey="a"   onClick="doit('QueryA'); return false;"  onMouseOver="MM_swapImage('QueryA','','<%=static_contextpath%>images/cx-q2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="已申报查询" alt="已申报查询(a)" id="QueryA" src="<%=static_contextpath%>images/cx-q1.jpg" width="79" height="21">&nbsp;&nbsp;<input type="image" accesskey="s"   onClick="doit('ExportA'); return false;"  onMouseOver="MM_swapImage('ExportA','','<%=static_contextpath%>images/b-dcexcelb2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="零申报导出" alt="零申报导出(s)" id="ExportA" src="<%=static_contextpath%>images/b-dcexcelb1.jpg" width="79" height="21"></td>
					</tr>
					<tr> 
					  <td width="30%" class="2-td2-left">查询未申报纳税人</td>
					  <td width="70%" class="2-td2-center"><input type="image" accesskey="d"   onClick="doit('QueryB'); return false;"  onMouseOver="MM_swapImage('QueryB','','<%=static_contextpath%>images/cx-q2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="未申报查询" alt="未申报查询(d)" id="QueryB" src="<%=static_contextpath%>images/cx-q1.jpg" width="79" height="21">&nbsp;&nbsp;<input type="image" accesskey="f"   onClick="doit('ExportB'); return false;"  onMouseOver="MM_swapImage('ExportB','','<%=static_contextpath%>images/b-dcexcelb2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="未申报导出" alt="未申报导出(f)" id="ExportB" src="<%=static_contextpath%>images/b-dcexcelb1.jpg" width="79" height="21"></td>
					</tr>
				</table>
				<br>				
				<table width="100%" border="0" cellspacing="0" align="center" >
					<tr>
						...
						<td width="14%" align="left" class="black9" >
							<div align="center"><strong>区县进度查询结果列表</strong></div>
						</td>
						<td width="43%" ><hr width="100%" class="hr1" size=1></td>
					</tr>
				</table>
				...
				<table width="100%" border="0" cellspacing="0" class="table-99" align="center" >
					<tr>
						...
						<td class="2-td1-left" align="center" nowrap>单位代码</td>
						<td class="2-td1-left" align="center" nowrap>单位名称</td>
						<td class="2-td1-left" align="center" nowrap>应录数</td>
						<td class="2-td1-left" align="center" nowrap>已录数</td>
						<td class="2-td1-center" align="center" nowrap>未录数</td>
					</tr>
					<logic:iterate id="item1" name="qyjbcwzbcxActionForm" property="dataList1" >
					<tr>
						<td class="2-td2-left" align="center"><bean:write name='item1' property='index'/></td>
						<td class="2-td2-left" align="center"><bean:write name='item1' property='swjgzzjgdm'/></td>
						<td class="2-td2-left" align="center"><bean:write name='item1' property='swjgzzjgmc'/></td>
						<td class="2-td2-left" align="center"><bean:write name='item1' property='data1'/></td>
						<td class="2-td2-left" align="center"><bean:write name='item1' property='data2'/></td>
						<td class="2-td2-center" align="center"><bean:write name='item1' property='data3'/></td>						
					</tr>
					</logic:iterate>
				</table>
				<br>				
				<table width="100%" border="0" cellspacing="0" align="center" >
					<tr>
						<td width="43%" ><hr width="100%" class="hr1" size=1></td>
						<td width="14%" align="left" class="black9" >
							<div align="center"><strong>纳税人查询结果列表</strong></div>
						</td>
						<td width="43%" ><hr width="100%" class="hr1" size=1></td>
					</tr>
				</table>
				<br>
				<div align="right">
					(第<bean:write name="qyjbcwzbcxActionForm" property="nextPage"/>页/共<bean:write name="qyjbcwzbcxActionForm" property="totalpage"/>页)
					<!--翻页功能开始-->
				...
				<table width="100%" border="0" cellspacing="0" class="table-99" align="center" >
					...
					<logic:iterate id="item" name="qyjbcwzbcxActionForm" property="dataList" >
					<tr>
				...
				<table width="94%" border="0" cellpadding="0" cellspacing="4">
					<tr valign="bottom">
                        ...
                        <td width="40%" align="center">	
							<input type="image" accesskey="c"   onClick="tuichu(); return false;"  onMouseOver="MM_swapImage('tc1_20060404','','<%=static_contextpath%>images/tc-c2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="退出" id="tc1_20060404" src="<%=static_contextpath%>images/tc-c1.jpg" width="79" height="21">
						</td>
                        <td width="30%"></td>
                      </tr>
				</table>
