...
<html:form action="/webapp/smsb/yhdkwjxzbcAction.do" method="POST">
							...
							<tr>
								...
								<td width="16%" class="2-td2-t-center">
									<a style="cursor:hand" onClick="doSave();" tabindex="-1">
										<img src="<%=static_contextpath%>images/gghxz01.jpg" value="提取银行扣款信息" name="chaxun1a" width="125" height="22" border="0" id="chaxun1a" alt="提取银行扣款信息" onMouseOver="MM_swapImage('chaxun1a','','<%=static_contextpath%>images/gghxz02.jpg',1)" onMouseOut="MM_swapImgRestore()">
									</a>
								</td>
							</tr>
						</table>
                ...
                <div align="center">
						...
						<table width="99%" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" class="black9">
							<tr bordercolor="#9BB4CA" bgcolor="#F6F6F6">
								<td >
									<br>&nbsp;&nbsp;选择提取银行扣款信息操作后，请耐心等候操作完成，不要退出本模块或者关闭浏览器。<br><br>
								</td>
							</tr>
						</table>            
						<br>
...
function doSave(){
	if(flag)
		return false;
	if(window.confirm("即将下载该月银行扣款文件并保存扣款信息，请确认")) {
