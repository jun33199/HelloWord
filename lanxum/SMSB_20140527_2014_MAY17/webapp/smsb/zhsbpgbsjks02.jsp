...
<html:hidden property="forward" />
      ...
      <table width="96%" align="center" cellspacing="0" class="table-99">
            ...
            <td class="1-td1"  colspan="7">中 华 人 民 共 和 国 税 收 电 子 转 帐 专 用 完 税 凭 
              证<ttsoft:write name="zhsbPgbsjksypdsActionForm" property="jkpzh"/>号</td>
                </tr>
                <tr> 
                  <td class="1-td2"  colspan="7" valign="top"> <br>
					<table cellpadding="2" border="0" cellspacing="2" width="100%">
                      <tr> 
					  	<td width="3%">&nbsp;</td>
						<!-- 评估补税 -->
						<td width="77%"><div align="left" class="black9">填发日期：<ttsoft:write name="zhsbPgbsjksypdsActionForm" property="lrrq"/>&nbsp;</div></td>
						<td width="20%">&nbsp;</td>
					  </tr>
					</table>
