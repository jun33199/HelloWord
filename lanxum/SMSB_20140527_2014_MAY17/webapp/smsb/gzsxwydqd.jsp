...
function exportwydqdExcel(){
  document.all.gzsxnrbt.value='未阅读：'+'<bean:write name="gzsxwhForm" property="gzsxnrbt"/>'+'的清单.';
  document.all.actionType.value="exportwydqdExcel";
...
function doQuery(num) {
     ...
     //alert(pageIndex+"------pageIndex-------");
      ...
      document.all.jlcount.value='<bean:write name="gzsxwhForm" property="jlcount"/>';
    document.all.actionType.value="getwydqd";
    
   document.forms[0].submit();
   }
   function loadform(){
      // alert('<bean:write name="gzsxwhForm" property="jlcount"/>'+'--------iiiiiiiiiii');
    ...
    <td>
    	<br>
      	<table align="center" cellspacing="0"  class="table-99"  width="98%">
	       <tr>
	          <td class="1-td1" >未阅读："<bean:write name="gzsxwhForm" property="gzsxnrbt"/>"的清单.(记录总数：<bean:write name="gzsxwhForm" property="jlcount"/>)</td>
	        </tr>
	        <tr>
	          <td class="1-td2" >
			  	  <br>
            <table id="gzsxlistTable" border="1" cellpadding="0" cellspacing="0" class="table-99" height="1" width="99%">
              <tr>
                ...
                <td width="30%" class="2-td1-left" height="1">计算机代码</td>
                <td width="70%" class="2-td1-left" height="1">纳税人名称</td>
              </tr>
           ...
           <logic:iterate id="data" indexId="index" length="length" name="gzsxwhForm" property="tjgzsxlilst" type="com.ttsoft.bjtax.smsb.model.client.nsrtogzsx">
               <tr>
                <td width="30%" class="2-td2-left" height="23"><ttsoft:write name="data" property="jsjdm"/>&nbsp</td>
                <td width="70%" class="2-td2-left" height="23"><ttsoft:write name="data" property="nsrmc"/>&nbsp</td>
                </tr>
              </logic:iterate>
            </table>
             <br>
	         <table border="0" width="100%">
              <tr>
              <td width="5%">&nbsp; </td>
                <td width="40%"><input name="I2" type="image" accesskey="e" value="导出Excel"  onClick="exportwydqdExcel();return false;" onMouseOver="MM_swapImage('baocun','','<%=static_contextpath%>images/b-dcexcelb2.jpg',1)" onMouseOut="MM_swapImgRestore()" alt="导出Excel" src="<%=static_contextpath%>images/b-dcexcelb1.jpg" width="100" height="25" id="daochu"></td>
