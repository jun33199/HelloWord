...
function doSubmit(method){
	...
	document.all.wqyysjfhsForm.submit();
	return false;
}
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="margin: 0"  onResize="if (isNS4) nsResizeHandler()" onLoad="showhj()">
<script language="JavaScript" type="text/JavaScript">
...
<html:form action="/webapp/smsb/wqyysjfhsAction.do" method="POST">
    ...
    <td>
      <table align="center" cellspacing="0" class="table-99">
        ...
        <tr>
          <td class="1-td2"><br>
            <table cellspacing="0" class="table-99">
              ...
              <tr>
                  <td class="2-td2-left"><div align="left">申报日期：<html:text property="sbrq" size="11" maxlength="8" onchange="getStartEndDate(this,document.forms[0].skssksrq,document.forms[0].skssjsrq)"/>
                      </div></td>
		<td class="2-td2-left"><div align="right">税款所属日期：
                ...
                <td width="250" class="2-td2-center">&nbsp;<ttsoft:write name="wqyysjfhsForm" property="nsrmc"/>&nbsp;
                      <html:hidden property="nsrmc"/></td>
              </tr>
            </table>
            <br>

            <table width="100%" border="0" cellpadding="0" cellspacing="0" id="WQYYS2" onkeydown='return dokeydown(this.id);'  onmouseup='return dokeyUp(this.id)'>
                  <ttsoft:smsbtable form="wqyysjfhsForm" property="dataList" tableId="WQYYS2" hasTitle="true"/>
            <DIV id=divSfTemp></DIV>
            <tr>
                  <td colspan="11" class="2-td2-center"><div align="right">本期实际应补税额合计：&nbsp;
                  <input align="right" type="textfield" name="hj" class="inputnoborder " readonly tabIndex="-1"></div></td>
            </tr>
            </table>
            ...
            <br><center> <input type="image" accesskey="a" tabIndex="-1" onclick="javascript:if(document.forms[0].jsjdm.value=='' || document.forms[0].nsrmc.value=='') return false;addRow('WQYYS2'); return false;" onMouseOver="MM_swapImage('tianjia','','<%=static_contextpath%>images/zj-a2.jpg',1)" onMouseOut="MM_swapImgRestore()"  src="<%=static_contextpath%>images/zj-a1.jpg" width="79" height="22" id="tianjia" alt="增加" style="cursor:hand"/>
              &nbsp;&nbsp;&nbsp;&nbsp;  <input type="image" accesskey="s" tabIndex="-1"  onClick=" doSave(); return false;" onMouseOver="MM_swapImage('baocun','','<%=static_contextpath%>images/bc-s2.jpg',1)" onMouseOut="MM_swapImgRestore()" src="<%=static_contextpath%>images/bc-s1.jpg" alt="保存"  width="79" height="22" id="baocun" style="cursor:hand" >
                  &nbsp;&nbsp;&nbsp;&nbsp; <input type="image" accesskey="d" tabIndex="-1" onClick="javascript:deleteRow('WQYYS2',null); return false;"  onMouseOver="MM_swapImage('sc2','','<%=static_contextpath%>images/sc-d2.jpg',1)" onMouseOut="MM_swapImgRestore()" value="删除" id="sc2" src="<%=static_contextpath%>images/sc-d1.jpg" width="79" height="22">
...
<div id="szsmdm_epodDateLayer" style="position: absolute; width: 142; height: 166; z-index: 9998; display: none" onclick="this.style.display='none'"><select id=sel size="11" onclick='selectClick("szsmdm","WQYYS2")' onkeyup='selectMove("szsmdm","WQYYS2")' onfocusout=selectClick("szsmdm","WQYYS2")></select></div>
      <br></td>
    </tr>
</table>
</html:form>
...
var nsrzt = <ttsoft:write name="wqyysjfhsForm" property="nsrzt" filter="false"/>;
checkNsrzt();
/**********end**********/
</SCRIPT>
</body>
<script language=JavaScript >
var WQYYS2_list=new DTable(WQYYS2,jsArr_WQYYS2);
WQYYS2_list.tableTail=1;
<ttsoft:write name="wqyysjfhsForm" property="scriptStr" filter="false"/>


mathArray[0] = new MathString("hssre=jfzce/0.85");
