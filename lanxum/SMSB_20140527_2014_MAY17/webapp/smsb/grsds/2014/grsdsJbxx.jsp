...
function setLoadInf()
{
	...
	var msg="<bean:write name='grsdsjbxxbForm2014' property='msg'/>";
	if(msg){
		alert(msg);
		if(msg=="保存成功"){
			endSave=true;
...
<html:form action="/webapp/smsb/grsds/grsdsJbxxAction2014.do">
<table width="80%" height="50%" border="0" align="center" cellpadding="0" cellspacing="0" >
	
	<bean:define id="sfzjlxListID" name="grsdsjbxxbForm2014" property="sfzjlxList"/>		<!-- 身份证件类型代码表 -->
	<bean:define id="gjListID" name="grsdsjbxxbForm2014" property="gjList"/>				<!-- 国籍 -->
	<bean:define id="swjgzzjgListID" name="grsdsjbxxbForm2014" property="swjgzzjgList"/>	<!-- 税务机关组织机构 -->
	<bean:define id="hyListID" name="grsdsjbxxbForm2014" property="hyList"/>				<!-- 行业 -->
	<bean:define id="djzclxListID" name="grsdsjbxxbForm2014" property="djzclxList"/>				<!-- 行业 -->
			...
			<tr>
				<td class="1-td2" >
					...
					<div align="left">
						...
						<STRONG>&nbsp;&nbsp;年度：</STRONG>
						&nbsp;&nbsp;<html:text styleId="nd" maxlength="4" name="grsdsjbxxbForm2014" onchange="doChangeNd();" property="nd"/>
						</FONT>
					</div>
					...
					<table  cellSpacing="0" cellPadding="0" width="97%" border="0" align = "center">
						<tr>
							...
							<td class="2-td2-t-left" width="10%">
								<html:text styleId="grxx_xm"  name="grsdsjbxxbForm2014"  property="grxx_xm"  style="width:80%" />
							</td>
							<td class="2-td2-t-left" width="10%"><!--身份证件类型 不可修改-->
								身份证件类型
							</td>
							<td class="2-td2-t-left" width="10%">
								<html:hidden name="grsdsjbxxbForm2014" property="grxx_sfzjlx"></html:hidden>
							    <html:select disabled="true" name="grsdsjbxxbForm2014" property="grxx_sfzjlx" >
							...
							<td class="2-td2-t-center"  width="50%" colspan="5">
								<html:text styleId="grxx_sfzjhm"  readonly="true" name="grsdsjbxxbForm2014"  property="grxx_sfzjhm"  style="background-color:#cccccc" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-center"  width="90%" colspan="9">
								<html:hidden property="grxx_nsrlx" name="grsdsjbxxbForm2014" />
						...
						<tr>
							...
							<td class="2-td2-left"  width="60%" colspan="5">
								<html:text styleId="grxx_rzsgdwmc"  name="grsdsjbxxbForm2014"  property="grxx_rzsgdwmc" />
							</td>
							<td class="2-td2-left"  width="10%"><!--任职受雇单位纳税人识别号-->
								任职受雇单位纳税人识别号
							</td>
							<td class="2-td2-center"  width="20%" colspan="3">
								<html:text styleId="grxx_rzsgdwnsrsbh"  name="grsdsjbxxbForm2014"  property="grxx_rzsgdwnsrsbh" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" width="60%" colspan="5">
								<html:hidden property="grxx_sfyjjnqk" name="grsdsjbxxbForm2014" />
							...
							<td class="2-td2-center"  width="20%" colspan="3">
								<html:text styleId="grxx_email"  name="grsdsjbxxbForm2014"  property="grxx_email" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" width="60%" colspan="5">
								<html:text styleId="grxx_jnlxdz"  name="grsdsjbxxbForm2014"  property="grxx_jnlxdz" />
							</td>
							...
							<td class="2-td2-center"  width="20%" colspan="3">
								...
								<html:text styleId="grxx_yzbm"  name="grsdsjbxxbForm2014"  property="grxx_yzbm" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" width="60%" colspan="5">
								<html:text styleId="grxx_lxdh"  name="grsdsjbxxbForm2014"  property="grxx_lxdh" />
							</td>
							<td class="2-td2-left"  width="10%"><!--邮政编码-->
								职业
							</td>
							<td class="2-td2-center"  width="20%" colspan="3">
								<html:text styleId="grxx_zy"  name="grsdsjbxxbForm2014"  property="grxx_zy" />
							</td>
						</tr>
						<tr>
							<td class="2-td2-left" ><!--联系电话-->
							...
							<td class="2-td2-left" width="60%" colspan="5">
								<html:select  name="grsdsjbxxbForm2014" property="grxx_zw" styleId="grxx_zw">
							...
							<td class="2-td2-center"  width="20%" colspan="3">
								...
								<html:text styleId="grxx_xl"  name="grsdsjbxxbForm2014"  property="grxx_xl" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" colspan="5">
								<html:hidden property="grxx_sfcjrlsgl" name="grsdsjbxxbForm2014" />
							...
							<td class="2-td2-center" colspan="3">
								<html:text styleId="grxx_cjdjqk"  name="grsdsjbxxbForm2014"  property="grxx_cjdjqk" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" colspan="2">
								<html:select name="grsdsjbxxbForm2014" property="grxx_yjwsd_dzlx" styleId="grxx_yjwsd_dzlx" >
									<html:option value=""></html:option>
							...
							<td class="2-td2-left" colspan="2">
								<html:text styleId="grxx_yjwsd_yzbm"  name="grsdsjbxxbForm2014"  property="grxx_yjwsd_yzbm" />
							</td>
							<td class="2-td2-left">
								地址
							</td>
							<td class="2-td2-center" colspan="3">
								<html:text styleId="grxx_yjwsd_dz"  name="grsdsjbxxbForm2014"  property="grxx_yjwsd_dz" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="2-td2-center" colspan="7">
								<html:hidden property="grxx_tzzlx" name="grsdsjbxxbForm2014" />
						...
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								<html:text styleId="qyxx_btzzxm"  name="grsdsjbxxbForm2014"  property="qyxx_btzzxm" />
								<html:hidden property="qyxx_jsjdm" name="grsdsjbxxbForm2014" />
							</td>
							<td class="2-td2-left" ><!--扣缴义务人编码-->
								扣缴义务人编码
							</td>
							<td class="2-td2-center" colspan="3">
								<html:text styleId="qyxx_kjywrbh"  name="grsdsjbxxbForm2014"  property="qyxx_kjywrbh" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								<html:text styleId="qyxx_dz"  name="grsdsjbxxbForm2014"  property="qyxx_dz" />
							</td>
							<td class="2-td2-left" ><!--扣缴义务人编码-->
								邮政编码
							</td>
							<td class="2-td2-center" colspan="3">
								<html:text styleId="qyxx_yzbm"  name="grsdsjbxxbForm2014"  property="qyxx_yzbm" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								<html:select styleId="qyxx_djzclx" name="grsdsjbxxbForm2014" property="qyxx_djzclx" >
									<html:option value=""></html:option>
							...
							<td class="2-td2-center" colspan="3">
								<html:select styleId="qyxx_hy" name="grsdsjbxxbForm2014" property="qyxx_hy" >
									<html:option value=""></html:option>
						...
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								<html:select styleId="qyxx_sdszsfs" name="grsdsjbxxbForm2014" property="qyxx_sdszsfs" >
									<html:option value=""></html:option>
							...
							<td class="2-td2-center" colspan="3">
								...
								<html:select styleId="qyxx_zgswjg" name="grsdsjbxxbForm2014" property="qyxx_zgswjg" >
									<html:option value=""></html:option>
						...
						<tr>
							...
							<td class="2-td2-center" colspan="7">
								...
								<html:text styleId="grxx_wzsnsr_nsrsbh"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_nsrsbh" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								...
								<html:select styleId="grxx_wzsnsr_gj" name="grsdsjbxxbForm2014" property="grxx_wzsnsr_gj" >
									<html:option value=""></html:option>
							...
							<td class="2-td2-center" colspan="3">
								<html:text styleId="grxx_wzsnsr_csd"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_csd" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								<html:select styleId="grxx_wzsnsr_xb" name="grsdsjbxxbForm2014" property="grxx_wzsnsr_xb" >
									<html:option value=""></html:option>
							...
							<td class="2-td2-center" colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_csrq"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_csrq" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_ldjyzhm"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_ldjyzhm" />
							</td>
							...
							<td class="2-td2-center" colspan="3">
								...
								<html:select styleId="grxx_wzsnsr_sfssxddygdfjm" name="grsdsjbxxbForm2014" property="grxx_wzsnsr_sfssxddygdfjm" >
									<html:option value=""></html:option>
						...
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								<html:text styleId="grxx_wzsnsr_jnzw"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jnzw" />
							</td>
							<td class="2-td2-left"><!--境外职务-->
								境外职务
							</td>
							<td class="2-td2-center" colspan="3">
								<html:text styleId="grxx_wzsnsr_jwzw"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jwzw" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								<html:text styleId="grxx_wzsnsr_lhsj"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_lhsj" />
							</td>
							<td class="2-td2-left"><!--任职期限-->
								任职期限
							</td>
							<td class="2-td2-center" colspan="3">
								<html:text styleId="grxx_wzsnsr_rzqx"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_rzqx" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								<html:text styleId="grxx_wzsnsr_yjljsj"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_yjljsj" />
							</td>
							<td class="2-td2-left"><!--预计离境地点-->
								预计离境地点
							</td>
							<td class="2-td2-center" colspan="3">
								<html:text styleId="grxx_wzsnsr_yjljdd"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_yjljdd" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_jnrzsgdw_mc"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jnrzsgdw_mc" />
							</td>
							<td class="2-td2-left"><!--扣缴义务人编码-->
								扣缴义务人编码
							</td>
							<td class="2-td2-center" colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_jnrzsgdw_kjywrbm"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jnrzsgdw_kjywrbm" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_jnrzsgdw_dz"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jnrzsgdw_dz" />
							</td>
							...
							<td class="2-td2-center" colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_jnrzsgdw_yzbm"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jnrzsgdw_yzbm" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left"  colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_jnspqydw_mc"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jnspqydw_mc" />
							</td>
							<td class="2-td2-left"><!--扣缴义务人编码-->
								扣缴义务人编码
							</td>
							<td class="2-td2-center" colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_jnspqydw_kjywrbm"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jnspqydw_kjywrbm" />
							</td>
						</tr>
						<tr>
							<td class="2-td2-left" ><!--地址-->
							...
							<td class="2-td2-left"  colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_jnspqydw_dz"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jnspqydw_dz" />
							</td>
							<td class="2-td2-left"><!--邮政编码-->
								邮政编码
							</td>
							<td class="2-td2-center" colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_jnspqydw_yzbm"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jnspqydw_yzbm" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left"  colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_jwpqdw_mc"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jwpqdw_mc" />
							</td>
							<td class="2-td2-left"><!--地址-->
								地址
							</td>
							<td class="2-td2-center"  colspan="3">
								...
								<html:text styleId="grxx_wzsnsr_jwpqdw_dz"  name="grsdsjbxxbForm2014"  property="grxx_wzsnsr_jwpqdw_dz" />
							</td>
						</tr>
						<tr>
							...
							<td class="2-td2-left" colspan="3">
								<html:select styleId="grxx_wzsnsr_zfd" name="grsdsjbxxbForm2014" property="grxx_wzsnsr_zfd" >
									<html:option value=""></html:option>
							...
							<td class="2-td2-center" colspan="3">
								<html:select styleId="grxx_wzsnsr_jwzfggb" name="grsdsjbxxbForm2014" property="grxx_wzsnsr_jwzfggb" >
									<html:option value=""></html:option>
									<html:options collection="gjListID" property="value" labelProperty="text" />
								</html:select>
							</td>
