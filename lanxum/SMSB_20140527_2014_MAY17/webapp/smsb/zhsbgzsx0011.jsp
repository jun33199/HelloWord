...
<html:form action="/webapp/smsb/zhsbGzsxAction.do" method="POST" >
        ...
        <table cellspacing="0" class="table-98">
          ...
          <tr> 
            <td class="1-td2"><br>
			  ...
			  <bean:define id="items" name="zhsbGzsxActionForm" property="dataList"/>
				...
				<logic:equal name="zhsbGzsxActionForm" property="fzcbs" value="1">
				<tr> 
                  <!-- /* 1，正常情况 */ -->
