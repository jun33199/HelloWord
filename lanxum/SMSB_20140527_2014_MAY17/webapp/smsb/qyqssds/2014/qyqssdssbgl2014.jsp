...
<%@page import="com.ttsoft.bjtax.smsb.sbzl.qyqssds2014.qyqssdssbgl.web.QyqssdsSbglForm"%>
<html>  
  <head>
    <title>企业清算所得税申报记录</title>
  ...
  <script type="text/javascript" language="JavaScript">
	...
	var alert_str;
  	<%
  		QyqssdsSbglForm form = (QyqssdsSbglForm) request.getAttribute("qyqssdsSbglForm");
	...
	function doInit(){
		...
		var itemCheck = document.getElementsByName("itemCheck");
	     ...
	     total=<%=request.getAttribute("QYQSSB_TOTAL_PAGE")%>;
	}
	...
	//手动输入新增
	function doAddByInput(){
	
		if(trim(document.forms[0].filter_jsjdm.value) == ""){
		alert("请输入纳税企业计算机代码！");
		document.forms[0].filter_jsjdm.focus();
		return false;
		}
		doSubmitForm('Add');
		return false;
	...
	//新增
	function doAdd(jsjdm,czlx)
	{
		document.forms[0].filter_jsjdm.value = jsjdm;
	...
	function doDelete(jsjdm){
		if(window.confirm("此操作将永久删除该条企业清算所得税申报记录，且不可恢复!\n是否删除该条企业清算所得税申报记录？")){
  ...
  <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onload="doInit()">
    <%@ include file="../../include/header.jsp" %>  
      ...
      <html:form action="/webapp/smsb/qyqssds/2014/qyqssdsSbglAction2014.do" method="post">
            						...
            						<td class="1-td2">
                							...
                							<tr>
                  							<td class="2-td2-t-left" width="8%">
      											...
      											<tr>
        												...
        												<td class="2-td2-left">
	        												<div align="left">
	        													&nbsp;<html:select name="qyqssdsSbglForm" styleId="sqlxSelect" property="filter_sqlx" />
	  															</div>
        												</td>
        												<td class="2-td2-left">
          												申请状态
               							 ...
               							 <tr>
        											<td width="15%" class="2-td2-left" width="11%">
          											...
          											<td class="2-td2-left" width="22%">
            											<div align="left">
             												&nbsp;<html:select name="qyqssdsSbglForm" styleId="zgswjgSelect" property="filter_zgswjg" />
            											</div>
          											</td>
      												<td class="2-td2-left">
        												&nbsp;
					                 		...
					                 		<a style="cursor:hand" onClick="doAddByInput()" onMouseOut="MM_swapImgRestore()"	 onMouseOver="MM_swapImage('xinzeng','','<%=static_contextpath%>images//xinzeng2.jpg',1)">
              						...
              						<br>
													<div id="gdjl" style="position:static; overflow: auto; height: 300px;">
												    	<%=request.getSession(false).getAttribute("QYQSSB_QUERY_HTML")%>									
													</div>	
		  										<br>
			                         ...
			                         <a style="cursor:hand" onClick="turnThePage('last')" onMouseOut="MM_swapImgRestore()"
			                          ...
			                          <img src="<%=static_contextpath%>images//zuimoye1.jpg" name="zuimoye" width="79" height="22" border="0" id="zuimoye">
					                			...
					                			<span id="pageInfo" class="black9">/<%=request.getAttribute("QYQSSB_TOTAL_PAGE")%>页&nbsp;共<%=request.getAttribute("QYQSSB_ROWS_COUNT")%>条记录</span> 
						            				&nbsp;
