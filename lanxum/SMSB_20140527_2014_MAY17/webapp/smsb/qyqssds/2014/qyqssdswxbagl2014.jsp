...
<%@page import="com.ttsoft.bjtax.smsb.sbzl.qyqssds2014.qyqssdswxbagl.web.QyqssdsWxBaglForm"%>
<html>  
  <head>
    <title>企业所得税不需清算备案记录</title>
  ...
  <script type="text/javascript" language="JavaScript">
	...
	var alert_str;
  	<%
  		QyqssdsWxBaglForm form = (QyqssdsWxBaglForm) request.getAttribute("qyqssdsWxBaglForm");
  ...
  <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  onload="doInit()">
    <%@ include file="../../include/header.jsp" %>  
      ...
      <html:form action="/webapp/smsb/qyqssds/2014/qyqssdsWxBaglAction2014.do" method="post">
              							...
              							<table cellspacing=0 border=0 class="table-99" style="TABLE-LAYOUT:fixed">
                							<tr>
                  							<td class="2-td2-t-left" width="20%">
        												...
        												<td class="2-td2-t-center"  colspan="3" width="30%">
          												<div align="left">
             													&nbsp;<html:text property="filter_nsrmc" size="20"/>
          												</div>
        												</td>
      											</tr>
        											<td width="15%" class="2-td2-left" width="20%">
              											主管税务机关
          											</td>
          											<td class="2-td2-left" width="30%">
            											<div align="left">
             												&nbsp;<html:select name="qyqssdsWxBaglForm" styleId="zgswjgSelect" property="filter_zgswjg" />
            											</div>
          											</td>
      												<td class="2-td2-left">
        												&nbsp;
