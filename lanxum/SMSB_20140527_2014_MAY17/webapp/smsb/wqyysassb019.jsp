...
<style>
<!--
.itemBorder { 	border: 1px solid #6F97AE;
    text-align: right;
 }
.itemText {
...
function doSubmit(method){
	...
	document.all.wqyysassbForm.submit();
	return false;
}
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="margin: 0" onLoad="checkVisitCount()">
<script language="JavaScript" type="text/JavaScript">
...
<html:form action="/webapp/smsb/wqyysassbAction.do" method="POST">
	...
	<br>
        <tr>
          ...
          <table cellspacing="0" class="table-99">
              ...
              <tr>
              	<td class="2-td2-left"><div align="left">申报日期：<html:text property="sbrq" size="11" onchange="getStartEndDate(this,document.forms[0].skssksrq,document.forms[0].skssjsrq)"/>
                      </div></td>
		<td class="2-td2-left"><div align="right">税款所属日期：
                ...
                <td width="250" class="2-td2-center">&nbsp;<ttsoft:write name="wqyysassbForm" property="nsrmc"/>&nbsp;
                      <html:hidden property="nsrmc"/></td>
              </tr>
            </table>
            <br>

            <table width="100%" border="0" cellpadding="0" cellspacing="0" id="WQYYS3" onkeydown='return dokeydown(this.id)'  onmouseup='return dokeyUp(this.id)'>
                  <ttsoft:smsbtable form="wqyysassbForm" property="dataList" tableId="WQYYS3" hasTitle="true"/>
            <DIV id=divSfTemp></DIV>
            <tr>
                  <td colspan="10" class="2-td2-center"><div align="right">本期实际应补税额合计：&nbsp;
            ...
            <br>   <input type="image" accesskey="a" tabIndex="-1" onclick="javascript:if(document.forms[0].jsjdm.value=='' || document.forms[0].nsrmc.value==''){ return false;}else{addRow('WQYYS3'); return false;}" onMouseOver="MM_swapImage('tianjia','','<%=static_contextpath%>images/zj-a2.jpg',1)" onMouseOut="MM_swapImgRestore()"  src="<%=static_contextpath%>images/zj-a1.jpg" width="79" height="22" id="tianjia" alt="增加" style="cursor:hand"/>
              &nbsp;&nbsp;&nbsp;&nbsp;  <input type="image" accesskey="s" tabIndex="-1"  onClick="doSave(); return false;" onMouseOver="MM_swapImage('baocun','','<%=static_contextpath%>images/bc-s2.jpg',1)" onMouseOut="MM_swapImgRestore()" src="<%=static_contextpath%>images/bc-s1.jpg" alt="保存"  width="79" height="22" id="baocun" style="cursor:hand" >
                  &nbsp;&nbsp;&nbsp;&nbsp; <input type="image" accesskey="d" tabIndex="-1" onClick="javascript:deleteRow('WQYYS3',null); return false;"  onMouseOver="MM_swapImage('sc2','','<%=static_contextpath%>images/sc-d2.jpg',1)" onMouseOut="MM_swapImgRestore()" alt="删除" value="删除" id="sc2" src="<%=static_contextpath%>images/sc-d1.jpg" width="79" height="22">
                   &nbsp;&nbsp;&nbsp;&nbsp;<input type="image" accesskey="x" tabIndex="-1"  onClick="doDelete();return false;"onMouseOver="MM_swapImage('shanchu','','<%=static_contextpath%>images/qbsc-x2.jpg ',1)" onMouseOut="MM_swapImgRestore()" alt="全部删除" src="<%=static_contextpath%>images/qbsc-x1.jpg" width="79" height="22" id="shanchu" style="cursor:hand">
...
<div id="szsmdm_epodDateLayer" style="position: absolute; width: 142; height: 166; z-index: 9998; display: none" onclick="this.style.display='none'"><select id=sel size="11" onclick='selectClick("szsmdm","WQYYS3")' onkeyup='selectMove("szsmdm","WQYYS3")' onfocusout=selectClick("szsmdm","WQYYS3")></select></div>
<INPUT TYPE="hidden" NAME="szsmdm_focus">
<br>
    </td>
  </tr>
...
var nsrzt = <ttsoft:write name="wqyysassbForm" property="nsrzt" filter="false"/>;
checkNsrzt();
/***************end*************88/
</SCRIPT>
</body>
<script language=JavaScript >
var WQYYS3_list=new DTable(WQYYS3,jsArr_WQYYS3);
WQYYS3_list.tableTail=1;
<ttsoft:write name="wqyysassbForm" property="scriptStr" filter="false"/>


mathArray[0] = new MathString("ynse=jsje*sl");
mathArray[1] = new MathString("bqybse=ynse-yinse");
