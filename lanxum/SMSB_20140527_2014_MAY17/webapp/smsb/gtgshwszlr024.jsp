          ...
          <td class="1-td2"  colspan="2"> <br>
            <table cellspacing="0" class="table-99" width="99%" height="27">
              <!--<tr class="black9">
                	...
                	完税证号：<bean:write name="gtgshWszlrForm" property="wszh"/></td>
              </tr>-->
              <tr class="black9">
                <td align="center" nowrap  height="11">
        	        <div align="center">填发日期：<bean:write name="gtgshWszlrForm" property="lrrq"/> <html:hidden property="lrrq"/>&nbsp;&nbsp;
        	        </div>
                </td>
                <td align="center" nowrap  height="11">
                	<div align="right">&nbsp;征收机关名称：<bean:write name="gtgshWszlrForm" property="swjgzzjgmc"/><html:hidden property="swjgzzjgmc"/> <html:hidden property="swjgzzjgdm"/></div>
                </td>
              </tr>
            </table><br>
             ...
             <table class="table-99" border="0" cellpadding="0" cellspacing="0">
              <tr class="black9">
               <td nowrap class="2-td2-t-left">计算机代码</td>
...
//modified by zhangyj 20131224 调整完税证最大录入条数4到7
