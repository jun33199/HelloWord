...
function parseXmlOnLoad()
{
	  ...
	  xslPath='/XSLTWEB/model/030012/XSLT/jcdlscqy12.xsl';
	if (strXml != "")
    {
        //alert(strXml);
...
if(Trim(document.getElementById("MZQSND").value).length>0||Trim(document.getElementById("MZZZND").value).length>0){
...
if(Trim(document.getElementById("JZQSND").value).length>0||Trim(document.getElementById("JZZZND").value).length>0){
						...
						<table width="100%" border="0" align="center">
							<tr align="center">
								...
								<td><img src="<%=static_contextpath%>images/baocun1.jpg"
									...
									alt="保存" onclick="javascript:return doSave();" style="cursor:hand"></td>
								...
								<td><img src="<%=static_contextpath%>images/fanhui1.jpg"
									...
									alt="返回" onclick="javascript:return doReturn();" style="cursor:hand"></td>
							</tr>
						</table>
						</td>
