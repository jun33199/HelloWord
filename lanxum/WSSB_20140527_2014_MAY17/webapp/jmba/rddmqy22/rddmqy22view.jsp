...
{
	//alert(strXml);
    var xslPath='jmba/rddmqy22/rddmqy22view.xsl';
	if (strXml != "")
    {
  ...
  <tr>
    <td align="center" colspan=2 valign="top">
    	<jsp:include page="../../../include/SbHeader.jsp" flush="true" >
    		<jsp:param name="name" value="22 20经认定的动漫企业" />
...
<td valign="top" class="title"> <br>
      ...
      <table width="75%" cellspacing=0 border=0 class="table-99" style="TABLE-LAYOUT:fixed">
        <tr>
          <td class="1-td1" >22 20经认定的动漫企业</td>
        </tr>
        <tr>
          <td class="1-td2">
               <div id="result"></div>  
                  <table width="100%" border="0" align="center">
                    <tr align="center">
                      <td >
                        <img src="<%=static_contextpath%>images/fanhui1.jpg" onMouseOver="this.src='<%=static_contextpath%>images/fanhui2.jpg'" onMouseOut="this.src='<%=static_contextpath%>images/fanhui1.jpg'" alt="返回" onClick="javascript:history.go(-1);" style="cursor:hand">
                      </td>
                    </tr>
                  </table>
            <br>
