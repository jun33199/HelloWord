            ...
            <td width="895" height="334"> 
              <div id="Layer2" style="position:static;">
                ...
                <table id="wrklistTable" border="1" cellspacing="0"
                  ...
                  <tr> 
                    <td width="144" rowspan="10" nowrap="nowrap" class="2-td2-left">应纳税所得额的计算</td>
                    <td width="208" rowspan="3" nowrap="nowrap" class="2-td2-left">按收入总额核定应纳税所得额</td>
                  ...
                  <tr> 
                    <td class="2-td2-left" nowrap="nowrap">应纳税所得额（1行×2行）</td>
                  ...
                  <tr> 
                    <td colspan="2" rowspan="3" nowrap="nowrap" class="2-td2-left">应纳所得税额的计算</td>
                  ...
                  <tr> 
                    <td class="2-td2-left" nowrap="nowrap">应纳所得税额（3行×11行）</td>
