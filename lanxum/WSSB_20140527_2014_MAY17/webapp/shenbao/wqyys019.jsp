...
var sre = document.createElement("<input maxlength=\"15\" size=\"15\" name=\"sre\" value=\"0.00\" onChange=\"return(checkvalue(this,0)&&formatCurrency(this,0));\">");
cell2.appendChild(sre);
...
function getSbsj(objForm)
{
	...
	var nodeNameArray = new Array("szsmdm","szsmmc","jsje","sl","ynse","yjnse","bqybse","sre");
...
function doSave(){
	...
	if(itemsize == 1){
			if(document.forms[0].sre.value == "")
			{
				alert("收入额不能为空！");
				document.forms[0].sre.focus();
				document.forms[0].sre.select();
				return false;
			}
		...
		{
			if(document.forms[0].sre[j].value == "")
			{
				alert("收入额不能为空！");
				document.forms[0].sre[j].focus();
				document.forms[0].sre[j].select();
				return false;
			}
...
function parseXml()
{
	var xslPath = "/XSLTWEB/model/010012/XSLT/"+strXSLTVersion+".xsl";
...
function sreOnChange(obj,par1,par2)
{
	return(checkvalue(obj,par1)&&formatCurrency(obj,par2));
}
</script>
...
<table width="98%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" colspan=2>
		...
		<jsp:param name="help_url" value="help/wssb/sbzl/wqyys/assb/wqyys-001.htm"/>
    	</jsp:include>
