...
//判断印花税可申报：1.税款类型为“委托代征”、征期范围外，无法申报上月印花税税款；2.其他可申报印花税
...
<tr>
 <td>
<form name="form1" method="POST" action="/shenbao/zhsbWithSfxy.dc">
			...
			<table cellspacing="0" class="table-99">			
				<tr class="black9">							
					<td align="center" nowrap="nowrap"><div align="center">
						<img src="<%=static_contextpath%>images/huak1.jpg" onmouseover="this.src='<%=static_contextpath%>images/huak2.jpg'" onmouseout="this.src='<%=static_contextpath%>images/huak1.jpg'" alt="划款" onclick="doSave(1);" style="cursor:hand">
						&nbsp;&nbsp;&nbsp;&nbsp;
