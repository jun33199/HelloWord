...
function checkToSave(){
	...
	//if(jdlx==<%=CheckJdlx.QYSDSZGFWJDLX_DLNSR%> || jdlx==<%=CheckJdlx.QYSDSZGFWJDLX_ZFJGJZBSZJGNSR%>||jdlx==<%=CheckJdlx.QYSDSZGFWJDLX_KSSFZJGNSR%>||jdlx==<%=CheckJdlx.QYSDSZGFWJDLX_KSSZJGNSR%>)
	//{
		
	//}else{
		//alert("对不起，您不是企业所得税应征户，不能进行数据的录入!");
	//	return false;
//	}
	...
	/* modify by guoxh, 2012-2-24
	if(parseFloat(document.getElementById('13_1').value)>parseFloat(document.getElementById('13_1').value)){
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="return parseXmlOnLoad();"> 
 <html:errors/>
<form name="hdzsjbForm2014" action="hdzsqyjb2014.dc">
