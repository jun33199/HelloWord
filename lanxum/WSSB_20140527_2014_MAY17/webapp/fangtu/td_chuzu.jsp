...
//设置数组
var items = xmlDoc.selectNodes("//tdChuzuList");
...
for(i=0;i<items.length;i++){
    ...
    function initPage()
    {
        ...
        aryColumn[aryColumn.length] = new DTColumn(constCTInput, "tdzsh", 150, null, "maxlength=30 onchange='modify()'", "土地证书号", false, false, "100");
        ...
        aryColumn[aryColumn.length] = new DTColumn(constCTInput, "qzysmj", 70, null, "maxlength=20 onchange='modify()'", "其中应税面积", false, true, "100");
	...
	{   
		var list = ["djbh","id","tdzl","tdzsh","tdmj","qzmsmj","qzysmj","mpfmse","nynse","bz","opFlag"];
		...
		for(var i=0;i<aryDataSource.length;i++)
		{
			  if ( aryDataSource[i][daList.DynamicTable.Columns.length] != "5") {
				  var child = g_Doc.XMLDoc.createElement("tdChuzuList");
				  
			      parent.appendChild(child);
			      
				  var tmp= g_Doc.XMLDoc.selectNodes("//tdChuzuList");
...
<script language="JavaScript">
	...
	function checkQZYSMJ(dataSource)
	{
		for (var i = 0; i < dataSource.length;i++)
		{
			...
			if ( remarkIsEmpty(dataSource, i, 10 ) ) {
						...
						<div id="DIV_LIST" style="OVERFLOW: auto;">
							<table cellspacing="0" class="table-99" id="TABLE_LIST">
								...
								<tr>
									...
									土地面积<strong><span class="bitian">*</span></strong></td>
									<td width="12%" align="middle" class="2-td1-left">
									其中免税面积</td>
									<td width="9%" align="middle" class="2-td1-center">
									其中应税面积<strong><span class="bitian">*</span></strong></td>
							...
							<table cellspacing="0" class="table-99" id="TABLE_SUM">
								...
								<tr>
									...
									<td width="70" align="middle" class="2-td1-left">
										<fmt:formatNumber pattern="0.00" value="${tdcz_total.tdmj}"/></td>
									<td width="70" align="middle" class="2-td1-left">
										<fmt:formatNumber pattern="0.00" value="${tdcz_total.qzmsmj}"/></td>
									<td width="70" align="middle" class="2-td1-center">
										<fmt:formatNumber pattern="0.00" value="${tdcz_total.qzysmj}"/></td>
									<td width="70" align="middle" class="2-td1-center">
										&nbsp;
										</td>
									<td width="70" align="middle" class="2-td1-center">
										<fmt:formatNumber pattern="0.00" value="${tdcz_total.nynse}"/></td>
