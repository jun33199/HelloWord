...
{
	var xslPath="fangtu/alter_td_chuzu.xsl";
	if (strXml != "")
    {
...
//设置数组
var items = xmlDoc.selectNodes("/taxdoc/tdChuzuList");
...
function getFangtuInfo(objForm) {
	...
	// reg vo info
	var regList = ["djbh","id","tdzl","tdzsh","tdmj","qzmsmj","qzysmj","mpfmse","nynse","bz","opFlag"];
	// alter vo info
	var alterList = ["jsjdm", "djbh", "jcbh", "id", "bglx", "bgqtdzl", "bgqtdzsh", "bgqtdmj", "bgqqzmsmj", "bgqqzysmj", "bgqmpfmse", "bgqnynse", "bgqbz", "bghtdzl", "bghtdzsh", "bghtdmj", "bghqzmsmj", "bghqzysmj", "bghmpfmse", "bghnynse", "bghbz", "fhbs", "fhr", "fhrq", "tbrq", "swjgzzjgdm", "qxdm", "lrr", "lrrq", "cjr", "cjrq"];


	toXml("tdChuzuList", tableCount, list, regList, alterList);
}
