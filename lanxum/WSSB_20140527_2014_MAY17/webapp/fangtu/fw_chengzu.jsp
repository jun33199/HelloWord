...
//设置数组
var items = xmlDoc.selectNodes("//fwChengzuList");
...
for(i=0;i<items.length;i++){
    ...
    function initPage()
    {
        ...
        aryColumn[aryColumn.length] = new DTColumn(constCTInput, "house_position", 150, null, "maxlength=100 onchange='modify()'", "出租人名称", false, false, "100");
        aryColumn[aryColumn.length] = new DTColumn(constCTSelect, "house_number", 150, arySelect_zjlx, "need_autoselect onchange='modify()'", "证件类型", false, true, "100");
        aryColumn[aryColumn.length] = new DTColumn(constCTInput, "house_value", 100, null, "maxlength=20 onchange='modify()'", "出租人证件号码", false, false, "100");
        aryColumn[aryColumn.length] = new DTColumn(constCTInput, "house_value", 100, null, "maxlength=200 onchange='modify()'", " 承租房屋坐落", false, true, "100");
        ...
        aryColumn[aryColumn.length] = new DTColumn(constCTInput, "house_value", 100, null, "maxlength=20 onchange='modify()'", " 年租金", false, true, "100");
        aryColumn[aryColumn.length] = new DTColumn(constCTInput, "house_value", 100, null, "maxlength=200 onchange='modify()'", "备注", false, false, "100");
	...
	{   
		var list = ["djbh","id","czrmc","zjlxdm","czrzjhm","czfwzl","zlqxdm","nzj","bz","opFlag"];
		...
		for(var i=0;i<aryDataSource.length;i++)
		{
			  if ( aryDataSource[i][daList.DynamicTable.Columns.length] != "5") {
				  var child = g_Doc.XMLDoc.createElement("fwChengzuList");
				  
			      parent.appendChild(child);
			      
				  var tmp= g_Doc.XMLDoc.selectNodes("//fwChengzuList");
...
<script language="JavaScript">
	...
	//对年租金进行校验
	function check_nzj (dataSource)
	{
		for (var i = 0; i < dataSource.length;i++)
		{
			var nzj_f = checkNumber(trimString(dataSource[i][7]), 19, 2, true);
	...
	{
		var isCheck = check_nzj(daList.getData());
		if (!isCheck) {
			return false;
		}
						...
						<div id="DIV_LIST" style="OVERFLOW: auto;">
							<table cellspacing="0" class="table-99" id="TABLE_LIST">
								...
								<tr>
									...
									<td width="13%" align="middle" class="2-td1-left">
									出租人名称</td>
									<td width="13%" align="middle" class="2-td1-left">
									...
									出租人证件号码</td>
									<td width="15%" align="middle"  class="2-td1-left">
									承租房屋坐落<strong><span class="bitian">*</span></strong></td>
									<td width="15%" align="middle"  class="2-td1-left">
									坐落区县<strong><span class="bitian">*</span></strong></td>
									<td width="8%" align="middle"  class="2-td1-left">
									年租金<strong><span class="bitian">*</span></strong></td>
