<%@ page import="import com.ttsoft.bjtax.shenbao.constant.SuccessConstant"%>
<%
...
<%
		...
		String saveMsg = (String)request.getAttribute(SuccessConstant.SUCCESS_MESSAGE);
		if(saveMsg==null){
			saveMsg="";
		}
		System.out.println("saveMsg is ::" + saveMsg);
%>
...
<table width="100%" height="23" border="0" cellpadding="0" cellspacing="0" background="<%=sbheader_contextpath%>images/q-top-bg-02.jpg" class="black9">
  <tr background="<%=sbheader_contextpath%>images/q-top-bg-02.jpg">
    <td width="88%"><font color="#A4B9C6">综合服务管理信息系统</font>&gt;<font color="#7C9AAB">网上服务系统</font>&gt;<%=request.getParameter("name")%></td>
