...
public class AlterFWChuzuProcessor extends FangtuAlterProcessor {

	protected String alterTable = "SFDB.SF_JL_CZFWBGXX";
	private String jsjdm;
	Logger logger = Logger.getLogger(AlterFWChuzuProcessor.class.getName());
	...
	public Object process(VOPackage vo) throws BaseException {
		...
		logger.debug("process AlterFWChuzuProcessor.");
		...
		try {
			...
			List vos = alterFangtuVO.getFwChuzuList();
			...
			if (vos != null) {
				...
				for (int i = 0; i < vos.size(); i++) {
					FWChuzuDataVO bvo = (FWChuzuDataVO) vos.get(i);
	 ...
	 */
	private void handleUpdate(DBAccess dao, FWChuzuDataVO bvo)
			throws BaseException {
		...
		FWChuzuAlterVO alterVO =  bvo.getAlterVO();
		CZFWBGXX alterData = new CZFWBGXX();
	 ...
	 * @throws ApplicationException
	 */
	private void handleDelete(DBAccess dao, FWChuzuDataVO bvo)
			throws ApplicationException {
		if ("1".equals(bvo.getDeleteFlag())) {
	 ...
	 * @throws BaseException
	 */
	private void handleAdd(DBAccess dao, FWChuzuDataVO bvo, String djbh)
			throws BaseException {
	 ...
	 * @throws BaseException
	 */
	private void handleOld(DBAccess dao, FWChuzuDataVO bvo, String djbh)
			throws BaseException {
		if ("1".equals(bvo.getDeleteFlag())) {
	...
	private void initAlterData(String djbh, FWChuzuVO regVO, CZFWBGXX alterData) throws ApplicationException {

		CZFWJBXX regData = new CZFWJBXX();
	 ...
	 * @throws ApplicationException
	 */
	private void initAlterData(String djbh, CZFWJBXX regData, CZFWBGXX alterData)
			throws ApplicationException {
		...
		alterData.setBgqnzjsr( regData.getNzjsr());
		alterData.setBgqbz(regData.getBz());
		alterData.setBgqczfwyz(regData.getCzfwyz());
		alterData.setBgqxgrczbs(regData.getXgrczbs());
	 ...
	 * @param alterData
	 */
	private void clearBghData(CZFWBGXX alterData) {
		alterData.setBghfwzl(null);
		alterData.setBghcqzsh(null);
		alterData.setBghnynse(0);
		alterData.setBghnzjsr(0);
		alterData.setBghbz(null);
		alterData.setBghczfwyz(0);
		alterData.setBghxgrczbs(null);
	}
	/**
	 * 取得对应的表名
	 */
