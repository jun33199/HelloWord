...
public class NsrJbxxVo implements XMLVOInterface {
	...
	public String toXMLChilds() {
		...
		xmlstr += XMLBuildUtil.appendStringElement("qsllry", qsllry);
		...
		xmlstr += XMLBuildUtil.appendStringElement("qsbaksrq", qsbaksrq);
		xmlstr += XMLBuildUtil.appendStringElement("qsbajsrq", qsbajsrq);
		xmlstr += XMLBuildUtil.appendStringElement("qssbksrq", qssbksrq);
		xmlstr += XMLBuildUtil.appendStringElement("qssbjsrq", qssbjsrq);
		xmlstr += XMLBuildUtil.appendStringElement("version", version);
		xmlstr += XMLBuildUtil.appendStringElement("sqspbh", sqspbh);
		xmlstr += XMLBuildUtil.appendStringElement("jyqxjm", jyqxjm);
		xmlstr += XMLBuildUtil.appendStringElement("gdjyjs", gdjyjs);
		xmlstr += XMLBuildUtil.appendStringElement("yfdxgb", yfdxgb);
		xmlstr += XMLBuildUtil.appendStringElement("yfxgpc", yfxgpc);
		xmlstr += XMLBuildUtil.appendStringElement("yfgdqs", yfgdqs);
		xmlstr += XMLBuildUtil.appendStringElement("qtyy", qtyy);

		xmlstr += XMLBuildUtil.appendStringElement("baShztbs", baShztbs);
		xmlstr += XMLBuildUtil.appendStringElement("baShztMessage", baShztMessage);
		xmlstr += XMLBuildUtil.appendStringElement("baShtgrq", baShtgrq);
		
		xmlstr += XMLBuildUtil.appendStringElement("sbShztbs", sbShztbs);
		xmlstr += XMLBuildUtil.appendStringElement("sbShztMessage", sbShztMessage);
		xmlstr += XMLBuildUtil.appendStringElement("sbShtgrq", sbShtgrq);
		xmlstr += XMLBuildUtil.appendStringElement("sqlxdm", sqlxdm);
		xmlstr += XMLBuildUtil.appendStringElement("sfwxjxba", sfwxjxba);
	...
	public String getSfwxjxba() {
		return sfwxjxba;
	}

	public void setSfwxjxba(String sfwxjxba) {
		this.sfwxjxba = sfwxjxba;
	}
