...
import com.ttsoft.bjtax.shenbao.sbzl.qysdsfznb2012.xmlvo.FzjgNbList2012VO;
import com.ttsoft.bjtax.shenbao.sbzl.qysdsfznb2012.xmlvo.FzjgNbhj2012VO;
import com.ttsoft.bjtax.shenbao.sbzl.qysdsfznb2012.xmlvo.FzjgxxNb2012VO;
import com.ttsoft.bjtax.shenbao.sbzl.qysdsfznb2012.xmlvo.NsrxxVO_HDZSNb;
import com.ttsoft.bjtax.shenbao.sbzl.qysdsfznb2012.xmlvo.SbxxNb2012VO;
import com.ttsoft.bjtax.shenbao.sbzl.qysdsfznb2012.xmlvo.ZfjgqysdsNbVO;
import com.ttsoft.bjtax.shenbao.sbzl.qysdsfznb2012.xmlvo.ZjgxxNb2012VO;
...
public class QysdsNbUtil2012 {
	// 企业所得税税率
	private static final String QYSDS_SL = "0.25";

	public QysdsNbUtil2012() {
	}
	 ...
	 */
	public CzzssdsNbVO Czzsconvert2XMLVO(CzzssdsNbBO qysdsndbo, SWDJJBSJ djJbsj,
		...
		// XML文档信息
		qysdsnb.setXsltVersion(QysdsNbConstant.CA_XSLTDM_CZZSSDSNB_2012);
		qysdsnb.setSchemaVersion(QysdsNbConstant.CA_SCHEMADM_CZZSSDSNB_2012);
		qysdsnb.setYwlx(QysdsNbConstant.CA_YWLXDM_CZZSSDSNB_2012);
	 ...
	 * @throws BaseException
	 */
	public CzzssdsNbBO Czzsconvert2VO(CzzssdsNbVO qysdsnbvo) throws BaseException {
		CzzssdsNbBO qysdsnbbo = new CzzssdsNbBO();
		// 纳税人信息
	 ...
	 * @throws BaseException
	 * @author wangcy,2013-12-03,
	 */
	public ZfjgqysdsNbVO zfjgxxGetDataFromAconvert2XMLVO(ZfjgqysdsNbBO qysdsbo,SWDJJBSJ djJbsj, CzzssdsNbVO cvo, String nszf) throws BaseException 
	{
		CzzssdsNbVO czzsNbvo = (CzzssdsNbVO)cvo;
		ZfjgqysdsNbVO qysdsvo = new ZfjgqysdsNbVO();
		SbxxNb2012VO sbxx = new SbxxNb2012VO();
		ZjgxxNb2012VO zjgxx = new ZjgxxNb2012VO();
		FzjgNbList2012VO fzjgList = new FzjgNbList2012VO();
		FzjgNbhj2012VO fzjghj = new FzjgNbhj2012VO();
...
//		zjgxx.setFzjgftse(czzsNbvo.getSbsj().getFzjgyftsdse());
		...
		int rows = Integer.parseInt((String) sbsj.get(QysdsNbConstant.ZFJGSDSNB_2012_MAX_ROW));
		for (int i = 1; i <= rows; i++) {
			FzjgxxNb2012VO fzjg = new FzjgxxNb2012VO();
...
//        fzjghj.setFpsehj(deFormat.format(fpsehj_new));
		...
		// XML文档信息
		qysdsvo.setXsltVersion(QysdsNbConstant.CA_XSLTDM_ZFJGSDSNB_2012);
		qysdsvo.setSchemaVersion(QysdsNbConstant.CA_SCHEMADM_ZFJGSDSNB_2012);
		qysdsvo.setYwlx(QysdsNbConstant.CA_YWLXDM_ZFJGSDSNB_2012);
	...
	public ZfjgqysdsNbVO CzzssdsNbVOGetDataFromAconvert2XMLVO(SWDJJBSJ djJbsj, CzzssdsNbVO cvo) throws BaseException 
	{
		...
		ArrayList fzjgxxList = new ArrayList();
		int rows = QysdsNbConstant.ZFJGSDSNB_2012_DEFAULT_MX_ROW_NUMBER;
		
		FzjgxxNb2012VO fzjg_new = new FzjgxxNb2012VO();
    ...
    public HashMap getNsfsAndZfjg(Map pData) throws BaseException, ApplicationException {
		...
		try {
			...
			CzzssdsNbBO czzsbo = (CzzssdsNbBO) pData.get(QysdsksMapConstant.VO_KEY_KSSBSJ);
			...
			sql.append("and qh = '").append((String) pData.get(QysdsNbConstant.STRING_KEY_NDLX)).append("' ");
    ...
    public void deleteCascadeZfjgData(Map pData) throws BaseException,ApplicationException 
    {
		...
		try {
			...
			detelePstmtZb.setString(4, (String) pData.get(QysdsNbConstant.STRING_KEY_NDLX));
			detelePstmtZb.setString(5, QysdsNbConstant.TABLE_ID_ZFJGSDSNB_2012);
			...
			detelePstmtCb.setString(4, (String) pData.get(QysdsNbConstant.STRING_KEY_NDLX));
			detelePstmtCb.setString(5, QysdsNbConstant.TABLE_ID_ZFJGSDSNB_2012);
    ...
    public void saveCascadeZfjgData(Map pData) throws BaseException, ApplicationException {
		...
		Connection conn = null;
		CzzssdsNbBO qysdsndbo = (CzzssdsNbBO) pData.get(QysdsksMapConstant.VO_KEY_KSSBSJ);
		SWDJJBSJ djJbsj = (SWDJJBSJ) pData.get(QysdsksMapConstant.OBJECT_KEY_DJSJ);
			...
			if(qysdsndbo.getZfjg().equals("1")){
				if (queryFlagZb.equals("0")) {
					...
					for (int i = 0; i < hcZb.length; i++) {
						...
						insertPstmtZb.setString(4, (String) pData.get(QysdsNbConstant.STRING_KEY_NDLX));
						...
						insertPstmtZb.setString(7, QysdsNbConstant.QYSDSNB_VERSION_2012);
						insertPstmtZb.setString(8, QysdsReportsConstants.CREPORTS_IBBQLX_TYPE_YEAR);
						insertPstmtZb.setString(9, QysdsNbConstant.TABLE_ID_ZFJGSDSNB_2012);
						insertPstmtZb.setString(10, QysdsNbConstant.TABLE_NAME_ZFJGSDSNB_2012);
				...
				if (queryFlagZb.equals("1")) {
					...
					for (int i = 0; i < hcZb.length-2; i++) {
						...
						updatePstmtZb.setString(6, (String) pData.get(QysdsNbConstant.STRING_KEY_NDLX));
						updatePstmtZb.setString(7, QysdsNbConstant.TABLE_ID_ZFJGSDSNB_2012);
			...
			if(qysdsndbo.getZfjg().equals("2")){
				...
				if (queryFlagCb.equals("0")) {
					...
					for (int i = 0; i < 7; i++) {
						...
						insertPstmtCb.setString(4, (String) pData.get(QysdsNbConstant.STRING_KEY_NDLX));
						insertPstmtCb.setString(5, (String) skssrq.get(Skssrq.SKSSRQ_ND));
						insertPstmtCb.setString(6, QysdsNbConstant.QYSDSNB_VERSION_2012);
						insertPstmtCb.setString(7, QysdsReportsConstants.CREPORTS_IBBQLX_TYPE_YEAR);
						insertPstmtCb.setString(8, QysdsNbConstant.TABLE_ID_ZFJGSDSNB_2012);
						insertPstmtCb.setString(9, QysdsNbConstant.TABLE_NAME_ZFJGSDSNB_2012);
				...
				if (queryFlagCb.equals("1")) {
					...
					for (int i = 0; i < hcCb.length-3; i++) {
						...
						updatePstmtCb.setString(6, (String) pData.get(QysdsNbConstant.STRING_KEY_NDLX));
						updatePstmtCb.setString(7, QysdsNbConstant.TABLE_ID_ZFJGSDSNB_2012);
...
//			updatePstmtCb.executeBatch();
	...
	public HashMap queryCascadeZfjgData(Map pData) throws BaseException, ApplicationException {
		...
		try {
			...
			querySqlZb.append((String) pData.get(QysdsNbConstant.STRING_KEY_NDLX)).append("' ");
			querySqlZb.append(" AND SKND= '");
			querySqlZb.append((String) skssrq.get(Skssrq.SKSSRQ_ND)).append("' ");
			querySqlZb.append(" AND SBDM = '");
			querySqlZb.append(QysdsNbConstant.TABLE_ID_ZFJGSDSNB_2012).append("' ");
			...
			querySqlCb.append((String) pData.get(QysdsNbConstant.STRING_KEY_NDLX)).append("' ");
			querySqlCb.append(" AND SKND= '");
			querySqlCb.append((String) skssrq.get(Skssrq.SKSSRQ_ND)).append("' ");
			querySqlCb.append(" AND SBDM = '");
			querySqlCb.append(QysdsNbConstant.TABLE_ID_ZFJGSDSNB_2012).append("' ");
	 ...
	 */
	public ZfjgqysdsNbBO Zfjgconvert2BO(ZfjgqysdsNbVO qysdsvo) throws BaseException {
		ZfjgqysdsNbBO qysdsbo = new ZfjgqysdsNbBO();
		...
		for (int i = 0; i < fzjgmxList.size(); i++) {
			FzjgxxNb2012VO fzjgxx = (FzjgxxNb2012VO) fzjgmxList.get(i);
...
//					break;
		...
		//2012版分支机构合计行
		FzjgNbhj2012VO fzjghj = qysdsvo.getFzjghj();
