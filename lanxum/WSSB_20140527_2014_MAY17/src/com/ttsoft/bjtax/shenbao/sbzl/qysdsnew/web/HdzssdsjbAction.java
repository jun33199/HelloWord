...
public class HdzssdsjbAction extends DcBaseAction {
	...
	protected boolean validate(HdzssdsnbVO qynb) {
		if (!qynb.getYwlx().equals(Constant.CA_YWLXDM_HDZSSDSJB)) {
	...
	protected int getActionID() {
		return com.ttsoft.bjtax.shenbao.util.SbzlAccess.HDZSQYJB;
	}
	...
	public String doSave(HttpServletRequest request,
		...
		try {
			...
			pData.put(QysdsksMapConstant.STRING_KEY_BBLX, Constant.JB);
...
//			return CAConstants.SUCCESSSB;
	...
	public String doShow(HttpServletRequest request,
		...
		try {
			...
			pDataMap.put(QysdsksMapConstant.STRING_KEY_BBLX, Constant.JB);
			...
			qysdsnbvo = qysdsUtil.Hdzsconvert2XMLVO(qysdsnbbo, djJbsj, Constant.JB);
	...
	protected String beforePerform(HttpServletRequest request,
		...
		// 检查权限
		if (!SbzlAccess.getAuthority(SbzlAccess.HDZSQYJB, request)) {
