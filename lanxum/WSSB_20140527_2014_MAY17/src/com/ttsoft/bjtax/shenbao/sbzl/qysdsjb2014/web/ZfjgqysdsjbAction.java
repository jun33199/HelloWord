...
public class ZfjgqysdsjbAction extends DcBaseAction
{
    ...
    public String doShow(HttpServletRequest request, HttpServletResponse response) throws BaseException
    {
        ...
        try {
            ...
            pDataMap.put(QysdsksMapConstant.STRING_KEY_BBLX, Constant.TABLE_ID_ZFJGSDS_2014);
            pDataMap.put(QysdsksMapConstant.STRING_KEY_JDLX, qysdsUtil.getJbDM());

            vo.setAction(QysdsksActionConstant.INT_ACTION_QUERY);
            vo.setProcessor(ProcessorNames.ZFJGQYSDSJB_PROCESSOR_2014);
            vo.setData(pDataMap);
            vo.setUserData(ud);
            // 调用后台查询数据
            ...
            request.setAttribute("maxrows", ((HashMap) qysdsjbbo.getSbsj()).get(Constant.ZFJGSDSJB_2014_MAX_ROW));
...
//
            ...
            pData.put(QysdsksMapConstant.STRING_KEY_BBLX, Constant.TABLE_ID_ZFJGSDS_2014);
            ...
            request.setAttribute(Constant.JUMP_FLAG_NAME,"1");//1代表保存成功，0代表保存失败，added by zhangj,2014.12.05
...
//        request.setAttribute(CAConstants.REQ_KEY_CA_XML_SCHEMA_VERSION, qysdsjbvo.getSchemaVersion());
	...
	public String doJumpSuccess(HttpServletRequest request,
		...
		request.setAttribute(SuccessConstant.SUCCESS_MESSAGE,"企业所得税汇总纳税分支机构分配表保存成功");
		request.setAttribute(CAConstants.REQ_KEY_SUCCESS_MSG,"企业所得税汇总纳税分支机构分配表保存成功");
		request.setAttribute(CAConstants.REQ_KEY_RETURN_ADDRESS,Constant.REQ_KEY_RETURN_CZZSSDS_QYJB2014);
