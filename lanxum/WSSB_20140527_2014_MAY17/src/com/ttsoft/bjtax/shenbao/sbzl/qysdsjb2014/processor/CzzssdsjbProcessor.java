...
/**
 * @version 1.0 2014核定征收企业所得税季报processor类
 * @author wangcy
 */
	...
	private void insertJm(CzzssdsBO qysdsjdbo, SWDJJBSJ djjbsj, Connection conn)
		...
		try {
			...
			if (jmxmdm == null) {
				...
				System.out.println("**************   取得的减免项目代码为空，网上申报的季报表中putJm中的企业征收类型qysdsjbbo.getQyzslx()为:"+ qysdsjdbo.getQyzslx());
