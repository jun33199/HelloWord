...
//                 + "\ntbblx = " + table.getTbblx());
    ...
    private Object doQuery(Map pData) throws BaseException
    {
        ...
        try {
            ...
            if(bblx.equals(Constant.TABLE_ID_ZFJGSDS_2014)) {
...
//        String sql = "";
        ...
        try {
            ...
            qrtd.setTableName(Constant.TABLE_NAME_ZFJGSDS_2014); //报表名称
            // qrtd.setTbblx(QysdsReportsConstants.CREPORTS_TABLE_REPORTTYPE_NORMAL_ONE_DIMENSIONALITY);
...
//        }
        ...
        if(maxIndex < Constant.ZFJGSDSJB_2014_DEFAULT_MX_ROW_NUMBER) {
            int statrIndex = maxIndex + 1;
            int endIndex = Constant.ZFJGSDSJB_2014_DEFAULT_MX_ROW_NUMBER + 1;
...
//                    System.out.println("add id = " + id);
            ...
            //设置最大行数
            dataMap.put(Constant.ZFJGSDSJB_2014_MAX_ROW, String.valueOf(Constant.ZFJGSDSJB_2014_DEFAULT_MX_ROW_NUMBER));
        }
        else {
            //设置最大行数
            dataMap.put(Constant.ZFJGSDSJB_2014_MAX_ROW, String.valueOf(maxIndex));
        }
...
//        }
        ...
        table.setTableName(Constant.TABLE_NAME_ZFJGSDS_2014);
        /**
         * 填报表类型，和报表期类型一样
         *
         */
