...
public class FzjgList2014VO implements XMLVOInterface
{
    /*
     * 分支机构明细信息
     */
    ...
    public FzjgList2014VO()
    {
        super();
        m.put("mxxx", "com.ttsoft.bjtax.shenbao.sbzl.qysdsjb2014.xmlvo.Fzjgxx2014VO");
    }
    ...
    public String toXMLChilds()
    {
        ...
        for(int i = 0; i < mxxx.size(); i++) {
            xmlstr += ( (Fzjgxx2014VO) mxxx.get(i)).toXML();
        }
        return xmlstr;
    }
