package com.ttsoft.bjtax.shenbao.sbzl.qysdsfznb2014.bo;

import java.io.*;
import java.sql.*;
import java.util.*;

public class CzzsfzjgNbBO implements Serializable {
	...
	private String jmzynssde;
	private String xwqyjmsdse;
	...
	public void setSbsj(HashMap sbsj) {
		...
		if (sbsj != null && sbsj.size() > 0) {
			...
			this.jmzynssde=sbsj.get("jmzynssde").toString();
