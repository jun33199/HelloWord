...
public class HdzssdsBO implements Serializable {
	...
	private String yssdl = "";  //2h

	private String ynssde = "";  //3h

	private String sl = "";    //11h

	private String ynsdse = ""; //12h

	private String jmsdse = ""; //13h

	private String yyjsdse = ""; //14h

	private String ybsdse = "";  //15h
