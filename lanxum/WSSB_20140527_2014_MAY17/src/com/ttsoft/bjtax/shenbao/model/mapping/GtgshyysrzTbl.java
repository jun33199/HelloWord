...
public class GtgshyysrzTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_GTGSHYYSRZ";
	public GtgshyysrzTbl(ORManager manager) {
		super(manager, tabName, Gtgshyysrz.class);
