...
public class DjzclxTbl extends ORTable {
	static final String tabName = "DMDB.DJ_DM_DJZCLX";
	public DjzclxTbl(ORManager manager) {
		super(manager, tabName, Djzclx.class);
