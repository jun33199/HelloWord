...
public class GtgshsdszTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_GTGSHSDSZ";
	public GtgshsdszTbl(ORManager manager) {
		super(manager, tabName, Gtgshsdsz.class);
