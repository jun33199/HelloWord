...
public class DsdzdkmxTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_DSDZDKMX";
	public DsdzdkmxTbl(ORManager manager) {
		super(manager, tabName, Dsdzdkmx.class);
