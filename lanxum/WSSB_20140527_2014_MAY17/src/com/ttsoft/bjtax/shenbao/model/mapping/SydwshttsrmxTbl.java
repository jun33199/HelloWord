...
public class SydwshttsrmxTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_SYDWSHTTSRMX";
	public SydwshttsrmxTbl(ORManager manager) {
		super(manager, tabName, Sydwshttsrmx.class);
