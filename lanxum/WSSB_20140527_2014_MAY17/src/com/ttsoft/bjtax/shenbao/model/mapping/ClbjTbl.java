...
import com.ttsoft.bjtax.shenbao.model.domain.Clbj;
import com.ekernel.db.or.*;
import java.util.*;
import java.sql.Timestamp;
import java.math.BigDecimal;
public class ClbjTbl extends ORTable {
	static final String tabName = "DMDB.SB_DM_CLBJ";
	public ClbjTbl(ORManager manager) {
		super(manager, tabName, Clbj.class);
