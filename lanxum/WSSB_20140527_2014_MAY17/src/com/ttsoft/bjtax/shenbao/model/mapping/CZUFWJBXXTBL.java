...
public class CZUFWJBXXTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_CZUFWJBXX";
	public CZUFWJBXXTBL(ORManager manager) {
		super(manager, tabName, CZUFWJBXX.class);
