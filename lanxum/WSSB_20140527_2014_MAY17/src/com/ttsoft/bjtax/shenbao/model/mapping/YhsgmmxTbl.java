...
public class YhsgmmxTbl extends ORTable {
    static final String tabName = "SBDB.SB_JL_YHSGMMX";
    public YhsgmmxTbl(ORManager manager) {
        super(manager, tabName, Yhsgmmx.class);
