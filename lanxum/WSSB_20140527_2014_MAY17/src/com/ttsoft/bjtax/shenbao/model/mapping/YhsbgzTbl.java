...
public class YhsbgzTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_YHSBGZ";
	public YhsbgzTbl(ORManager manager) {
		super(manager, tabName, Yhsbgz.class);
