...
public class ZYTDJBXXTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_ZYTDJBXX";
	public ZYTDJBXXTBL(ORManager manager) {
		super(manager, tabName, ZYTDJBXX.class);
