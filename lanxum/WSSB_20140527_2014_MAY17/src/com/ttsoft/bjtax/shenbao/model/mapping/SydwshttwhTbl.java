...
public class SydwshttwhTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_SYDWSHTTWH";
	public SydwshttwhTbl(ORManager manager) {
		super(manager, tabName, Sydwshttwh.class);
