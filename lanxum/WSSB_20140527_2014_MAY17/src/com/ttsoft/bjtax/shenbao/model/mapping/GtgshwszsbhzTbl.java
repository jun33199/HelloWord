...
public class GtgshwszsbhzTbl extends ORTable {
        static final String tabName = "SBDB.SB_JL_GTGSHWSZSBHZ";
        public GtgshwszsbhzTbl(ORManager manager) {
                super(manager, tabName, Gtgshwszsbhz.class);
