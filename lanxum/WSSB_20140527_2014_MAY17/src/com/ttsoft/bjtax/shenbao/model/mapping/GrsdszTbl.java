...
public class GrsdszTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_GRSDSZ";
	public GrsdszTbl(ORManager manager) {
		super(manager, tabName, Grsdsz.class);
