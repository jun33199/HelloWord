...
public class CzzsnbqyTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_CZZSNBQY";
	public CzzsnbqyTbl(ORManager manager) {
		super(manager, tabName, Czzsnbqy.class);
