...
public class SqsbtmpTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_SQSB_TMP";
	public SqsbtmpTbl(ORManager manager) {
		super(manager, tabName, Sqsbtmp.class);
