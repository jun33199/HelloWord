...
public class CzzsjbqysjTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_CZZSJBQYSJ";
	public CzzsjbqysjTbl(ORManager manager) {
		super(manager, tabName, Czzsjbqysj.class);
