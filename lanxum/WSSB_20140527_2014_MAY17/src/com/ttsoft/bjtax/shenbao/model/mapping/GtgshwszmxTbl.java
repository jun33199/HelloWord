...
public class GtgshwszmxTbl extends ORTable {
        static final String tabName = "SBDB.SB_JL_GTGSHWSZMX";
        public GtgshwszmxTbl(ORManager manager) {
                super(manager, tabName, Gtgshwszmx.class);
