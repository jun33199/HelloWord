...
public class CZFWBGXXTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_CZFWBGXX";
	public CZFWBGXXTBL(ORManager manager) {
		super(manager, tabName, CZFWBGXX.class);
