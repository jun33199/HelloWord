...
import com.ttsoft.bjtax.shenbao.model.domain.Jjlxglszsm;
import com.ekernel.db.or.*;
import java.util.*;
import java.sql.Timestamp;
import java.math.BigDecimal;
public class JjlxglszsmTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_JJLXGLSZSM";
	public JjlxglszsmTbl(ORManager manager) {
		super(manager, tabName, Jjlxglszsm.class);
