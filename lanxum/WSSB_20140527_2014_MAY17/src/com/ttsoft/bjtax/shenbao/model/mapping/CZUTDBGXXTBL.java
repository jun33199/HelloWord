...
public class CZUTDBGXXTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_CZUTDBGXX";
	public CZUTDBGXXTBL(ORManager manager) {
		super(manager, tabName, CZUTDBGXX.class);
