...
public class CzzsnbzbTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_CZZSNBZB";
	public CzzsnbzbTbl(ORManager manager) {
		super(manager, tabName, Czzsnbzb.class);
