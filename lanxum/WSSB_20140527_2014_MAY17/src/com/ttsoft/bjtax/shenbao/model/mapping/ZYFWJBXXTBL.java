...
public class ZYFWJBXXTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_ZYFWJBXX";
	public ZYFWJBXXTBL(ORManager manager) {
		super(manager, tabName, ZYFWJBXX.class);
