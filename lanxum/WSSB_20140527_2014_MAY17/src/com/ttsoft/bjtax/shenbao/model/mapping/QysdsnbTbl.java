...
public class QysdsnbTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_QYSDSNB";
	public QysdsnbTbl(ORManager manager) {
		super(manager, tabName, Qysdsnb.class);
