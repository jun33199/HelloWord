...
public class CZFWJBXXTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_CZFWJBXX";
	public CZFWJBXXTBL(ORManager manager) {
		super(manager, tabName, CZFWJBXX.class);
