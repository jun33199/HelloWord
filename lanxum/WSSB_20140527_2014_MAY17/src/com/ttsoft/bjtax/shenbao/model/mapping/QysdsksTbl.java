...
import com.ttsoft.bjtax.shenbao.model.domain.Qysdsks;
import com.ekernel.db.or.*;
import java.util.*;
import java.sql.Timestamp;
import java.math.BigDecimal;
public class QysdsksTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_QYSDSKS";
	public QysdsksTbl(ORManager manager) {
		super(manager, tabName, Qysdsks.class);
