...
public class SzsmyfjsTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_SZSMYFJS";
	public SzsmyfjsTbl(ORManager manager) {
		super(manager, tabName, Szsmyfjs.class);
