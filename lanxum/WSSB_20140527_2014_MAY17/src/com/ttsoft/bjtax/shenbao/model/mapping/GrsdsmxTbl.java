...
public class GrsdsmxTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_GRSDSMX";
	public GrsdsmxTbl(ORManager manager) {
		super(manager, tabName, Grsdsmx.class);
