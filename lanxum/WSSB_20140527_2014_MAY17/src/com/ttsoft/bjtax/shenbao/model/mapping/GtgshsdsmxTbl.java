...
public class GtgshsdsmxTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_GTGSHSDSMX";
	public GtgshsdsmxTbl(ORManager manager) {
		super(manager, tabName, Gtgshsdsmx.class);
