...
public class LswszsbhzTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_LSWSZSBHZ";
	public LswszsbhzTbl(ORManager manager) {
		super(manager, tabName, Lswszsbhz.class);
