...
public class CzzsjbtzzsjTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_CZZSJBTZZSJ";
	public CzzsjbtzzsjTbl(ORManager manager) {
		super(manager, tabName, Czzsjbtzzsj.class);
