...
public class SdwszsbhzTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_SDWSZSBHZ";
	public SdwszsbhzTbl(ORManager manager) {
		super(manager, tabName, Sdwszsbhz.class);
