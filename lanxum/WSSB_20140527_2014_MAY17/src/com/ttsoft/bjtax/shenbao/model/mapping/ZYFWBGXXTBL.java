...
public class ZYFWBGXXTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_ZYFWBGXX";
	public ZYFWBGXXTBL(ORManager manager) {
		super(manager, tabName, ZYFWBGXX.class);
