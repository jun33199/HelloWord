...
public class FTCDJZBTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_FTCDJZB";
	public FTCDJZBTBL(ORManager manager) {
		super(manager, tabName, FTCDJZB.class);
