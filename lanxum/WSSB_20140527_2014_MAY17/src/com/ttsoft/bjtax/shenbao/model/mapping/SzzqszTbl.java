...
public class SzzqszTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_SZZQSZ";
	public SzzqszTbl(ORManager manager) {
		super(manager, tabName, Szzqsz.class);
