...
public class SydwshttsrzbTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_SYDWSHTTSRZB";
	public SydwshttsrzbTbl(ORManager manager) {
		super(manager, tabName, Sydwshttsrzb.class);
