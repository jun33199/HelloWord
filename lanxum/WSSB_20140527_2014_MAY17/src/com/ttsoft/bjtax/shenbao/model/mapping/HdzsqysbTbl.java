...
public class HdzsqysbTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_HDZSQYSB";
	public HdzsqysbTbl(ORManager manager) {
		super(manager, tabName, Hdzsqysb.class);
