...
public class YhsbgmxTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_YHSBGMX";
	public YhsbgmxTbl(ORManager manager) {
		super(manager, tabName, Yhsbgmx.class);
