...
public class CZTDBGXXTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_CZTDBGXX";
	public CZTDBGXXTBL(ORManager manager) {
		super(manager, tabName, CZTDBGXX.class);
