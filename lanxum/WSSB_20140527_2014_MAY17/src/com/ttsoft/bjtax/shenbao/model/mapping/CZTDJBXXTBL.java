...
public class CZTDJBXXTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_CZTDJBXX";
	public CZTDJBXXTBL(ORManager manager) {
		super(manager, tabName, CZTDJBXX.class);
