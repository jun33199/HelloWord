...
public class LsswszmxTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_LSSWSZMX";
	public LsswszmxTbl(ORManager manager) {
		super(manager, tabName, Lsswszmx.class);
