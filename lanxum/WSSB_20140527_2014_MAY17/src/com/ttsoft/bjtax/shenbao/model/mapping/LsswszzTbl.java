...
public class LsswszzTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_LSSWSZZ";
	public LsswszzTbl(ORManager manager) {
		super(manager, tabName, Lsswszz.class);
