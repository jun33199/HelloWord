...
public class CzzsnbfpblTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_CZZSNBFPBL";
	public CzzsnbfpblTbl(ORManager manager) {
		super(manager, tabName, Czzsnbfpbl.class);
