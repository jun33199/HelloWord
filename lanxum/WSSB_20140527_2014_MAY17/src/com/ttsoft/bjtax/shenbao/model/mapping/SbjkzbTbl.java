...
public class SbjkzbTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_SBJKZB";
	public SbjkzbTbl(ORManager manager) {
		super(manager, tabName, Sbjkzb.class);
