...
public class GjbzhyTbl extends ORTable {
	static final String tabName = "DMDB.GY_DM_GJBZHY";
	public GjbzhyTbl(ORManager manager) {
		super(manager, tabName, Gjbzhy.class);
