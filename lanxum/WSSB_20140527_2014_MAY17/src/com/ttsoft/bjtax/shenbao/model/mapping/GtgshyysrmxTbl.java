...
public class GtgshyysrmxTbl extends ORTable {
	static final String tabName = "SBDB.SB_JL_GTGSHYYSRMX";
	public GtgshyysrmxTbl(ORManager manager) {
		super(manager, tabName, Gtgshyysrmx.class);
