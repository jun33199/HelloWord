...
public class SbbbxmTbl extends ORTable {
	static final String tabName = "SBDB.SB_DM_SBBBXM";
	public SbbbxmTbl(ORManager manager) {
		super(manager, tabName, Sbbbxm.class);
