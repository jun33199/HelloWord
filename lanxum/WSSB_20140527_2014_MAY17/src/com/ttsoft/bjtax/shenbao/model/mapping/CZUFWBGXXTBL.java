...
public class CZUFWBGXXTBL extends ORTable {
	static final String tabName = "SFDB.SF_JL_CZUFWBGXX";
	public CZUFWBGXXTBL(ORManager manager) {
		super(manager, tabName, CZUFWBGXX.class);
