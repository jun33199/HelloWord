 ...
 */
package com.syax.bjtax.shenbao.jmba.basx020.processor;
 ...
 */
public class Basx020Processor implements Processor {
	/**
	 * 实现Processor接口
	 *
	 * @param vo
	...
	private Object doSave(VOPackage vo) throws BaseException {
		...
		Jmba20VO mxvo = (Jmba20VO) vo1.getQysdsjmba().get(0);
		...
		try {
			...
			if (mxvo.getXh() != null && !mxvo.getXh().equals("")) {
				sql = "UPDATE sfdb.sf_jl_qysdsjmsba_20 SET DMQYLXDM='"
						+ mxvo.getDmqylxdm() + "',ZSBH='" + mxvo.getZsbh()
						+ "',ZSQSRQ=to_date('" + mxvo.getZsqsrq()
						+ "','yyyy-mm-dd'),ZSZZRQ=to_date('" + mxvo.getZszzrq()
						+ "','yyyy-mm-dd'),HLND='" + mxvo.getHlnd()
						+ "',MZQSND='" + mxvo.getMzqsnd() + "',MZZZND='"
						+ mxvo.getMzzznd() + "',JZQSND='" + mxvo.getJzqsnd()
						+ "',JZZZND='" + mxvo.getJzzznd() + "',JMSE='"
						+ mxvo.getJmse() + "',LRR='" + ud.getYhid()
						+ "',LRRQ=sysdate where xh ='" + mxvo.getXh() + "'";
			} else {
				String xh = qysdsUtil.getSequence();
				sql = "INSERT INTO sfdb.sf_jl_qysdsjmsba_20 (XH,BASQWSH,JSJDM,BAND,SWJGZZJGDM"
						+ ",DMQYLXDM,ZSBH,ZSQSRQ,ZSZZRQ,HLND,MZQSND,MZZZND,JZQSND,JZZZND,JMSE "
			...
			System.out.println("20Processor===doSave===sql=" + sql);
	...
	private Object doDelete(VOPackage vo) throws BaseException {
		...
		try {
			 ...
			 */
			conn = DBResource.getConnection();
			String delSQL = "DELETE FROM sfdb.sf_jl_qysdsjmsba_20 t WHERE t.xh = '"
					+ bo.getXh() + "'";
	...
	private Object doQuery(VOPackage vo) throws BaseException {
		...
		try {
			...
			if (vo1.getBasqwsh() == null || "".equals(vo1.getBasqwsh())) {
				...
				sb
						.append("select t.xh,t.DMQYLXDM,t.ZSBH,t.ZSQSRQ,t.ZSZZRQ,t.HLND,t.MZQSND,t.MZZZND,t.JZQSND,t.JZZZND,t.JMSE");

				sb
						.append(" from sfdb.sf_jl_qysdsjmsba_20 t,sfdb.sf_jl_qysdsjmsbajl c where  t.band='"
			...
			sb.append(" from sfdb.sf_jl_qysdsjmsba_20 t where  basqwsh='"
					+ bo.getBasqwsh() + "'");
	...
	private Jmba20VO getBamxvo(ResultSet rs) throws Exception {
		Jmba20VO mxvo = new Jmba20VO();
		// String tbblx = null;
		try {
			mxvo.setXh(rs.getString("xh"));
			mxvo.setDmqylxdm(rs.getString("DMQYLXDM"));
