 ...
 */
package com.syax.bjtax.shenbao.jmba.basx017.processor;
...
import com.syax.bjtax.shenbao.jmba.xmlvo.Jmba17VO;
 ...
 */
public class Basx017Processor implements Processor {
	/**
	 * 实现Processor接口
	 *
	 * @param vo
	...
	private Object doQuery(VOPackage vo) throws BaseException {
		...
		try {
			...
			if (vo1.getBasqwsh() == null || "".equals(vo1.getBasqwsh())) {
				...
				sb
						.append("select t.xh,t.ZRSRJE,t.SJJE1,t.SJJE2,t.HLND,t.MZQSND,t.MZZZND,t.JZQSND,t.JZZZND ");

				sb
						.append(" from sfdb.sf_jl_qysdsjmsba_17 t,sfdb.sf_jl_qysdsjmsbajl c where  t.band='"
			...
			sb = new StringBuffer();
			sb
					.append("select t.xh,t.ZRSRJE,t.SJJE1,t.SJJE2,t.HLND,t.MZQSND,t.MZZZND,t.JZQSND,t.JZZZND ");// t.SFYCJRMC,t.SFYSHBX,t.SFYLDHT,t.SFYCJRZM,t.SFYGZZM,

			sb.append(" from sfdb.sf_jl_qysdsjmsba_17 t where  basqwsh='"
					+ bo.getBasqwsh() + "'");
	...
	private Jmba17VO getBamxvo(ResultSet rs) throws Exception {
		Jmba17VO mxvo = new Jmba17VO();
		try {
			mxvo.setXh(rs.getString("xh"));
			mxvo.setZrsrje(MoneyUtils.format(rs.getString("ZRSRJE")));
			mxvo.setSjje1(MoneyUtils.format(rs.getString("SJJE1")));
			mxvo.setSjje2(MoneyUtils.format(rs.getString("SJJE2")));
	...
	private Object doSave(VOPackage vo) throws BaseException {
		...
		Jmba17VO mxvo =  (Jmba17VO) vo1.getQysdsjmba().get(0);
		...
		try {
			...
			if (mxvo.getXh() != null && !mxvo.getXh().equals("")) {
				sql = "UPDATE sfdb.sf_jl_qysdsjmsba_17 SET " + " ZRSRJE='"
						+ mxvo.getZrsrje() + "',SJJE1='" + mxvo.getSjje1()
						+ "',SJJE2='" + mxvo.getSjje2() + "',HLND='"
				...
				sql = "INSERT INTO sfdb.sf_jl_qysdsjmsba_17 (XH,BASQWSH,JSJDM,BAND,SWJGZZJGDM"
						+ // ,SFYCJRMC,SFYCJRZM" +
						// ",QTZL,SFYLDHT,SFYSHBX,SFYGZZM" +
						",ZRSRJE,SJJE1,SJJE2,HLND,MZQSND,MZZZND,JZQSND,JZZZND,CJR,CJRQ,LRR,LRRQ) VALUES('"
						+ xh
						+ "','"
						+ vo1.getBasqwsh()
						+ "','"
			...
			System.out.println("017==============Processor===doSave===sql="
					+ sql);
