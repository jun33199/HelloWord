...
/*----------总机构备案信息----------------*/
	 ...
	 * Description：备案其实时间
	 */
	//private String baqssj;
	private Date   baqssj;
	/**
	 * Description：是否存在备案查询结构
	 */
	private boolean hasBasj;
...
/*------------------------------*/
	...
	/*public String getBaqssj() {
		return baqssj;
	}

	public void setBaqssj(String baqssj) {
		this.baqssj = baqssj;
	}
*/
	
	public boolean isHasBasj() {
		return hasBasj;
	}

	public Date getBaqssj() {
		return baqssj;
	}

	public void setBaqssj(Date baqssj) {
		this.baqssj = baqssj;
	}

	public void setHasBasj(boolean hasBasj) {
		this.hasBasj = hasBasj;
	}
