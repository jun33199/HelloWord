...
public class TABLETypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TABLETypeDescriptor() 
     {
        ...
        //-- _INPUTITEMS
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.lscdz.qysds.common.service.qysds.xml.vo.data.INPUTITEMS.class, "_INPUTITEMS", "INPUTITEMS", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TABLEType target = (TABLEType) object;
                    target.setINPUTITEMS( (com.lscdz.qysds.common.service.qysds.xml.vo.data.INPUTITEMS) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new com.lscdz.qysds.common.service.qysds.xml.vo.data.INPUTITEMS();
            }
        };
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        desc.setValidator(fieldValidator);
    } //-- com.lscdz.qysds.common.service.qysds.xml.vo.data.TABLETypeDescriptor()
    ...
    {
        return com.lscdz.qysds.common.service.qysds.xml.vo.data.TABLEType.class;
