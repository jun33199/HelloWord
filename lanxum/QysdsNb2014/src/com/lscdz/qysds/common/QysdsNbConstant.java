...
public class QysdsNbConstant {
    ...
    public static final String QYSDS_TABLE_SBBM_A100000= "A100000";
    public static final String QYSDS_TABLE_SBBM_A105060 = "A105060";
    public static final String QYSDS_TABLE_SBBM_A105010 = "A105010";
    public static final String QYSDS_TABLE_SBBM_A107020 = "A107020";//所得减免优惠明细表
	...
	//end
    public static final String deploy_environment=ResourceManager.getTokenByName("DEPLOY_ENVIRONMENT");
    //是否进行关联申报的标志
    public static final String QYSDS_GLSB_FLAG="QYSDS_GLSB_FLAG";
}
