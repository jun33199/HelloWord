package com.lscdz.qysds.application.jmsbayj2014.main.vo.response;
...
public class JmsbaInitRes implements java.io.Serializable{
	...
	public String getInZqFlag() {
		return inZqFlag;
	}

	public void setInZqFlag(String inZqFlag) {
		this.inZqFlag = inZqFlag;
	}
