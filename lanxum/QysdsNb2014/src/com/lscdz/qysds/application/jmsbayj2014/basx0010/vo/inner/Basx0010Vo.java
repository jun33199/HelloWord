package com.lscdz.qysds.application.jmsbayj2014.basx0010.vo.inner;


public class Basx0010Vo  {
	...
	private String	jjsr;	//减计收入(单位:元)
	private String	qdsr;	//取得收入(单位:元)
	private String	zsbh;	//证书编号
	private String	zsyxjzrq;	//证书有效截止日期
	private String	zsyxksrq;	//证书有效开始日期
