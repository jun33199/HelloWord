...
public class QyjbxxVo {
	...
	private String baqssjFlag;//是否具有备案起始时间标志
	//后期修改
	private Date baqssj;//备案起始时间
	...
	public String getBaqssjFlag() {
		return baqssjFlag;
	}
	public void setBaqssjFlag(String baqssjFlag) {
		this.baqssjFlag = baqssjFlag;
	}
